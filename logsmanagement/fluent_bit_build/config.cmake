...
set(FLB_RELEASE                     ON  CACHE BOOL "Build with release mode (-O2 -g -DNDEBUG)")
...
set(FLB_BINARY                      ON CACHE BOOL "Build executable binary")
...
set(FLB_SIGNV4                      OFF CACHE BOOL "Enable AWS Signv4 support")
set(FLB_AWS                         OFF CACHE BOOL "Enable AWS support")
...
# set(FLB_CORO_STACK_SIZE           "Set coroutine stack size")
set(FLB_AVRO_ENCODER                OFF CACHE BOOL "Build with Avro encoding support")
set(FLB_AWS_ERROR_REPORTER          OFF CACHE BOOL "Build with aws error reporting support")
set(FLB_ARROW                       OFF CACHE BOOL "Build with Apache Arrow support")
set(FLB_WINDOWS_DEFAULTS            ON  CACHE BOOL "Build with predefined Windows settings")
...
set(FLB_IN_FORWARD                  OFF CACHE BOOL "Enable Forward input plugin")
...
set(FLB_IN_KMSG                     OFF CACHE BOOL "Enable Kernel log input plugin")
set(FLB_IN_LIB                      ON CACHE BOOL "Enable library mode input plugin")
set(FLB_IN_RANDOM                   OFF CACHE BOOL "Enable random input plugin")
set(FLB_IN_SERIAL                   OFF CACHE BOOL "Enable Serial input plugin")
...
set(FLB_IN_MQTT                     OFF CACHE BOOL "Enable MQTT Broker input plugin")
...
set(FLB_OUT_AZURE                   OFF CACHE BOOL "Enable Azure output plugin")
set(FLB_OUT_AZURE_BLOB              OFF CACHE BOOL "Enable Azure output plugin")
set(FLB_OUT_AZURE_KUSTO             OFF CACHE BOOL "Enable Azure Kusto output plugin")
set(FLB_OUT_BIGQUERY                OFF CACHE BOOL "Enable BigQuery output plugin")
...
set(FLB_OUT_DATADOG                 OFF CACHE BOOL "Enable DataDog output plugin")
set(FLB_OUT_ES                      OFF CACHE BOOL "Enable Elasticsearch output plugin")
set(FLB_OUT_EXIT                    OFF CACHE BOOL "Enable Exit output plugin")
set(FLB_OUT_FORWARD                 OFF CACHE BOOL "Enable Forward output plugin")
set(FLB_OUT_GELF                    OFF CACHE BOOL "Enable GELF output plugin")
set(FLB_OUT_HTTP                    OFF CACHE BOOL "Enable HTTP output plugin")
set(FLB_OUT_INFLUXDB                OFF CACHE BOOL "Enable InfluxDB output plugin")
set(FLB_OUT_NATS                    OFF CACHE BOOL "Enable NATS output plugin")
set(FLB_OUT_NRLOGS                  OFF CACHE BOOL "Enable New Relic output plugin")
set(FLB_OUT_OPENSEARCH              OFF CACHE BOOL "Enable OpenSearch output plugin")
set(FLB_OUT_TCP                     OFF CACHE BOOL "Enable TCP output plugin")
set(FLB_OUT_PLOT                    OFF CACHE BOOL "Enable Plot output plugin")
set(FLB_OUT_FILE                    OFF CACHE BOOL "Enable file output plugin")
set(FLB_OUT_TD                      OFF CACHE BOOL "Enable Treasure Data output plugin")
set(FLB_OUT_RETRY                   OFF CACHE BOOL "Enable Retry test output plugin")
set(FLB_OUT_PGSQL                   OFF CACHE BOOL "Enable PostgreSQL output plugin")
set(FLB_OUT_SKYWALKING              OFF CACHE BOOL "Enable Apache SkyWalking output plugin")
set(FLB_OUT_SLACK                   OFF CACHE BOOL "Enable Slack output plugin")
set(FLB_OUT_SPLUNK                  OFF CACHE BOOL "Enable Splunk output plugin")
set(FLB_OUT_STACKDRIVER             OFF CACHE BOOL "Enable Stackdriver output plugin")
set(FLB_OUT_STDOUT                  ON CACHE BOOL "Enable STDOUT output plugin")
set(FLB_OUT_SYSLOG                  OFF CACHE BOOL "Enable Syslog output plugin")
...
set(FLB_OUT_FLOWCOUNTER             OFF CACHE BOOL "Enable flowcount output plugin")
set(FLB_OUT_LOGDNA                  OFF CACHE BOOL "Enable LogDNA output plugin")
set(FLB_OUT_LOKI                    OFF CACHE BOOL "Enable Loki output plugin")
set(FLB_OUT_KAFKA                   OFF CACHE BOOL "Enable Kafka output plugin")
set(FLB_OUT_KAFKA_REST              OFF CACHE BOOL "Enable Kafka Rest output plugin")
set(FLB_OUT_CLOUDWATCH_LOGS         OFF CACHE BOOL "Enable AWS CloudWatch output plugin")
set(FLB_OUT_KINESIS_FIREHOSE        OFF CACHE BOOL "Enable AWS Firehose output plugin")
set(FLB_OUT_KINESIS_STREAMS         OFF CACHE BOOL "Enable AWS Kinesis output plugin")
set(FLB_OUT_OPENTELEMETRY           OFF CACHE BOOL "Enable OpenTelemetry plugin")
set(FLB_OUT_PROMETHEUS_EXPORTER     OFF CACHE BOOL "Enable Prometheus exporter plugin")
set(FLB_OUT_PROMETHEUS_REMOTE_WRITE OFF CACHE BOOL "Enable Prometheus remote write plugin")
set(FLB_OUT_S3                      OFF CACHE BOOL "Enable AWS S3 output plugin")
set(FLB_OUT_WEBSOCKET               OFF CACHE BOOL "Enable Websocket output plugin")
...
set(FLB_FILTER_RECORD_MODIFIER      OFF CACHE BOOL "Enable record_modifier filter")
