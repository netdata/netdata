# Corduroy: NetdataICP Message Response Modeling
...
### Key Terminology (Netdata Context)
...
### Core ICP Response Modeling Framework (SaaS ICP)
...
**How Scoring Works:**
Each outbound message is scored across these four categories using a mix of:
...
### Decision Tree: Simulating SaaS Buyer Response
