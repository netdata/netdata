...
USAGE: ${PROGRAM} [options]
  ...
  --enable-plugin-journal-viewer Enable the journal viewer plugin. Default: disabled
  --disable-plugin-journal-viewer Explicitly disable the journal viewer plugin.
...
while [ -n "${1}" ]; do
  case "${1}" in
    ...
    "--enable-plugin-journal-viewer") ENABLE_JOURNAL_VIEWER=1 ;;
    "--disable-plugin-journal-viewer") ENABLE_JOURNAL_VIEWER=0 ;;
