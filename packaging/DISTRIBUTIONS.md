...
This is Netdata's TLS capability that incorporates encryption on the web server and the APIs between receivers and
transmitters. Also a mandatory facility for Netdata, but remains optional for users who are limited or not interested in
tight security
