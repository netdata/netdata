...
COMMON_CFLAGS="-static -I/openssl-static/include -I/libmnl-static/include -I/libnetfilter-acct-static/include/libnetfilter_acct -I/curl-local/include/curl -pipe"
