...
You can restrict access by following the [official Caddy guide](https://caddyserver.com/docs/caddyfile/directives/basic_auth) and adding lines to Caddyfile.
