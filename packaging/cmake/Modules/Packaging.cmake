...
if(NOT NETDATA_RPM_HAVE_SYSUSER)
  set(NETDATA_RPM_USER_PREDEP "netdata-user >= ${CPACK_PACKAGE_VERSION}")
else()
...
if(ENABLE_PLUGIN_EBPF)
  list(APPEND _rpm_main_requires "netdata-plugin-ebpf = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_OTEL)
  list(APPEND _rpm_main_requires "netdata-plugin-otel = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_APPS)
  list(APPEND _rpm_main_requires "netdata-plugin-apps = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_PYTHON)
  list(APPEND _rpm_main_requires "netdata-plugin-pythond = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_GO)
  list(APPEND _rpm_main_requires "netdata-plugin-go = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_DEBUGFS)
  list(APPEND _rpm_main_requires "netdata-plugin-debugfs = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_CHARTS)
  list(APPEND _rpm_main_requires "netdata-plugin-chartsd = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_SLABINFO)
  list(APPEND _rpm_main_requires "netdata-plugin-slabinfo = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_PERF)
  list(APPEND _rpm_main_requires "netdata-plugin-perf = ${CPACK_PACKAGE_VERSION}")
endif()
if(ENABLE_PLUGIN_NFACCT)
  list(APPEND _rpm_main_requires "netdata-plugin-nfacct = ${CPACK_PACKAGE_VERSION}")
endif()

if(NETDATA_RPM_HAVE_WEAK_DEPS)
  if(ENABLE_PLUGIN_IBM)
    list(APPEND _rpm_main_suggests "netdata-plugin-ibm = ${CPACK_PACKAGE_VERSION}")
  endif()
  if(ENABLE_PLUGIN_FREEIPMI)
    list(APPEND _rpm_main_suggests "netdata-plugin-freeipmi = ${CPACK_PACKAGE_VERSION}")
  endif()
  if(ENABLE_PLUGIN_CUPS)
    list(APPEND _rpm_main_suggests "netdata-plugin-cups = ${CPACK_PACKAGE_VERSION}")
  endif()
  if(ENABLE_PLUGIN_SYSTEMD_JOURNAL)
    list(APPEND _rpm_main_recommends "netdata-plugin-systemd-journal = ${CPACK_PACKAGE_VERSION}")
  endif()
  if(ENABLE_PLUGIN_SYSTEMD_UNITS)
    list(APPEND _rpm_main_recommends "netdata-plugin-systemd-units = ${CPACK_PACKAGE_VERSION}")
  endif()
  if(ENABLE_PLUGIN_NETWORK_VIEWER)
    list(APPEND _rpm_main_recommends "netdata-plugin-network-viewer = ${CPACK_PACKAGE_VERSION}")
  endif()
  if(ENABLE_PLUGIN_SCRIPTS)
    list(APPEND _rpm_main_recommends "netdata-plugin-scripts = ${CPACK_PACKAGE_VERSION}")
  endif()
else()
  if(ENABLE_PLUGIN_SYSTEMD_JOURNAL)
    list(APPEND _rpm_main_requires "netdata-plugin-systemd-journal = ${CPACK_PACKAGE_VERSION}")
  endif()
  if(ENABLE_PLUGIN_NETWORK_VIEWER)
    list(APPEND _rpm_main_requires "netdata-plugin-network-viewer = ${CPACK_PACKAGE_VERSION}")
  endif()
endif()
...
set(CPACK_RPM_DASHBOARD_PACKAGE_REQUIRES "netdata >= ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_DASHBOARD_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-APPS_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-APPS_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-CHARTSD_PACKAGE_REQUIRES "bash, netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-CHARTSD_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
...
set(CPACK_RPM_PLUGIN-CUPS_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-DEBUGFS_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-DEBUGFS_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-EBPF_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
...
set(CPACK_RPM_EBPF-CODE-LEGACY_PACKAGE_REQUIRES "netdata-plugin-ebpf = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_EBPF-CODE-LEGACY_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-FREEIPMI_PACKAGE_REQUIRES "freeipmi, netdata = ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-GO_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-GO_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_PLUGIN_SUGGESTS)
...
set(CPACK_RPM_PLUGIN-SCRIPTS_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-SCRIPTS_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-IBM-LIBS_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-IBM-LIBS_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
...
set(CPACK_RPM_PLUGIN-NETWORK-VIEWER_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-NETWORK-VIEWER_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(ENABLE_PLUGIN_EBPF)
  if(NETDATA_RPM_HAVE_WEAK_DEPS)
    set(CPACK_RPM_PLUGIN-NETWORK-VIEWER_PACKAGE_RECOMMENDS "netdata-plugin-ebpf = ${CPACK_PACKAGE_VERSION}")
  else()
    string(APPEND CPACK_RPM_PLUGIN-NETWORK-VIEWER_PACKAGE_REQUIRES
           ", netdata-plugin-ebpf = ${CPACK_PACKAGE_VERSION}")
  endif()
endif()
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-OTEL_PACKAGE_REQUIRES "netdata >= ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-OTEL_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
...
set(CPACK_RPM_PLUGIN-NETFLOW_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-NETFLOW_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-NFACCT_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-NFACCT_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-PERF_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-PERF_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
if((NETDATA_DISTRO_EL AND NETDATA_DISTRO_VERSION_MAJOR LESS 8) OR
   (NETDATA_DISTRO_AMZN AND NETDATA_DISTRO_VERSION_MAJOR LESS_EQUAL 2))
  set(CPACK_RPM_PLUGIN-PYTHOND_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}, python")
else()
  set(CPACK_RPM_PLUGIN-PYTHOND_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}, python3")
endif()
set(CPACK_RPM_PLUGIN-PYTHOND_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_PLUGIN_SUGGESTS)
...
set(CPACK_RPM_PLUGIN-SLABINFO_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-SLABINFO_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-SYSTEMD-JOURNAL_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-SYSTEMD-JOURNAL_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-SYSTEMD-UNITS_PACKAGE_REQUIRES "netdata = ${CPACK_PACKAGE_VERSION}")
set(CPACK_RPM_PLUGIN-SYSTEMD-UNITS_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
...
set(CPACK_RPM_PLUGIN-XENSTAT_PACKAGE_CONFLICTS "netdata < ${CPACK_PACKAGE_VERSION}")
if(NETDATA_RPM_USER_PREDEP)
