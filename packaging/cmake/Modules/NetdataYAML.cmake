...
macro(netdata_detect_libyaml)
        ...
        if(ENABLE_BUNDLED_LIBYAML OR NOT YAML_FOUND)
                ...
                get_target_property(NETDATA_YAML_DEFINITIONS yaml INTERFACE_COMPILE_DEFINITIONS)
                get_target_property(NETDATA_YAML_CFLAGS_OTHER yaml INTERFACE_COMPILE_OPTIONS)
        else()
                set(NETDATA_YAML_LDFLAGS ${YAML_LDFLAGS})
                set(NETDATA_YAML_INCLUDE_DIRS ${YAML_INCLUDE_DIRS})
                set(NETDATA_YAML_DEFINITIONS ${YAML_CFLAGS_OTHER})
                set(NETDATA_YAML_CFLAGS_OTHER ${YAML_CFLAGS})
...
function(netdata_add_libyaml_to_target _target)
        ...
        target_compile_definitions(${_target} PUBLIC ${NETDATA_YAML_DEFINITIONS})
