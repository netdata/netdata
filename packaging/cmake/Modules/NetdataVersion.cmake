...
function(netdata_version)
  ...
  string(REGEX MATCH "v?([0-9]+)\\.([0-9]+)\\.([0-9]+)-rc([0-9]+)-?([0-9a-zA-Z]+)?" MATCHES "${GIT_DESCRIBE_OUTPUT}")
  if(CMAKE_MATCH_COUNT EQUAL 4)
    ...
    set(NETDATA_VERSION_TYPE "release-candidate" PARENT_SCOPE)
  elseif(CMAKE_MATCH_COUNT EQUAL 5)
    set(NETDATA_VERSION_MAJOR ${CMAKE_MATCH_1} PARENT_SCOPE)
    set(NETDATA_VERSION_MINOR ${CMAKE_MATCH_2} PARENT_SCOPE)
    set(NETDATA_VERSION_PATCH ${CMAKE_MATCH_3} PARENT_SCOPE)
    set(NETDATA_VERSION_TWEAK ${CMAKE_MATCH_4} PARENT_SCOPE)
    set(NETDATA_VERSION_DESCR "rc-${CMAKE_MATCH_5}" PARENT_SCOPE)
    set(NETDATA_VERSION_TYPE "git" PARENT_SCOPE)
  else()
    ...
    if(CMAKE_MATCH_COUNT EQUAL 3)
      ...
      set(NETDATA_VERSION_DESCR "N/A" PARENT_SCOPE)
      set(NETDATA_VERSION_TYPE "stable" PARENT_SCOPE)
  ...
  if(NETDATA_VERSION_TYPE STREQUAL "stable")
    set(CPACK_PACKAGE_VERSION ${NETDATA_VERSION_MAJOR}.${NETDATA_VERSION_MINOR}.${NETDATA_VERSION_PATCH} PARENT_SCOPE)
  elseif(NETDATA_VERSION_TYPE STREQUAL "release-candidate")
    set(CPACK_PACKAGE_VERSION ${NETDATA_VERSION_MAJOR}.${NETDATA_VERSION_MINOR}.${NETDATA_VERSION_PATCH}~rc${NETDATA_VERSION_TWEAK} PARENT_SCOPE)
  else()
    set(CPACK_PACKAGE_VERSION ${NETDATA_VERSION_MAJOR}.${NETDATA_VERSION_MINOR}.${NETDATA_VERSION_PATCH}-${NETDATA_VERSION_TWEAK}-${NETDATA_VERSION_DESCR} PARENT_SCOPE)
  endif()
endfunction()
