...
if [ -n "${NETDATA_PREFIX}" ] && [ -d "${NETDATA_PREFIX}" ] && [ "netdata" = "$(basename "$NETDATA_PREFIX")" ] ; then
  ...
  rm_file "${NETDATA_PREFIX}/sbin/netdata"
  rm_file "${NETDATA_PREFIX}/sbin/netdatacli"
  rm_file "${NETDATA_PREFIX}/sbin/netdata-claim.sh"
  rm_file "${NETDATA_PREFIX}/sbin/log2journal"
  rm_file "${NETDATA_PREFIX}/sbin/systemd-cat-native"
  ...
  rm_dir "${NETDATA_PREFIX}/share/netdata"
  rm_dir "${NETDATA_PREFIX}/libexec/netdata"
