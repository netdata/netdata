...
- `--dont-start-it`: Don’t auto-start the daemon after installing. This will not always work for the new kickstart script, 
    but is important to keep for some testing scenarios.
