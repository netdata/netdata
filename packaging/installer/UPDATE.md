...
If you installed Netdata using native packages (`binpkg-rpm` or `binpkg-deb`), control upgrades through your system's package manager by holding or pinning the installed version:
