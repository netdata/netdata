...
The single most important rule when writing code is this: _check the surrounding code and try to imitate it_. [Reference](https://developer.gnome.org/programming-guidelines/stable/c-coding-style.html.en)
