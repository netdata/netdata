...
if [ "$currentdir" = "generate" ]; then
	cd ../..
fi
GENERATOR_DIR="docs/generate"

# Copy all netdata .md files to docs/generate/src. Exclude htmldoc itself and also the directory node_modules generated by Netlify
echo "Copying files"
