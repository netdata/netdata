...
- **On-premises requirements** - Multi-node view without Cloud connectivity. For a fully self-hosted Cloud experience, consider [Netdata Cloud On-Prem](https://learn.netdata.cloud/docs/netdata-cloud-on-prem)
