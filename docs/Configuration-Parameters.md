...
| `shared` | `boolean` | `false` | Share across sessions |
| `healthProbe` | `string` | `"ping"` | Health check method |
| `requestTimeoutMs` | `number` | `60000` | Request timeout |
| `toolsAllowed` | `string[]` | `[]` | Tools to expose |
| `toolsDenied` | `string[]` | `[]` | Tools to hide |
...
| `timeoutMs` | `number/string` | `60000` | Stream timeout |
...
| `llmTimeout` | `number` | `120000` | LLM timeout (ms) |
| `toolTimeout` | `number` | `60000` | Tool timeout (ms) |
| `maxTurns` | `number` | `10` | Max conversation turns |
| `maxToolCallsPerTurn` | `number` | `20` | Max tools per turn |
| `maxRetries` | `number` | `3` | Max retry attempts |
| `maxOutputTokens` | `number` | Model default | Max output tokens |
| `toolResponseMaxBytes` | `number` | `12288` | Max tool response size |
| `contextWindowBufferTokens` | `number` | `256` | Context buffer |
| `stream` | `boolean` | `true` | Enable streaming |
| `parallelToolCalls` | `boolean` | `true` | Parallel tool execution |
...
| `maxChunks` | `number` | `10` | Max stored chunks |
| `overlapPercent` | `number` | `10` | Chunk overlap percentage |
| `avgLineBytesThreshold` | `number` | `200` | Line size threshold |
...
|-----------|-------------|---------|-------------|
| `--temperature <n>` | `defaults.temperature` | `0.7` | LLM temperature |
| `--top-p <n>` | `defaults.topP` | `1.0` | Top-p sampling |
| `--llm-timeout <ms>` | `defaults.llmTimeout` | `120000` | LLM timeout |
| `--tool-timeout <ms>` | `defaults.toolTimeout` | `60000` | Tool timeout |
| `--max-output-tokens <n>` | `defaults.maxOutputTokens` | Model default | Max output |
...
| `--parallel-tool-calls / --no-parallel-tool-calls` | `defaults.parallelToolCalls` | `true` | Parallel tools |
...
| `topK` | `number` | - | Top-k |
| `maxOutputTokens` | `number` | Model default | Max output |
