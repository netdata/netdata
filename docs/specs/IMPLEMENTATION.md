...
- LLM error classification: `mapError` uses structured fields (HTTP status, error name/code) and never inspects error message text to classify rate_limit/auth/quota/model/timeout/network.
