...
## TL;DR
Optional tool for reporting intermediate status during execution. Updates session title and emits progress events. Enabled only when external tools or subagents present.
