...
| **description** | Page description used by Learn metadata, search, and social previews.          | Use unique plain text of 50–160 characters. Uniqueness is case-insensitive and NFC-normalized. Do not include `*`, `_`, `[`, `]`, `<`, `>`, `#`, backticks, `~`, URLs, or newlines.          |
