...
Because no server-side AI is involved, **Cloud MCP queries do not consume Netdata AI credits**. AI credits meter only Netdata's built-in, server-side AI features — [Conversations](/docs/netdata-ai/conversations.md), [Investigations](/docs/netdata-ai/investigations/index.md), and [Insights reports](/docs/ml-ai/ai-insights.md). See those pages for per-feature credit costs, plan availability, and how to top up.
