...
|-----------------------------------------|-------------------------------------------------------------------------------------|
| Architecture, kernel, OS metadata       | `_architecture`, `_kernel_version`, `_os`, `_os_name`, `_os_version`, `_os_release`, `_os_codename`, `_os_edition`, `_os_build`, `_os_display_version` |
...
`_os_display_version` preserves the legacy display value for streamed node metadata. Use normalized `_os_version`
when filtering host labels.
