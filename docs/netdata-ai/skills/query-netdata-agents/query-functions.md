...
[../query-netdata-cloud/query-functions.md#list-functions-on-the-nodes-in-a-room](../query-netdata-cloud/query-functions.md#list-functions-on-the-nodes-in-a-room);
