...
nodes](/docs/metrics-storage-management/stream-metrics.mdx) doc. All other configuration options and scenarios are
...
| :---------------------------------------------- | :------------------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`[stream]` section**                          |                           | For configuring a child node.                                                                                                                                                                                                                                                                                                                             |
...
| **`[API_KEY]` section**                         |                           | For configuring a parent node using an `API_KEY`.                                                                                                                                                                                                                                                                                                         |
...
| **`[MACHINE_GUID]` section**                    |                           | For configuring per-child settings on a parent node. The file `/var/lib/netdata/registry/netdata.public.unique.id` contains a random GUID that **uniquely identifies each node**. This file is automatically generated by Netdata the first time it is started and remains unaltered forever. See the `API_KEY` section for descriptions of each setting. |
| `enabled`                                       | `no`                      |                                                                                                                                                                                                                                                                                                                                                           |
...
| `default proxy api key`                         | ` `                       |                                                                                                                                                                                                                                                                                                                                                           |
| `default send charts matching`                  | `*`                       |                                                                                                                                                                                                                                                                                                                                                           |
...
A space-separated list of [Netdata simple patterns](/libnetdata/simple_patterns/README.md) to filter which charts are streamed.
...
- `ram`: Stores metrics _only_ in memory, which means metrics are when Netdata stops or restarts. Ideal for streaming
  configurations that use ephemeral nodes.
