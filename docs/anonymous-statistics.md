...
- Failures to build the dependencies required to be able to use Cloud features.
- Unavailability of Cloud features in Agent.
- Failures to connect to the Cloud in case the Agent has been claimed (you register Agent in Cloud). This includes error code informing us about the reason why the connection failed.
