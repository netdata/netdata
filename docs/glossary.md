...
- [**Dashboard**](https://github.com/netdata/netdata/blob/master/docs/category-overview-pages/accessing-netdata-dashboards.md): Out-of-the box visual presentation of metrics that allow you to make sense of your infrastructure and its health and performance.
