...
See the reverse DNS option in [Configuration](/docs/snmp-traps/configuration.md).
...
3. Check `source.trusted_relays` in [Configuration](/docs/snmp-traps/configuration.md).
...
- Use [Field Reference](/docs/snmp-traps/field-reference.md) for the complete list of trap fields.
- Use [Validation and Data Quality](/docs/snmp-traps/validation-and-data-quality.md) to validate receiver health, source controls, and enrichment quality.
- Use [Configuration](/docs/snmp-traps/configuration.md) to configure source allowlists, trusted relays, reverse DNS, and outputs.
