...
The structure of the documentation is handled by a [map](https://github.com/netdata/netdata/blob/master/docs/.map/map.yaml) file that contains metadata for the Markdown files published from this repository.
