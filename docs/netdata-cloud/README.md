...
- The closest available Parent to the Child for executing a Function through [Live View](/docs/top-monitoring-netdata-functions.md). The streaming protocol can forward the request through the Parents to the leaf Child for a current result.
