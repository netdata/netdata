...
Each node can [stream](/docs/metrics-storage-management/how-streaming-works.mdx) its metrics to any other node, and the
default [registry](/registry/README.md) is configurable to create a private "network" of Netdata dashboards.
