...
[installer script (`kickstart.sh`)](/packaging/installer/methods/kickstart.md). This script automatically installs
dependencies and builds Netdata from its source code with [automatic nightly
updates](/docs/installation/reference-installer.mdx#automatic-updates) and [anonymous
statistics](/docs/anonymous-statistics.md) enabled.
