...
<details>
  <summary><strong>Need a different installation method, or use a different operating system? See all our options.</strong></summary>
  <Install>
    <InstallBox
      to="/docs/agent/packaging/installer/methods/kickstart"
      os="Linux with one-line installer/kickstart script" />
    <InstallBox
      to="/docs/agent/packaging/installer/methods/packages"
      os="Linux with .deb/.rpm packages" />
    <InstallBox
