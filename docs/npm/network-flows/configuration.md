...
- Operational: [Enrichment Intel Downloader](/docs/npm/network-flows/intel-downloader.md) — the bundled refresh tool for MMDB providers.
...
- [Retention and Querying](/docs/npm/network-flows/retention-querying.md) — How the four tiers work and how the dashboard picks one.
- [Sizing and Capacity Planning](/docs/npm/network-flows/sizing-capacity.md) — How much disk and CPU you need.
- [Validation and Data Quality](/docs/npm/network-flows/validation.md) — How to confirm the data is right.
- [Troubleshooting](/docs/npm/network-flows/troubleshooting.md) — When things break.
