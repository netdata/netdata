...
- [Sankey and Table](/docs/npm/network-flows/visualization/summary-sankey.md) — The view that filters drive most often.
- [Retention and Querying](/docs/npm/network-flows/retention-querying.md) — Why filters can shift the tier the query uses.
- [Field Reference](/docs/npm/network-flows/field-reference.md) — Which fields are available as facets.
- [Investigation Playbooks](/docs/npm/network-flows/investigation-playbooks.md) — Practical filter-driven workflows.
