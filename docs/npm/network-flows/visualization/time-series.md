...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/network-flows/visualization/time-series"
slug: "/network-performance-monitoring/network-flows/visualization/time-series"
-->
...
The minimum bucket size is **60 seconds**. Zoom in past one minute and the chart silently widens to 60-second buckets. There's no warning — sub-minute jitter just smooths out. For sub-second analysis, flow data is the wrong tool ([microbursts are invisible](/docs/npm/network-flows/anti-patterns.md)).
...
- [Sankey and Table](/docs/npm/network-flows/visualization/summary-sankey.md) — The default view; same aggregation, point-in-time.
- [Retention and Querying](/docs/npm/network-flows/retention-querying.md) — How tiers map to time ranges.
- [Filters and Facets](/docs/npm/network-flows/visualization/filters-facets.md) — Narrowing the data.
- [Anti-patterns](/docs/npm/network-flows/anti-patterns.md) — Common misuses to avoid when reading time-series volume.
