...
- [Enrichment](/docs/npm/network-flows/enrichment.md) — Order of evaluation and the MMDB shared mechanism that drives geographic visualisation.
...
- [Filters and Facets](/docs/npm/network-flows/visualization/filters-facets.md) — Narrowing geographic views.
- [Anti-patterns](/docs/npm/network-flows/anti-patterns.md) — Why "alert on traffic to country X" is fragile.
