...
- [Filters and Facets](/docs/npm/network-flows/visualization/filters-facets.md) — Filtering mechanics in detail.
- [Time-Series](/docs/npm/network-flows/visualization/time-series.md) — How traffic evolves over the time window.
- [Maps and Globe](/docs/npm/network-flows/visualization/maps-globe.md) — Geographic views.
- [Field Reference](/docs/npm/network-flows/field-reference.md) — Which fields are available for aggregation.
- [Anti-patterns](/docs/npm/network-flows/anti-patterns.md) — How to read the numbers correctly.
