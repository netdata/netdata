...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/network-flows/visualization/plugin-health-charts"
slug: "/network-performance-monitoring/network-flows/visualization/plugin-health-charts"
-->
