...
- [Sankey and Table](/docs/npm/network-flows/visualization/summary-sankey.md) — Full reference for the default view.
- [Filters and Facets](/docs/npm/network-flows/visualization/filters-facets.md) — How to narrow effectively.
- [Time-Series](/docs/npm/network-flows/visualization/time-series.md) — Trends over the time range.
- [Anti-patterns](/docs/npm/network-flows/anti-patterns.md) — What "wrong" looks like and why.
- [Validation and Data Quality](/docs/npm/network-flows/validation.md) — Confirming your numbers before acting on them.
