...
**Example output:**
```
[VRB] → [1.0] agent turn 1 starting
[VRB]   model: openai/gpt-4o
[VRB]   tools: 5 available
[VRB] ← [1.0] agent turn 1 complete (2.3s)
[VRB]   tokens: prompt=1234 completion=567 total=1801
[VRB]   tool_calls: 2
```
