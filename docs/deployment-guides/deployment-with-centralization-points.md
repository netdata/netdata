...
For full instructions, see the [Connect Agent to Cloud guide](/src/claim/README.md). To remove and reconnect a node, see [Unclaim and Reclaim a Node](/docs/learn/unclaim-reclaim-node.md).
