...
For more information, Check [Sizing Netdata Parents](Sizing-Netdata-Parents.md).
...
Check [Restoring a Netdata Parent after maintenance](Clustering-and-High-Availability-of-Netdata-Parents.md#restoring-a-netdata-parent-after-maintenance).
