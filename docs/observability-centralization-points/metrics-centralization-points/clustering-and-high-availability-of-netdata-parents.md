...
Given the [replication limitations](Replication-of-Past-Samples.md#replication-limitations), special care is needed when restoring a Netdata Parent after some long maintenance work on it.
