...
2. You are presented with:
   ...
   - If you're an Administrator, Manager, you'll also see the Rooms from a Space you don't have access to on the **All Rooms** tab, and you can activate notifications for them by joining the Room.
