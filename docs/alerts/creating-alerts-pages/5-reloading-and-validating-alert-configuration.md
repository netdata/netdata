...
- **[Chapter 3: Alert Configuration Syntax (Reference)](../alert-configuration-syntax/README.md)** covers full syntax for `alarm` and `template` definitions
- **[Chapter 4: Controlling Alerts and Noise](../controlling-alerts-noise/README.md)** explains how to use silencing, delays, and hysteresis to reduce noise once alerts are active
- **[Chapter 7: Troubleshooting Alert Behaviour](../troubleshooting-alerts/README.md)** provides deeper debugging when alerts don't behave as expected