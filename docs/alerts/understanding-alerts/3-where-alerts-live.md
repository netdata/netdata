...
- **[Chapter 2: Creating and Managing Alerts](../creating-alerts-pages/README.md)** Step-by-step guides for creating alerts via config files (2.2) and Netdata Cloud UI (2.3)
- **[2.4 Managing Stock vs Custom Alerts](../creating-alerts-pages/4-managing-stock-vs-custom-alerts.md)** Detailed workflow for safely customizing stock alerts
- **[Chapter 3: Alert Configuration Syntax](../alert-configuration-syntax/README.md)** The exact syntax and configuration lines for writing alert definitions
