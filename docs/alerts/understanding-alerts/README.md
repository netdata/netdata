...
In Netdata, an **alert** is a rule that continuously monitors one or more metrics and assigns a **status** based on whether conditions are met.
...
|---------|----------------|
| **[1.1 What is a Netdata Alert?](/docs/alerts/understanding-alerts/1-what-is-a-netdata-alert.md)** | Status values, how alerts relate to charts and contexts |
| **[1.2 Alert Types: `alarm` vs `template`](/docs/alerts/understanding-alerts/2-alert-types-alarm-vs-template.md)** | Chart-specific vs context-based rules |
| **[1.3 Where Alerts Live](/docs/alerts/understanding-alerts/3-where-alerts-live.md)** | File paths, stock vs custom, Cloud integration |
