...
- **[Chapter 2: Creating and Managing Alerts](/docs/creating-alerts-pages/README.md)** How to create/edit alert rules via config files and Netdata Cloud UI
- **[Chapter 3: Alert Configuration Syntax](/docs/alert-configuration-syntax/README.md)** The exact configuration lines and options for defining template-based alerts
