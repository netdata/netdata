...
- [13.2 Alert Lifecycle](/docs/alerts/architecture/README.md) - How alerts transition states
- [13.1 Evaluation Architecture](/docs/alerts/architecture/README.md) - Where alerts are evaluated
