...
- [13.2 Configuration Layers](./4-configuration-layers.md) - How configurations work hierarchically
- [13.4 Notification Dispatch](./3-notification-dispatch.md) - Delivery architecture