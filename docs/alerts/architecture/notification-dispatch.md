...
- [13.3 Evaluation Architecture](evaluation-architecture.md) - Alert evaluation process
- [13.5 Scaling Topologies](scaling-topologies.md) - Distributed notification handling
