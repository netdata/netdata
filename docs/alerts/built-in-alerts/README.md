...
## 6.0.4 What's Included

| Section | Description |
|---------|-------------|
| **[6.1 System Resource Alerts](1-system-resource-alerts.md)** | CPU, memory, disk space, network, load averages |
| **[6.2 Container Alerts](2-container-alerts.md)** | Docker containers, Kubernetes pods, cgroup metrics |
| **[6.3 Application Alerts](3-application-alerts.md)** | MySQL, PostgreSQL, Redis, nginx, Apache, and more |
| **[6.4 Network Alerts](4-network-alerts.md)** | Interface errors, packet drops, bandwidth utilization |
| **[6.5 Hardware Alerts](5-hardware-alerts.md)** | RAID controllers, UPS battery, SMART disk status |

## 6.0.5 Related Sections
