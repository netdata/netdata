...
- **[12.4 Large Environment Patterns](/docs/alerts/best-practices/4-scaling-large-environments.md)** for multi-node setups
- **[13.5 Scaling Topologies](/docs/alerts/architecture/5-scaling-topologies.md)** for complex topologies
...
- **[8.3 Host, Chart, and Label-Based Targeting](/docs/alerts/essential-patterns/README.md#83-host-chart-and-label-based-targeting)** for label usage
- **[12.4 Large Environment Patterns](/docs/alerts/best-practices/4-scaling-large-environments.md)** for multi-room strategies
