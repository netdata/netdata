...
- **[8.1 Hysteresis and Status-Based Conditions](../essential-patterns/1-hysteresis.md)** shows patterns for using status and expressions together to control alert transitions