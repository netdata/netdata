...
If you hover over a chart, the dashboard's state changes to _paused_, as shown in the [top
panel](/docs/dashboard/how-dashboard-works.mdx#play-pause-force-play-and-timeframe-selector).
