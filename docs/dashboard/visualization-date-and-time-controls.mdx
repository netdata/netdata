...
With the timezone select you have the ability to change the timezone both in Agent and on Netdata Cloud. More often than not are 
...
charts to alerts information and across the Netdata Agent and Cloud.
