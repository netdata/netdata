...
* Easily [setup your alert notification process](/docs/nightly/metric-correlations): 
...
or [Anomaly Advisor](/docs/cloud/insights/anomaly-advisor)
...
- [Manage notification methods](/docs/cloud/alerts-notifications/manage-notification-methods)
- [Add webhook notification configuration](/docs/cloud/alerts-notifications/add-webhook-notification-configuration)
- [Add discord notification configuration](/docs/cloud/alerts-notifications/add-discord-notification-configuration)
- [Add slack notification configuration](/docs/cloud/alerts-notifications/add-slack-notification-configuration)
- [Add pagerduty notification configuration](/docs/cloud/alerts-notifications/add-pagerduty-notification-configuration)