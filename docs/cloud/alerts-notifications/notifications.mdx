...
* Have a clear view of the health across your infrastructure, [seeing all a alerts in one place](/docs/nightly/operations/view-active-health-alarms)
* Easily [setup your alert notification process](/docs/nightly/metric-correlations.md): 
methods to use and where to use them, filtering rules, etc.
* Quickly troubleshoot using [Metric Correlations](https://learn.netdata.cloud/docs/nightly/concepts/guided-troubleshooting/metric-correlations) 
or [Anomaly Advisor](/docs/cloud/insights/anomaly-advisor.mdx)
...
#### **Related Concepts**
- [Rooms](/docs/cloud/war-rooms.md)
- [Metric Correlations](/docs/nightly/metric-correlations.md)
- [Anomaly Advisor](/docs/cloud/insights/anomaly-advisor.mdx)

#### Related Tasks
- [View Active health alarms](/docs/nightly/operations/view-active-health-alarms)
- [Manage notification methods](/docs/cloud/alerts-notifications/manage-notification-methods.md)
- [Add webhook notification configuration](/docs/cloud/alerts-notifications/add-webhook-notification-configuration.md)
- [Add discord notification configuration](/docs/cloud/alerts-notifications/add-discord-notification-configuration.md)
- [Add slack notification configuration](/docs/cloud/alerts-notifications/add-slack-notification-configuration.md)
- [Add pagerduty notification configuration](/docs/cloud/alerts-notifications/add-pagerduty-notification-configuration.md)