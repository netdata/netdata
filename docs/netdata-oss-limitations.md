...
In the tables below, **Community** refers to Netdata Cloud Community, **Homelab** refers to Netdata Cloud Homelab, and **Business** refers to Netdata Cloud Business.

:::

:::note

Netdata Cloud offers paid plans: **Homelab** for personal and home lab environments, and **Business** for commercial and enterprise use. Both plans provide the same feature sets. Visit [Netdata Cloud pricing](https://netdata.cloud/pricing) for details.
...
| Alert notifications                |      ✓      |      ✓      |     ✓      |     ✓      |
| Multi-node views                   |   5 nodes   |   5 nodes   | Unlimited  | Unlimited  |
| Custom dashboards                  | 1 per agent | 1 per room  | Unlimited  | Unlimited  |
...
| **Parent-Child WITH Cloud (Homelab)**  | Homelab        | Unlocked for authenticated users | Available             | Cloud dashboards + Dynamic Configuration |
...
| **Dynamic Configuration** | Blocked     | Blocked       | Full access  | Full access  |
| **Multi-node Limit**      | 5 nodes     | 5 nodes       | Unlimited    | Unlimited    |
| **Custom Dashboards**     | 1 per agent | 1 per room    | Unlimited    | Unlimited    |
| **RBAC & SSO**            | N/A         | Not available | Full access  | Full access  |
