...
<details>
  <summary><strong>Don't see an installation method that works for you below?</strong></summary>
  <Install>
    <InstallBox
...
container](https://learn.netdata.cloud/docs/agent/packaging/docker/). Copy the following `docker run` command into your
node and hit `Enter` to download and run the container.
