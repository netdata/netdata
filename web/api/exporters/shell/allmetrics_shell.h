...
extern void rrd_stats_api_v1_charts_allmetrics_json(RRDHOST *host, const char *filter, BUFFER *wb);
extern void rrd_stats_api_v1_charts_allmetrics_shell(RRDHOST *host, const char *filter, BUFFER *wb);
