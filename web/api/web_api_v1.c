...
// /api/v1/registry?action=access&machine=${machine_guid}
// /api/v1/registry?action=delete&machine=${machine_guid}
// /api/v1/registry?action=search&machine=${machine_guid}
// /api/v1/registry?action=search&switch=${machine_guid}
