...
int web_client_api_request_v1_alert_config (RRDHOST *host __maybe_unused, struct web_client *w, char *url) {
...
static struct api_command {
    ...
    int (*callback)(RRDHOST *host, struct web_client *w, char *url);
        ...
        { "alert_config",    0, WEB_CLIENT_ACL_DASHBOARD, web_client_api_request_v1_alert_config    },
