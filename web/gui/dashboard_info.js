...
netdataDashboard.context = {
    ...
    'system.swapio': {
        info: 'Total Swap I/O. (netdata measures both <code>in</code> and <code>out</code>. If neither are shown in the chart, it is because they are zero - (you can change the page settings to always render all the available dimensions on all charts).'
    },
