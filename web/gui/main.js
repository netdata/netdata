...
function renderMyNetdataMenu(machinesArray) {
    ...
    if (!isSignedIn()) {
        html += (
            `<div class="agent-item">
                <i class="fas fa-tv"></i>
                <a onClick="openAuthenticatedUrl('console/index.html');" target="_blank">Nodes<sup style="color:#FFCC00;"> beta</sup></a>
                <div></div>
            </div>
            <div class="agent-item">
        ...
        html += (
            `<div class="agent-item">
                <i class="fas fa-tv"></i>
                <a href"console/index.html" target="_blank">Nodes<sup style="color:#FFCC00;"> beta</sup></a>
                <div></div>
            </div>
            <div class="agent-item">
        ...
        container.innerHTML = (
            ...
            <ul id="cloud-menu" class="dropdown-menu scrollable-menu inpagemenu" role="menu">   
                <li>
                    ...
                    <i class="fas fa-tv"></i>&nbsp;&nbsp;<span class="hidden-sm hidden-md">Nodes<sup style="color:#FFCC00;"> beta</sup></span>
                    </a>
                </li>
                <li>
