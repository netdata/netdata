...
NETDATA.errorCodes = {
    100: {
        message: "Cannot load chart library",
        alert: true
    },
    101: {
        message: "Cannot load jQuery",
        alert: true
    },
    402: {
        message: "Chart library not found",
        alert: false
    },
    403: {
        message: "Chart library not enabled/is failed",
        alert: false
    },
    404: {
    ...
    405: {
        message: "Cannot download charts index from server",
        alert: true
    },
    406: {
    ...
    407: {
        message: "Cannot HELLO netdata server",
        alert: false
    },
    408: {
    ...
    409: {
        message: "Cannot ACCESS netdata registry",
        alert: false
    },
    410: {
        message: "Netdata registry ACCESS failed",
        alert: false
    },
    411: {
    ...
    412: {
        message: "Netdata registry DELETE failed",
        alert: false
    },
    413: {
    ...
    414: {
        message: "Netdata registry SWITCH failed",
        alert: false
    },
    415: {
        message: "Netdata alarms download failed",
        alert: false
    },
    416: {
        message: "Netdata alarms log download failed",
        alert: false
    },
    417: {
    ...
    418: {
        message: "Netdata registry SEARCH failed",
        alert: false
    }
};
NETDATA.errorLast = {
    ...
    this.updateChart = function (callback) {
        ...
        if (this.library.initialized === false) {
            if (this.library.enabled === true) {
                this.library.initialize(function () {
                    that.updateChart(callback);
                });
                return false;
            } else {
...
NETDATA.sparklineChartCreate = function (state, data) {
    ...
    var numberFormatter = self.data('sparkline-numberformatter') || function (n) {
        return n.toFixed(2);
    };
...
NETDATA.dygraphChartCreate = function (state, data) {
    ...
    state.dygraph_options = {
        ...
        valueFormatter: self.data('dygraph-valueformatter') || function (x) {
            return x.toFixed(2);
        },
...
NETDATA.easypiechartChartCreate = function (state, data) {
    ...
    switch (adjust) {
    case 'width':
        size = state.chartHeight();
        break;
    case 'min':
        size = Math.min(state.chartWidth(), state.chartHeight());
        break;
    case 'max':
        size = Math.max(state.chartWidth(), state.chartHeight());
        break;
    case 'height':
    default:
        size = state.chartWidth();
        break;
    }
    ...
    chart.easyPieChart({
        ...
        animate: self.data('easypiechart-rotate') || {
            duration: 500,
            enabled: true
        },
