...
- Docs(prometheus): keep profile questions internal ([#23614](https://github.com/netdata/netdata/issues/23614))
- Regenerate integrations docs ([#23609](https://github.com/netdata/netdata/issues/23609))
- Fix(query): apply absolute to incoming plan points ([#23503](https://github.com/netdata/netdata/issues/23503))
- Fix(query): keep tier-0 evidence on source rows ([#23504](https://github.com/netdata/netdata/issues/23504))
- Fix(query): preserve incremental sum baselines ([#23505](https://github.com/netdata/netdata/issues/23505))
- Fix(query): keep API timestamps independent of retention ([#23507](https://github.com/netdata/netdata/issues/23507))
- Fix(query): preserve multipass contributor counts ([#23508](https://github.com/netdata/netdata/issues/23508))
- Fix(dbengine): accept valid long page cadences ([#23514](https://github.com/netdata/netdata/issues/23514))
- Build(deps): bump github.com/miekg/dns from 1.1.72 to 1.1.73 in /src/go ([#23619](https://github.com/netdata/netdata/issues/23619))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/credentials from 1.19.36 to 1.19.37 in /src/go ([#23617](https://github.com/netdata/netdata/issues/23617))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/resourcegroupstaggingapi from 1.36.1 to 1.36.2 in /src/go ([#23620](https://github.com/netdata/netdata/issues/23620))
- Render Prometheus profile metrics as grouped tables ([#23616](https://github.com/netdata/netdata/issues/23616))
- Build(deps): bump k8s.io/client-go from 0.36.3 to 0.36.4 in /src/go ([#23625](https://github.com/netdata/netdata/issues/23625))
- Build(deps): bump google.golang.org/grpc from 1.83.0 to 1.83.1 in /src/go ([#23623](https://github.com/netdata/netdata/issues/23623))
- Build(deps): bump github.com/vmware/govmomi from 0.55.1 to 0.56.0 in /src/go ([#23629](https://github.com/netdata/netdata/issues/23629))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/cloudwatch from 1.66.5 to 1.66.6 in /src/go ([#23628](https://github.com/netdata/netdata/issues/23628))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/config from 1.32.37 to 1.32.38 in /src/go ([#23626](https://github.com/netdata/netdata/issues/23626))
- Fix(query): preserve sum values across row seams ([#23512](https://github.com/netdata/netdata/issues/23512))
- Chore(go.d): retire dedicated HAProxy collector ([#23631](https://github.com/netdata/netdata/issues/23631))
- Regenerate integrations docs ([#23627](https://github.com/netdata/netdata/issues/23627))
- Docs(mcp): add Custom MCP Server requirements and FAQ ([#23633](https://github.com/netdata/netdata/issues/23633))
- Chore(python.d): retire HAProxy collector ([#23632](https://github.com/netdata/netdata/issues/23632))
- Fix(go.d/snmp): resolve UniFi models from sysDescr ([#23635](https://github.com/netdata/netdata/issues/23635))
- Fix(build): restrict eBPF plugin to 64-bit userlands ([#23446](https://github.com/netdata/netdata/issues/23446))
- Perf(rrd): avoid redundant chart metadata re-interning ([#23603](https://github.com/netdata/netdata/issues/23603))
...
- Build(deps): bump github.com/gofrs/flock from 0.13.0 to 0.13.1 in /src/go ([#23695](https://github.com/netdata/netdata/issues/23695))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/s3 from 1.107.3 to 1.109.1 in /src/go ([#23691](https://github.com/netdata/netdata/issues/23691))
- Build(deps): bump Kubernetes client libraries to 0.37.0 ([#23696](https://github.com/netdata/netdata/issues/23696))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/sts from 1.45.7 to 1.47.1 in /src/go ([#23694](https://github.com/netdata/netdata/issues/23694))
- Build(deps): bump docker/build-push-action from 6 to 7 ([#23689](https://github.com/netdata/netdata/issues/23689))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/config from 1.32.38 to 1.33.1 in /src/go ([#23698](https://github.com/netdata/netdata/issues/23698))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/resourcegroupstaggingapi from 1.36.2 to 1.38.1 in /src/go ([#23702](https://github.com/netdata/netdata/issues/23702))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/cloudwatch from 1.66.6 to 1.69.1 in /src/go ([#23697](https://github.com/netdata/netdata/issues/23697))
- Build(deps): bump google.golang.org/grpc from 1.83.1 to 1.83.2 in /src/go ([#23706](https://github.com/netdata/netdata/issues/23706))
- Build(deps): bump github.com/catonetworks/cato-go-sdk from 0.3.3 to 0.4.0 in /src/go ([#23704](https://github.com/netdata/netdata/issues/23704))
- Build(deps): bump github.com/microsoft/go-mssqldb from 1.10.0 to 1.11.0 in /src/go ([#23703](https://github.com/netdata/netdata/issues/23703))
- Build(deps): bump github.com/Azure/azure-sdk-for-go/sdk/azidentity from 1.14.0 to 1.14.1 in /src/go ([#23705](https://github.com/netdata/netdata/issues/23705))
- Build(deps): bump go.mongodb.org/mongo-driver/v2 from 2.8.0 to 2.8.2 in /src/go ([#23707](https://github.com/netdata/netdata/issues/23707))
- Fix(jobmgr): preserve shutdown errors through redaction ([#23708](https://github.com/netdata/netdata/issues/23708))
- Update version parsing in the updater script. ([#23586](https://github.com/netdata/netdata/issues/23586))
- Feat(go.d/snmp_topology): publish diagnostic archive ([#23709](https://github.com/netdata/netdata/issues/23709))
- Fix(cpp): remove dead stores and avoid copying ML queue items ([#23666](https://github.com/netdata/netdata/issues/23666))
- Pulse: chart dbengine extent decompression throughput ([#23671](https://github.com/netdata/netdata/issues/23671))
- Fix(god./snmp_topology): decode LLDP management addresses from indexes ([#23713](https://github.com/netdata/netdata/issues/23713))
- Fix dbengine empty flush batch counter leak ([#23699](https://github.com/netdata/netdata/issues/23699))
- Fix(go.d/snmp_topology): validate LLDP management address size ([#23715](https://github.com/netdata/netdata/issues/23715))
- Fix(go.d/snmp_topology): inspect links by replay index ([#23716](https://github.com/netdata/netdata/issues/23716))
...
- Convert File Descriptor monitor to GO (ebpf.plugin) ([#23642](https://github.com/netdata/netdata/issues/23642))
- Feat(go.d): add independent SNMP-backed virtual nodes ([#23823](https://github.com/netdata/netdata/issues/23823))
- Refactor(support-bundle): improve Unix script maintainability and reliability ([#23825](https://github.com/netdata/netdata/issues/23825))
- Integrations: add AlmaLinux deploy target ([#23725](https://github.com/netdata/netdata/issues/23725))
- Feat(go.d/snmp): inspect diagnostics directly from support bundles ([#23827](https://github.com/netdata/netdata/issues/23827))
- Docs(skills): add offline diagnostics triage skill ([#23828](https://github.com/netdata/netdata/issues/23828))
- Otel-plugin: bind the gRPC endpoint before declaring Functions ([#23826](https://github.com/netdata/netdata/issues/23826))
- Docs(agents): clarify workflow and knowledge capture policies ([#23831](https://github.com/netdata/netdata/issues/23831))
- Fix kickstart install-prefix sanitization for safe paths ([#23830](https://github.com/netdata/netdata/issues/23830))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/credentials from 1.20.2 to 1.20.3 in /src/go ([#23833](https://github.com/netdata/netdata/issues/23833))
- Build(deps): bump go.mongodb.org/mongo-driver/v2 from 2.8.2 to 2.9.0 in /src/go ([#23836](https://github.com/netdata/netdata/issues/23836))
- Build(deps): bump golang.org/x/sync from 0.22.0 to 0.23.0 in /src/go ([#23834](https://github.com/netdata/netdata/issues/23834))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/config from 1.33.2 to 1.33.3 in /src/go ([#23838](https://github.com/netdata/netdata/issues/23838))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/s3 from 1.110.0 to 1.111.0 in /src/go ([#23837](https://github.com/netdata/netdata/issues/23837))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/cloudwatch from 1.70.0 to 1.71.0 in /src/go ([#23835](https://github.com/netdata/netdata/issues/23835))
...
- Feat(health/alarm-notify): add Opsgenie ([#23898](https://github.com/netdata/netdata/issues/23898))
- Feat(health/alarm-notify): add Teams and Matrix ([#23900](https://github.com/netdata/netdata/issues/23900))
- Feat(health/alarm-notify): add custom commands and smstools3 ([#23901](https://github.com/netdata/netdata/issues/23901))
- Feat(health/alarm-notify): add syslog ([#23902](https://github.com/netdata/netdata/issues/23902))
- Feat(go.d): add Redfish monitoring ([#23343](https://github.com/netdata/netdata/issues/23343))
- Feat(nd-run): add one-shot unprivileged file operations ([#23887](https://github.com/netdata/netdata/issues/23887))
- Feat(health/alarm-notify): add AWS SNS delivery ([#23906](https://github.com/netdata/netdata/issues/23906))
- Feat(health/alarm-notify): add Kafka HTTP bridge delivery ([#23907](https://github.com/netdata/netdata/issues/23907))
- Refactor(go.d/redfish): remove optional subsystems ([#23909](https://github.com/netdata/netdata/issues/23909))
- Fix(go.d): drop privileges for configured credential-file reads ([#23884](https://github.com/netdata/netdata/issues/23884))
- Docs(skills/collectors): require evidence for added design complexity ([#23910](https://github.com/netdata/netdata/issues/23910))
- Feat(health/alarm-notify): add email delivery through sendmail ([#23908](https://github.com/netdata/netdata/issues/23908))
- Otel-traces: filter the overview heatmap by the page's selections ([#23905](https://github.com/netdata/netdata/issues/23905))
- Feat(health/alarm-notify): add IRC delivery through nc ([#23911](https://github.com/netdata/netdata/issues/23911))
- Refactor(go.d/redfish): simplify hardware monitoring ([#23912](https://github.com/netdata/netdata/issues/23912))
- Feat(health/alarm-notify): add destination status filters ([#23913](https://github.com/netdata/netdata/issues/23913))
- Fix(go.d): restrict secret references to operator-authored configs ([#23916](https://github.com/netdata/netdata/issues/23916))
- Refactor(health/alarm-notify): extract shared notification foundations ([#23914](https://github.com/netdata/netdata/issues/23914))
- Docs(agents): make review requirements proportionate to risk ([#23917](https://github.com/netdata/netdata/issues/23917))
- Refactor(go.d/redfish): simplify collector structure and responsibilities ([#23915](https://github.com/netdata/netdata/issues/23915))
- Feat(go.d): allow per-pipeline trust of discovered targets ([#23918](https://github.com/netdata/netdata/issues/23918))
- Refactor(health/alarm-notify): isolate typed provider implementations ([#23919](https://github.com/netdata/netdata/issues/23919))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/s3 from 1.113.0 to 1.113.1 in /src/go ([#23920](https://github.com/netdata/netdata/issues/23920))
- Feat(health): add critical-history policies to Go notifier ([#23921](https://github.com/netdata/netdata/issues/23921))
- Refactor(go.d/redfish): replace custom protocol machinery with gofish ([#23922](https://github.com/netdata/netdata/issues/23922))
- Docs(secrets): document secret-resolution execution privileges and SNMP scan exposure ([#23923](https://github.com/netdata/netdata/issues/23923))
- Regenerate integrations docs ([#23824](https://github.com/netdata/netdata/issues/23824))
- Feat(health/alarm-notify): add native legacy notification config reader ([#23925](https://github.com/netdata/netdata/issues/23925))
- Refactor(go.d/redfish): separate measurement conversion from acquisition ([#23926](https://github.com/netdata/netdata/issues/23926))
- Feat(health/alarm-notify): add legacy notification recipient routing ([#23928](https://github.com/netdata/netdata/issues/23928))
- Refactor(go.d/redfish): isolate endpoint acquisition ([#23929](https://github.com/netdata/netdata/issues/23929))
- Feat(health/alarm-notify): add legacy configuration delivery to Go notifier ([#23930](https://github.com/netdata/netdata/issues/23930))
- Feat(health/alarm-notify): support legacy Slack and Teams configuration ([#23931](https://github.com/netdata/netdata/issues/23931))
- Feat(go.d/redfish): add sensor and hardware functions ([#23933](https://github.com/netdata/netdata/issues/23933))
- Feat(health/alarm-notify): map legacy ilert, Opsgenie and Dynatrace settings ([#23934](https://github.com/netdata/netdata/issues/23934))
- Test(go.d/redfish): expect registered function hooks ([#23938](https://github.com/netdata/netdata/issues/23938))
...
- Replace deprecated bzero and usleep with portable wrappers ([#22566](https://github.com/netdata/netdata/issues/22566))
- Improve ML host access ([#22559](https://github.com/netdata/netdata/issues/22559))
- Update metadata.yaml ([#22560](https://github.com/netdata/netdata/issues/22560))
- Regenerate integrations docs ([#22564](https://github.com/netdata/netdata/issues/22564))
- Docs: task class: improve_docs — add claiming instructions for ([#22568](https://github.com/netdata/netdata/issues/22568))
...
- Docs: fix Hyper-V integration overview in metadata.yaml ([#22522](https://github.com/netdata/netdata/issues/22522))
- Update vendored NetIPC library ([#22649](https://github.com/netdata/netdata/issues/22649))
- Chore(go.d/prometheus): migrate to framework v2 ([#22651](https://github.com/netdata/netdata/issues/22651))
- Fix sum on incremental dimensions for archived dims ([#22580](https://github.com/netdata/netdata/issues/22580))
- Add slot bounds check and unit tests for pluginsd_parser ([#22598](https://github.com/netdata/netdata/issues/22598))
- Build(deps): update go toolchain to v1.26.4 ([#22654](https://github.com/netdata/netdata/issues/22654))
- Docs(go.d): add V1-to-V2 parity-manifest recipe and V2-collector patterns ([#22656](https://github.com/netdata/netdata/issues/22656))
- Silence output from curl in netdata-updater.sh ([#22639](https://github.com/netdata/netdata/issues/22639))
...
- NetFlow: journal backend on systemd-journal-sdk, compact format, optional fsync ([#22665](https://github.com/netdata/netdata/issues/22665))
- Build(deps): bump github.com/redis/go-redis/v9 from 9.20.0 to 9.20.1 in /src/go ([#22701](https://github.com/netdata/netdata/issues/22701))
- Build(deps): bump google.golang.org/grpc from 1.79.3 to 1.81.1 in /src/go ([#22700](https://github.com/netdata/netdata/issues/22700))
- Build(deps): bump golang.org/x/sys from 0.45.0 to 0.46.0 in /src/go ([#22699](https://github.com/netdata/netdata/issues/22699))
- Build(deps): bump k8s.io/client-go from 0.36.1 to 0.36.2 in /src/go ([#22706](https://github.com/netdata/netdata/issues/22706))
- Build(deps): bump github.com/prometheus-community/pro-bing from 0.8.0 to 0.9.0 in /src/go ([#22707](https://github.com/netdata/netdata/issues/22707))
- Build(deps): bump golang.org/x/net from 0.55.0 to 0.56.0 in /src/go ([#22708](https://github.com/netdata/netdata/issues/22708))
- Build(deps): bump gopkg.in/ini.v1 from 1.67.2 to 1.67.3 in /src/go ([#22709](https://github.com/netdata/netdata/issues/22709))
- NetFlow: offload rollup-tier commits to per-tier worker threads ([#22703](https://github.com/netdata/netdata/issues/22703))
- Add SNMP traps documentation and metrics ([#22702](https://github.com/netdata/netdata/issues/22702))
- Topology: add container grouping to network connection topology ([#22601](https://github.com/netdata/netdata/issues/22601))
...
- Fix buffer overflow / off-by-one in claim and freebsd_ipfw collectors ([#22710](https://github.com/netdata/netdata/issues/22710))
- Docs: document netdatacli commands for Windows in Service Control and CLI README ([#22610](https://github.com/netdata/netdata/issues/22610))
- Docs: escape `labels:<pattern>` placeholder in network-viewer metadata ([#22733](https://github.com/netdata/netdata/issues/22733))
- Record spinlock holder identity for datafile/journal deadlock fatals ([#22725](https://github.com/netdata/netdata/issues/22725))
- Docs(docker): document docker_container_down alert disabled by default ([#22612](https://github.com/netdata/netdata/issues/22612))
- Feat(go.d/mssql): add SQL Agent job execution metrics ([#22730](https://github.com/netdata/netdata/issues/22730))
- Regenerate integrations docs ([#22734](https://github.com/netdata/netdata/issues/22734))
- Chore(go.d): migrate Docker API usage to Moby modules ([#22738](https://github.com/netdata/netdata/issues/22738))
- Build(deps): bump rand from 0.9.2 to 0.9.3 in /src/crates ([#22251](https://github.com/netdata/netdata/issues/22251))
- Build(deps): bump rustls-webpki from 0.103.10 to 0.103.13 in /src/crates ([#22269](https://github.com/netdata/netdata/issues/22269))
- Improve error handling in the kickstart script when fetching files. ([#22424](https://github.com/netdata/netdata/issues/22424))
- MCP Streamable HTTP: return 202/no-body for notification-only POSTs ([#22597](https://github.com/netdata/netdata/issues/22597))
- Docs: Add a Gmail-specific msmtp configuration example to the email ([#22629](https://github.com/netdata/netdata/issues/22629))
- Regenerate integrations docs ([#22740](https://github.com/netdata/netdata/issues/22740))
- Update map.yaml ([#22741](https://github.com/netdata/netdata/issues/22741))
- Chore(go.d/mongodb): Migrate MongoDB Go driver to v2 ([#22742](https://github.com/netdata/netdata/issues/22742))
- Fix(go.d/fail2ban): move fail2ban socket path into ndsudo ([#22745](https://github.com/netdata/netdata/issues/22745))
...
- Refactor(go.d): decouple SNMP topology function ownership ([#22753](https://github.com/netdata/netdata/issues/22753))
- Docs: Add a concise note to the RBAC model page stating that role changes ([#22658](https://github.com/netdata/netdata/issues/22658))
- Docs: Fix misleading StatsD example metric names in config docs ([#22674](https://github.com/netdata/netdata/issues/22674))
- Switch log level from `NOTICE` to `DEBUG` for active context checkpoint logs ([#22758](https://github.com/netdata/netdata/issues/22758))
- Refactor(go.d): migrate SNMP topology to V2 single instance ([#22762](https://github.com/netdata/netdata/issues/22762))
- Track and account memory allocation size in replication queries ([#22756](https://github.com/netdata/netdata/issues/22756))
- Docs: Clarify StatsD [app] section is a namespace requiring chart ([#22673](https://github.com/netdata/netdata/issues/22673))
- Refactor(go.d): bind single-instance functions to runtime job ([#22767](https://github.com/netdata/netdata/issues/22767))
- Add chart to monitor in-flight ACLK messages ([#22757](https://github.com/netdata/netdata/issues/22757))
- Streaming: add receiver disconnect diagnostics and per-child join keys ([#22769](https://github.com/netdata/netdata/issues/22769))
- Adjust ML model deletion query ([#22763](https://github.com/netdata/netdata/issues/22763))
- Refactor(go.d/snmp): inject shared SNMP state ([#22770](https://github.com/netdata/netdata/issues/22770))
- Sonar cleanup ([#22760](https://github.com/netdata/netdata/issues/22760))
- Chore(go.d/snmp_topology): remove dead cache snapshot path ([#22773](https://github.com/netdata/netdata/issues/22773))
- Bump rand to 0.9.4 in Cargo.lock ([#22772](https://github.com/netdata/netdata/issues/22772))
- Chore(go.d/snmp-topology): extract topology Function package ([#22774](https://github.com/netdata/netdata/issues/22774))
- Chore(snmp_topology): split v1 topology renderer ([#22775](https://github.com/netdata/netdata/issues/22775))
...
- Docs: cgroups.plugin README — cgroup.name override, accuracy overhaul, Learn publication ([#22726](https://github.com/netdata/netdata/issues/22726))
- Network Performance Monitoring section + SNMP integration catalog ([#22840](https://github.com/netdata/netdata/issues/22840))
- Docs: Add kickstart SSL/certificate download troubleshooting ([#22739](https://github.com/netdata/netdata/issues/22739))
- Regenerate integrations docs ([#22842](https://github.com/netdata/netdata/issues/22842))
- Docs: Document disabling auto-updates ([#22737](https://github.com/netdata/netdata/issues/22737))
- Test(go.d/snmp-topology): add scenario golden harness ([#22843](https://github.com/netdata/netdata/issues/22843))
- Docs: Correct windows.plugin disabled defaults and add missing config entries ([#22743](https://github.com/netdata/netdata/issues/22743))
- Docs: Clarify Groups tab requires SCIM SSO in User Management ([#22744](https://github.com/netdata/netdata/issues/22744))
- Fix(go.d/snmp): tolerate invalid optional typed row values ([#22846](https://github.com/netdata/netdata/issues/22846))
- Docs: Document prototype vs per-rule alert enable/disable behavior ([#22735](https://github.com/netdata/netdata/issues/22735))
- Test(go.d/snmp_topology): add semantic scenario assertions ([#22851](https://github.com/netdata/netdata/issues/22851))
- Fix SNMP traps DynCfg schema name validation ([#22849](https://github.com/netdata/netdata/issues/22849))
- Feat(go.d): publish SNMP topology function after data is ready ([#22853](https://github.com/netdata/netdata/issues/22853))
- Build: enable netflow plugin in static and docker builds ([#22852](https://github.com/netdata/netdata/issues/22852))
- Refactor(go.d): funnel function reconcile through job manager ([#22856](https://github.com/netdata/netdata/issues/22856))
- NPM docs: capability overviews + Integrations submenu ([#22854](https://github.com/netdata/netdata/issues/22854))
- Regenerate integrations docs ([#22858](https://github.com/netdata/netdata/issues/22858))
- Refactor(go.d): prepare function publication state ([#22857](https://github.com/netdata/netdata/issues/22857))
...
- Fix(streaming): reject oversized ZSTD frames instead of fatal() ([#22830](https://github.com/netdata/netdata/issues/22830))
- Add decompression-bomb guard to WebSocket message handling (CWE-409) ([#22828](https://github.com/netdata/netdata/issues/22828))
- Build(deps): bump github.com/redis/go-redis/v9 from 9.20.1 to 9.21.0 in /src/go ([#22888](https://github.com/netdata/netdata/issues/22888))
- Build(deps): bump github.com/vmware/govmomi from 0.54.1 to 0.55.0 in /src/go ([#22886](https://github.com/netdata/netdata/issues/22886))
- Build(deps): bump github.com/netdata/systemd-journal-sdk/go from 0.7.5 to 0.7.6 in /src/go ([#22887](https://github.com/netdata/netdata/issues/22887))
- Build(deps): bump actions/cache from 5 to 6 ([#22884](https://github.com/netdata/netdata/issues/22884))
- Docs(map): fix duplicate Learn route for Service Discovery ([#22889](https://github.com/netdata/netdata/issues/22889))
- Docs: Document virtual node GUI and dynamic configuration creation ([#22766](https://github.com/netdata/netdata/issues/22766))
- Docs: Add Cloud firewall egress allowlisting to agent security doc ([#22765](https://github.com/netdata/netdata/issues/22765))
- Docs(map): route Service Discovery via integration_placeholder ([#22895](https://github.com/netdata/netdata/issues/22895))
- Docs: fix SD learn rel path ([#22898](https://github.com/netdata/netdata/issues/22898))
- Chore(codeowners): own .agents/ with maintainers ([#22899](https://github.com/netdata/netdata/issues/22899))
- Refactor SPINLOCK_TRACKED to store acquire-site function names inline ([#22890](https://github.com/netdata/netdata/issues/22890))
- Build(rust): keep line tables instead of full debuginfo ([#22907](https://github.com/netdata/netdata/issues/22907))
- Build(packaging): enable scripts.d plugin in static and docker builds ([#22892](https://github.com/netdata/netdata/issues/22892))
- Fix _is_parent label update on receiver bursts ([#22902](https://github.com/netdata/netdata/issues/22902))
- Netdata fixes part 1 ([#22900](https://github.com/netdata/netdata/issues/22900))
- Netdata fixes part 2 ([#22901](https://github.com/netdata/netdata/issues/22901))
- Netdata fixes part 3 ([#22903](https://github.com/netdata/netdata/issues/22903))
- Netdata fixes part 4 ([#22904](https://github.com/netdata/netdata/issues/22904))
- Netdata fixes part 6 ([#22906](https://github.com/netdata/netdata/issues/22906))
- Netdata fixes part 7 ([#22909](https://github.com/netdata/netdata/issues/22909))
- Fix coverity issues ([#22835](https://github.com/netdata/netdata/issues/22835))
- Netdata fixes part 8 ([#22908](https://github.com/netdata/netdata/issues/22908))
- Docs: Add outbound communication paths to Agent security design page ([#22778](https://github.com/netdata/netdata/issues/22778))
- Docs: document managing automatic updates in the Update guide ([#22768](https://github.com/netdata/netdata/issues/22768))
- Docs: Add EKS Kubernetes monitoring cross-link to AWS install guide ([#22817](https://github.com/netdata/netdata/issues/22817))
- Remove openSUSE Leap 15.6 from CI and package builds. ([#22239](https://github.com/netdata/netdata/issues/22239))
- Fix DBEngine retention accounting underflow ([#22914](https://github.com/netdata/netdata/issues/22914))
- Netdata fixes part 5 ([#22905](https://github.com/netdata/netdata/issues/22905))
- Netdata fixes part 9 ([#22910](https://github.com/netdata/netdata/issues/22910))
- Netdata fixes part 10 ([#22911](https://github.com/netdata/netdata/issues/22911))
- Netdata fixes part 11 ([#22912](https://github.com/netdata/netdata/issues/22912))
- Netdata fixes part 12 ([#22913](https://github.com/netdata/netdata/issues/22913))
...
- Netdata fixes part 31 ([#22971](https://github.com/netdata/netdata/issues/22971))
- Netdata fixes part 32 ([#22972](https://github.com/netdata/netdata/issues/22972))
- Netdata fixes part 33 ([#22973](https://github.com/netdata/netdata/issues/22973))
- Netdata fixes part 34 ([#22974](https://github.com/netdata/netdata/issues/22974))
- Netdata fixes part 35 ([#22975](https://github.com/netdata/netdata/issues/22975))
- Netdata fixes part 36 ([#22976](https://github.com/netdata/netdata/issues/22976))
- Netdata fixes part 37 ([#22977](https://github.com/netdata/netdata/issues/22977))
- Docs: Add bundled Protobuf stall workaround flags to manual install ([#22946](https://github.com/netdata/netdata/issues/22946))
- Refactor(go.d): shared profile-catalog loader + lazy prometheus profiles ([#23016](https://github.com/netdata/netdata/issues/23016))
- Docs: Clarify Windows installer claim fields are Cloud-only ([#22961](https://github.com/netdata/netdata/issues/22961))
- Fix(go.d): unify histogram bucket dimension names ([#23021](https://github.com/netdata/netdata/issues/23021))
- Docs: fix remove-stale-node Offline-transition and cleanup-timing claims ([#22962](https://github.com/netdata/netdata/issues/22962))
- Docs: Clarify 5-node limit is display-only, not streaming ([#22957](https://github.com/netdata/netdata/issues/22957))
- Docs: Add Docker section to netflow plugin installation guide ([#22960](https://github.com/netdata/netdata/issues/22960))
- Feat(go.d/cloudwatch): add stock health alerts ([#23024](https://github.com/netdata/netdata/issues/23024))
- Docs: Fix Functions tab reference to Live tab in NPM quick-start ([#22981](https://github.com/netdata/netdata/issues/22981))
- Feat(go.d/cloudwatch): add MSK stock health alerts ([#23028](https://github.com/netdata/netdata/issues/23028))
- Docs: Add minimum system requirements to resource utilization page ([#22963](https://github.com/netdata/netdata/issues/22963))
- Feat(go.d/cloudwatch): add target health and MSK alarms ([#23031](https://github.com/netdata/netdata/issues/23031))
- Netdata fixes part 38 ([#22999](https://github.com/netdata/netdata/issues/22999))
- Netdata fixes part 39 ([#23000](https://github.com/netdata/netdata/issues/23000))
- Update systemd journal SDK to 0.7.8 ([#23033](https://github.com/netdata/netdata/issues/23033))
- Fix view.dimensions.sts.avg for group-by aggregation percentage ([#23035](https://github.com/netdata/netdata/issues/23035))
- Percentage group-by: per-row anomaly rate and zero-denominator guard ([#23037](https://github.com/netdata/netdata/issues/23037))
- Netdata fixes part 40 ([#23002](https://github.com/netdata/netdata/issues/23002))
- Netdata fixes part 41 ([#23007](https://github.com/netdata/netdata/issues/23007))
- Netdata fixes part 42 ([#23009](https://github.com/netdata/netdata/issues/23009))
- Netdata fixes part 43 ([#23010](https://github.com/netdata/netdata/issues/23010))
- Netdata fixes part 44 ([#23015](https://github.com/netdata/netdata/issues/23015))
- Netdata fixes part 45 ([#23017](https://github.com/netdata/netdata/issues/23017))
- Docs: Add post-install dashboard verification to installer README ([#22980](https://github.com/netdata/netdata/issues/22980))
- Docs: Link node removal guide to Service Control and Uninstall docs ([#22987](https://github.com/netdata/netdata/issues/22987))
- Docs: Document brace syntax for dimension names with spaces in alert ([#22984](https://github.com/netdata/netdata/issues/22984))
- Docs: Add netflow plugin package-not-found troubleshooting ([#22982](https://github.com/netdata/netdata/issues/22982))
- Docs: Surface existing-agent claiming in getting-started guide ([#22989](https://github.com/netdata/netdata/issues/22989))
- Docs(mcp): document MCP Connections (Netdata Cloud as MCP client) ([#23049](https://github.com/netdata/netdata/issues/23049))
- Feat(go.d/metrix): transactional, bounded descriptor lifecycle ([#23053](https://github.com/netdata/netdata/issues/23053))
- Netdata fixes part 46 ([#23018](https://github.com/netdata/netdata/issues/23018))
- Netdata fixes part 47 ([#23019](https://github.com/netdata/netdata/issues/23019))
- Netdata fixes part 48 ([#23020](https://github.com/netdata/netdata/issues/23020))
- Docs(agents): workflow lessons + SOW friction-tracking ([#23054](https://github.com/netdata/netdata/issues/23054))
- Netdata fixes part 49 ([#23023](https://github.com/netdata/netdata/issues/23023))
- Netdata fixes part 50 ([#23026](https://github.com/netdata/netdata/issues/23026))
- Netdata fixes part 51 ([#23029](https://github.com/netdata/netdata/issues/23029))
- Netdata fixes part 52 ([#23042](https://github.com/netdata/netdata/issues/23042))
- Replace HTTP_ACL_NOCHECK with HTTP_ACL_DASHBOARD on /api/v3/settings ([#22896](https://github.com/netdata/netdata/issues/22896))
- Go.d/nvidia_smi: restore stable temperature/power collection with driver 580 XML variants ([#23047](https://github.com/netdata/netdata/issues/23047))
- Docs: remove cloudwatch from Prometheus metadata ([#23058](https://github.com/netdata/netdata/issues/23058))
- Netdata fixes part 21 ([#22938](https://github.com/netdata/netdata/issues/22938))
- Regenerate integrations docs ([#23059](https://github.com/netdata/netdata/issues/23059))
- Build(deps): bump golang.org/x/text from 0.38.0 to 0.40.0 in /src/go ([#23063](https://github.com/netdata/netdata/issues/23063))
- Build(deps): bump github.com/prometheus-community/pro-bing from 0.9.0 to 0.9.1 in /src/go ([#23062](https://github.com/netdata/netdata/issues/23062))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/config from 1.32.27 to 1.32.29 in /src/go ([#23064](https://github.com/netdata/netdata/issues/23064))
- Build(deps): bump google.golang.org/grpc from 1.81.1 to 1.82.0 in /src/go ([#23068](https://github.com/netdata/netdata/issues/23068))
- Build(deps): bump github.com/klauspost/compress from 1.18.6 to 1.19.0 in /src/go ([#23067](https://github.com/netdata/netdata/issues/23067))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/resourcegroupstaggingapi from 1.33.5 to 1.34.0 in /src/go ([#23060](https://github.com/netdata/netdata/issues/23060))
- Build(deps): bump github.com/vmware/govmomi from 0.55.0 to 0.55.1 in /src/go ([#23066](https://github.com/netdata/netdata/issues/23066))
- Build(deps): update go toolchain to v1.26.5 ([#23065](https://github.com/netdata/netdata/issues/23065))
- Build(deps): bump golang.org/x/net from 0.56.0 to 0.57.0 in /src/go ([#23069](https://github.com/netdata/netdata/issues/23069))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/cloudwatch from 1.61.1 to 1.62.0 in /src/go ([#23061](https://github.com/netdata/netdata/issues/23061))
- OpenTelemetry logs ingestion/query subsystem ([#22720](https://github.com/netdata/netdata/issues/22720))
...
- Fix view.dimensions.sts.avg for group-by aggregations sum, min, max, extremes ([#23097](https://github.com/netdata/netdata/issues/23097))
- Dbengine: record metric retention start when its first page gets data ([#23096](https://github.com/netdata/netdata/issues/23096))
- Build(deps): bump go.mongodb.org/mongo-driver/v2 from 2.7.0 to 2.8.0 in /src/go ([#23098](https://github.com/netdata/netdata/issues/23098))
- Build(deps): bump github.com/prometheus/common from 0.69.0 to 0.70.0 in /src/go ([#23100](https://github.com/netdata/netdata/issues/23100))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/cloudwatch from 1.62.0 to 1.63.0 in /src/go ([#23099](https://github.com/netdata/netdata/issues/23099))
- Feat(go.d/cloudwatch): add per-rule query policies for sparse metrics ([#23094](https://github.com/netdata/netdata/issues/23094))
- Build(deps): bump github.com/lmittmann/tint from 1.1.3 to 1.2.0 in /src/go ([#23101](https://github.com/netdata/netdata/issues/23101))
- Docs: Add per-app network bandwidth pointer to apps.plugin README ([#23001](https://github.com/netdata/netdata/issues/23001))
- Fix group-by percentage at the second grouping level with a dimensions filter ([#23104](https://github.com/netdata/netdata/issues/23104))
- Docs: Add hostname display guidance to Group by Node in charts ([#23012](https://github.com/netdata/netdata/issues/23012))
- Docs: Add Windows config and health.d alert template path guidance ([#23003](https://github.com/netdata/netdata/issues/23003))
- Docs: Clarify Cloud alert edits apply instantly and override stock files ([#23008](https://github.com/netdata/netdata/issues/23008))
- Cgroups: add cgroup-name Go helper ([#22685](https://github.com/netdata/netdata/issues/22685))
- Feat(go.d/cloudwatch): add AWS Billing profiles ([#23110](https://github.com/netdata/netdata/issues/23110))
- Fix cardinality_limit crashes and limit only the result dataset by default ([#23108](https://github.com/netdata/netdata/issues/23108))
- Feat(go.d/cloudwatch): add AWS PrivateLink endpoint profiles ([#23113](https://github.com/netdata/netdata/issues/23113))
- Netdata fixes part 55 ([#23071](https://github.com/netdata/netdata/issues/23071))
- Netdata fixes part 56 ([#23072](https://github.com/netdata/netdata/issues/23072))
- Fix false PARTIAL annotations on complete data ([#23114](https://github.com/netdata/netdata/issues/23114))
- Netdata fixes part 58 ([#23078](https://github.com/netdata/netdata/issues/23078))
- Netdata fixes part 59 ([#23080](https://github.com/netdata/netdata/issues/23080))
- Netdata fixes part 57 ([#23077](https://github.com/netdata/netdata/issues/23077))
...
- Build(deps): bump github.com/aws/aws-sdk-go-v2/config from 1.32.29 to 1.32.30 in /src/go ([#23173](https://github.com/netdata/netdata/issues/23173))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/cloudwatch from 1.63.0 to 1.63.1 in /src/go ([#23174](https://github.com/netdata/netdata/issues/23174))
- Build(deps): bump github.com/aws/aws-sdk-go-v2/service/resourcegroupstaggingapi from 1.34.0 to 1.34.1 in /src/go ([#23177](https://github.com/netdata/netdata/issues/23177))
- Build(deps): bump google.golang.org/grpc from 1.82.0 to 1.82.1 in /src/go ([#23180](https://github.com/netdata/netdata/issues/23180))
...
- Netdata fixes part 78 ([#23153](https://github.com/netdata/netdata/issues/23153))
- Netdata fixes part 83 ([#23171](https://github.com/netdata/netdata/issues/23171))
- MCP: limit metadata exposed to anonymous callers ([#22891](https://github.com/netdata/netdata/issues/22891))
- Docs: Clarify FQDN/hostname support in streaming destination setting ([#23107](https://github.com/netdata/netdata/issues/23107))
- Docs: Fill network interface_type and device label descriptions ([#23111](https://github.com/netdata/netdata/issues/23111))
- Docs: Fix incorrect netdata --version to -V in troubleshooting guide ([#23147](https://github.com/netdata/netdata/issues/23147))
- Docs: Add Docker container env vars reference page ([#23112](https://github.com/netdata/netdata/issues/23112))
- Docs: Clarify lookup-only templates without warn/crit produce UNDEFINED ([#23167](https://github.com/netdata/netdata/issues/23167))
- Regenerate integrations docs ([#23228](https://github.com/netdata/netdata/issues/23228))
- Docs: Document OTel logs retention and storage config defaults ([#23165](https://github.com/netdata/netdata/issues/23165))
- Refactor(go.d/jobmgr): replace distributed lifecycle with single-owner command kernel ([#23203](https://github.com/netdata/netdata/issues/23203))
- Feat(netflow): support Cisco ASA NSEL accounting ([#23201](https://github.com/netdata/netdata/issues/23201))
- Chore(go.d): remove sensors collector ([#23237](https://github.com/netdata/netdata/issues/23237))
- Enable the otel-plugin on macOS ([#23172](https://github.com/netdata/netdata/issues/23172))
- Regenerate integrations docs ([#23232](https://github.com/netdata/netdata/issues/23232))
- Api: escape dimension names in the v1 JSON formatters ([#23216](https://github.com/netdata/netdata/issues/23216))
- Fix(jobmgr): harden stopping rejection classification ([#23238](https://github.com/netdata/netdata/issues/23238))
- Perf(go.d/metrix): eliminate repeated multiscope flattening ([#23242](https://github.com/netdata/netdata/issues/23242))
- Docs: fix broken links ([#23243](https://github.com/netdata/netdata/issues/23243))
- Add regression tests for function access verification in MCP ([#23225](https://github.com/netdata/netdata/issues/23225))
- Netdata fixes part 87 ([#23226](https://github.com/netdata/netdata/issues/23226))
- Improve Network Flow collector accounting charts ([#23241](https://github.com/netdata/netdata/issues/23241))
- Skill how-tos: add 5 new how-tos, fix query-nodes.md response shape ([#23245](https://github.com/netdata/netdata/issues/23245))
- Docs: Document stock config install path in log2journal README ([#23160](https://github.com/netdata/netdata/issues/23160))
- Fix(plugins.d): prevent plugins from overwriting reserved dyncfg functions ([#23224](https://github.com/netdata/netdata/issues/23224))
- Optimize host context loading during agent startup ([#23116](https://github.com/netdata/netdata/issues/23116))
- Docs: Document dom0 host requirement in xenstat plugin metadata ([#23169](https://github.com/netdata/netdata/issues/23169))
- Remove redundant status message for ACLK connection state  ([#23247](https://github.com/netdata/netdata/issues/23247))
- Docs(proc): document and render network metric descriptions ([#23030](https://github.com/netdata/netdata/issues/23030))
- Docs(go.d/promtheus): document profile format ([#23248](https://github.com/netdata/netdata/issues/23248))
- Docs: Document ping collector timeout tuning via update_every ([#23197](https://github.com/netdata/netdata/issues/23197))
- Docs (go.d): wrap hand-authored docs at 120 columns ([#23249](https://github.com/netdata/netdata/issues/23249))
- Correctly preserve PWD while ensuring temporary directory is set in kickstart.sh. ([#23222](https://github.com/netdata/netdata/issues/23222))
- Docs: Add Windows fix for cloned VM duplicate node identity ([#23198](https://github.com/netdata/netdata/issues/23198))
- Make otel-plugin durable-write I/O errors name the operation and path ([#23250](https://github.com/netdata/netdata/issues/23250))
- Stop static packages shipping builder runtime state; repair otel dir ownership ([#23251](https://github.com/netdata/netdata/issues/23251))
- Feat(go.d/prometheus): add profile autogen selector ([#23255](https://github.com/netdata/netdata/issues/23255))
- Correctly handle EPEL on RHEL 7. ([#23235](https://github.com/netdata/netdata/issues/23235))
- Fix two memory leaks on chart/dimension churn (ram + all engines) ([#23254](https://github.com/netdata/netdata/issues/23254))
- Fix(go.d/functions): clamp over-limit function timeouts instead of 400 ([#23258](https://github.com/netdata/netdata/issues/23258))
- Regenerate integrations docs ([#23244](https://github.com/netdata/netdata/issues/23244))
