...
static int rrdpush_receive(struct receiver_state *rpt)
{
    ...
    rrdpush_compression = appconfig_get_boolean(&stream_config, rpt->key, "enable_compression", default_compression_enabled);
    rrdpush_compression = (rrdpush_compression && default_compression_enabled);
    rrdpush_compression = appconfig_get_boolean(&stream_config, rpt->machine_guid, "enable_compression", default_compression_enabled);
