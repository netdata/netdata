...
| `enable compression`                          | `yes`    | Control stream compression in parent agent stream.                                                                                                                                                                                             |
| `enable replication`                          | `yes`    | Enable replication for all hosts                                                                                                                                                                                                               |
| `seconds to replicate`                        | `86400`  | How many seconds to replicate from each child                                                                                                                                                                                                  |
| `replication_step`                            | `600`    | The duration we want to replicate per each step.                                                                                                                                                                                               |
