...
void health_log_alert_transition_with_trace(RRDHOST *host, ALARM_ENTRY *ae, int line, const char *file, const char *function) {
    ND_LOG_STACK lgs[] = {
            ...
            ND_LOG_FIELD_U32(NDF_ALERT_ID, ae->alarm_id),
            ND_LOG_FIELD_U32(NDF_ALERT_UNIQUE_ID, ae->unique_id),
            ND_LOG_FIELD_U32(NDF_ALERT_EVENT_ID, ae->alarm_event_id),
            ...
            ND_LOG_FIELD_I32(NDF_ALERT_DURATION, ae->duration),
            ND_LOG_FIELD_I64(NDF_RESPONSE_CODE, ae->exec_code),
            ND_LOG_FIELD_TMT(NDF_ALERT_NOTIFICATION_REALTIME_USEC, ae->delay_up_to_timestamp * USEC_PER_SEC),
            ND_LOG_FIELD_END(),
    };
