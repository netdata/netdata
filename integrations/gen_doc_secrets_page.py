...
SECRETS_PAGE = {
    ...
    "intro": [
        ...
        "To allow references in all jobs from a trusted pipeline, set its top-level `trust_discovered_targets: yes`; this trusts target-provided values too. The option does not resolve discovery connection credentials. Alternatively, adopt an individual job through Dynamic Configuration and review the complete configuration before saving.",
