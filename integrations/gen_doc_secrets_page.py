...
SECRETS_PAGE = {
    ...
    "intro": [
        ...
        "Jobs generated by service discovery treat all reference syntax as literal text, including references written in discovery rules or credentials. "
        "To use references in a discovered job, adopt it through Dynamic Configuration and review the complete configuration before saving.",
