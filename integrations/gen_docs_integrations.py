...
def create_img_link(integration, filename):
...
{create_img_link(integration, integration['meta']['monitored_instance']['icon_filename'])}"""
...
{create_img_link(integration, integration['meta']['icon_filename'])}"""
