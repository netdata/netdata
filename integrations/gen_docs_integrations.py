...
{first_overview_part}"""
            ...
            if len(integration['meta']['monitored_instance']['icon_filename']) > 0:
                md += f"""
<img src="https://netdata.cloud/img/{integration['meta']['monitored_instance']['icon_filename']}" width="150"/>
"""

            md += f"""{rest_overview_part}
"""
...
{first_overview_part}"""
            ...
            if len(integration['meta']['icon_filename']) > 0:
                md += f"""
<img src="https://netdata.cloud/img/{integration['meta']['icon_filename']}" width="150"/>
"""
