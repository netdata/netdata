...
learn_rel_path: "Logs/macOS Unified Logs/macOS Unified Logs/macOS Unified Logs/macOS Unified Logs/macOS Unified Logs"
keywords: [macos, macos logs, unified logs, oslog, logs]
description: "The macOS Logs plugin by Netdata makes viewing, exploring and analyzing macOS unified logs simple and efficient."
...
learn_link: "https://learn.netdata.cloud/docs/logs/macos-unified-logs/macos-unified-logs/macos-unified-logs/macos-unified-logs/macos-unified-logs"
slug: "/logs/macos-unified-logs/macos-unified-logs/macos-unified-logs/macos-unified-logs/macos-unified-logs"
-->
...
<img src="https://netdata.cloud/img/macos.svg" width="150" alt="macOS Unified Logs"/>
