...
description: "The macOS Logs plugin lets you view, explore and analyze the macOS unified log from the Netdata dashboard."
...
The macOS Logs plugin lets you view, explore and analyze the macOS unified log from the Netdata dashboard.
