...
description: "The Windows Events plugin lets you view, explore and analyze Windows events from the Netdata dashboard."
...
The Windows Events plugin lets you view, explore and analyze Windows events from the Netdata dashboard.
