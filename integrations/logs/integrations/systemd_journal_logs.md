...
description: "The systemd journal plugin lets you view, explore and analyze systemd journal logs from the Netdata dashboard."
...
The `systemd` journal plugin lets you view, explore and analyze `systemd` journal logs from the Netdata dashboard.
