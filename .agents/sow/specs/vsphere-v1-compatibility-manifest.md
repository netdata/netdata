...
- Optional VM virtual disk capacity/performance and VM network-interface
  performance metrics are not part of this PR. They were hard-removed before
  merge by 2026-05-22 user decision. Existing aggregate VM disk and network
  contexts remain default-on.
