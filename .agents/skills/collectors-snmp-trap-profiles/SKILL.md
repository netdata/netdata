...
- `.agents/skills/collectors-snmp-trap-profiles/netdata.md` (when the change touches profile schema or trap subsystem decisions that the profiles encode)
...
`.agents/skills/collectors-snmp-trap-profiles/netdata.md`. This skill is the working checklist
...
3. `.agents/skills/collectors-snmp-trap-profiles/netdata.md` — §3 (category taxonomy) and
   §11 (PRIORITY mapping).
