...
| New go.d discoverer or changed discovery capability, ownership or lifecycle | `.agents/skills/collectors-go-design/SKILL.md#the-collector-design-note` and its architecture gate; implementation under `src/go/plugin/go.d/discovery/sdext/discoverer/` |
