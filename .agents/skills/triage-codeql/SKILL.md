...
```
bash .agents/skills/triage-codeql/scripts/codeql-list.sh
```
...
Filters:
```
bash .agents/skills/triage-codeql/scripts/codeql-list.sh --state=open --severity=high
bash .agents/skills/triage-codeql/scripts/codeql-list.sh --tool=CodeQL --severity=critical
bash .agents/skills/triage-codeql/scripts/codeql-list.sh --raw          # full JSON
```
...
```bash
bash .agents/skills/triage-codeql/scripts/codeql-list.sh --raw \
