...
4. Check affected commands, links, routing and source claims safely. Choose development-time assessment and review
   coverage under `AGENTS.md#review`, including its readiness assessment.
...
Use `AGENTS.md#review` for development-time and readiness assessments and reuse of earlier coverage.
