...
- [handle-generated-integration-markdown](handle-generated-integration-markdown.md) -- classify markdownlint findings in generator-owned `**/integrations/*.md` pages and validate the source/generator boundary instead of patching generated output.
...
- [resolve-md043-none-heading-findings](resolve-md043-none-heading-findings.md) -- retain required Markdown headings while suppressing Codacy Cloud's empty `MD043` heading sequence before the first heading.
