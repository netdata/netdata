...
| `.agents/skills/topology-authoring/topology-function-schema.md` | Durable project spec for topology semantics |
| `.agents/skills/topology-authoring/topology-modes-correlation-aggregation.md` | Mode, correlation, aggregation, and actor modal identification contract |
| `src/go/pkg/topology/v1` | Go production topology payload builders and compact-table helpers |
| `.agents/skills/collectors-authoring/SKILL.md` | Collector quality, Function, validation, and cardinality rules |
