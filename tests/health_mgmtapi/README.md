...
The directory `tests/health_mgmtapi` contains the test script `health-cmdapi-test.sh.in` for the [health command API](/src/web/api/health/README.md). The build no longer generates it; substitute `@varlibdir_POST@` by hand to run it.
