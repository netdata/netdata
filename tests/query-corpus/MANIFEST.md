...
| L5/group-by-matrix | level-1 (first-pass) group-by non-raw: 7 keys x 5 aggregations vs member-enumeration oracle (values, ar/gbc, PARTIAL on gap rows, naming) | green | n/a | |
