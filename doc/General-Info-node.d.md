...
`node.d.plugin` can work even without any configuration. Its default configuration file is [/etc/netdata/node.d.conf](https://github.com/netdata/netdata/blob/master/conf.d/node.d.conf).
