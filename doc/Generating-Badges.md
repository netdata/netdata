...
A more advanced badges refresh method is to include `http://your.netdata.ip:19999/refresh-badges.js` in your page. For more information and use example, check this: https://github.com/netdata/netdata/blob/master/web/refresh-badges.js
