...
const SCENARIOS: ScenarioDefinition[] = [
  ...
  {
    id: 'run-test-55',
    description: 'Slack block kit mrkdwn repair for markdown-heavy content.',
    systemPromptMustInclude: [SYSTEM_PROMPT_MARKER],
    turns: [
      {
        turn: 1,
        response: {
          kind: FINAL_RESPONSE_KIND,
          assistantText: 'Delivering Slack formatted content with markdown.',
          reportContent: '*Slack* message generated for repair.',
          reportFormat: SLACK_BLOCK_KIT_FORMAT,
          reportMessages: [{ blocks: [{ type: 'section', text: { type: 'mrkdwn', text: SLACK_MRKDWN_SAMPLE } }] }],
          status: STATUS_SUCCESS,
          tokenUsage: DEFAULT_TOKEN_USAGE,
        },
      },
  ...
  },
  {
    ...
    description: 'Slack block kit snapshot payload with wrapper noise.',
    systemPromptMustInclude: [SYSTEM_PROMPT_MARKER],
    turns: [
      {
        turn: 1,
        response: {
          kind: FINAL_RESPONSE_KIND,
          assistantText: 'Delivering anonymized snapshot payload.',
          reportContent: SLACK_BLOCK_KIT_SNAPSHOT_PAYLOAD,
          reportFormat: SLACK_BLOCK_KIT_FORMAT,
          status: STATUS_SUCCESS,
          tokenUsage: DEFAULT_TOKEN_USAGE,
        },
  ...
  },
  {
    ...
    description: 'Session snapshot preserves full LLM payloads without truncation.',
    systemPromptMustInclude: [SYSTEM_PROMPT_MARKER],
    turns: [
      {
        turn: 1,
        response: {
          kind: FINAL_RESPONSE_KIND,
          assistantText: 'Delivering a long payload for snapshot verification.',
          reportContent: SNAPSHOT_FULL_CONTENT,
          reportFormat: MARKDOWN_FORMAT,
          status: STATUS_SUCCESS,
          tokenUsage: DEFAULT_TOKEN_USAGE,
        },
