...
export const OPTIONS_REGISTRY: OptionDef[] = [
  ...
  strArrDef({
    key: 'override',
    default: [],
    description: 'Override settings for every agent/sub-agent (key=value). Supported keys: models, tools, agents, temperature, topP, topK, maxOutputTokens, repeatPenalty, llmTimeout, toolTimeout, maxRetries, maxTurns, maxToolCallsPerTurn, toolResponseMaxBytes, mcpInitConcurrency, stream, reasoning, reasoningTokens, caching, contextWindow.',
