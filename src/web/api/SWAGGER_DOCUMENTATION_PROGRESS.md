...
**Request Limit:** The complete encoded request, including the request line, headers, and JSON body, must fit within
1,048,576 bytes. The maximum JSON body size is smaller and varies with the request line and headers.
...
- `413 Payload Too Large` - Complete encoded request exceeds 1,048,576 bytes
...
**Request Limit:** 1,048,576 bytes for the complete encoded request; larger requests return 413
