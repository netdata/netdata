...
#define FUNCTION_BEARER_GET_TOKEN "bearer_get_token"
#define FUNCTION_BEARER_GET_TOKEN_HELP "Get a bearer token for authenticated direct access to the agent"
