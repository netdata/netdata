...
| `timeout for first request`        | `1m`                                                                                                                                                                                   | How long to wait for the first request after connection establishment and how long each HTTP request, including keep-alive requests, may take to arrive after its first byte. Prevents slow request attacks                                                                                                                                                                                              |
