...
struct timing_steps {
    ...
    size_t count;
        ...
        [TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_TIER1_MALLOC] = { .name = "EVC_FREE_MAIN_T1MAL", .time = 0, },
        [TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_TIER1_ARAL]   = { .name = "EVC_FREE_MAIN_T1ARL", .time = 0, },
        [TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_G512]         = { .name = "EVC_FREE_MAIN_G512", .time = 0, },
        [TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_GBIG]         = { .name = "EVC_FREE_MAIN_GBIG", .time = 0, },
        [TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_GMALLOC]      = { .name = "EVC_FREE_MAIN_GMLOC", .time = 0, },
