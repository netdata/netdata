...
static inline SIMPLE_HASHTABLE_KEY_TYPE *SIMPLE_HASHTABLE_VALUE2KEY_FUNCTION(SIMPLE_HASHTABLE_VALUE_TYPE *p);
#endif

#if defined(SIMPLE_HASHTABLE_COMPARE_KEYS_FUNCTION)
static inline bool SIMPLE_HASHTABLE_COMPARE_KEYS_FUNCTION(SIMPLE_HASHTABLE_KEY_TYPE *a, SIMPLE_HASHTABLE_KEY_TYPE *b);
#endif
...
static inline bool simple_hashtable_can_use_slot_named(
    ...
    if(sl->hash == hash) {
        ...
        return SIMPLE_HASHTABLE_COMPARE_KEYS_FUNCTION(
            SIMPLE_HASHTABLE_VALUE2KEY_FUNCTION(SIMPLE_HASHTABLE_SLOT_DATA(sl)), key);
#else
        return true;
#endif
    }
