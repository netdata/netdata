...
void query_progress_start_or_update(nd_uuid_t *transaction, usec_t started_ut, HTTP_REQUEST_MODE mode, HTTP_ACL acl,
...
#define FUNCTION_PROGRESS_HELP "Monitors active and recent Netdata API requests with transaction details, duration, and response sizes."
