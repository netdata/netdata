...
// All five _W variants are checked by wel_manifest_is_current() to detect partial registrations.
...
#define NETDATA_WEL_PROVIDER_COLLECTORS_GUID_STR_W  WIDEN(NETDATA_WEL_PROVIDER_COLLECTORS_GUID_STR)
#define NETDATA_WEL_PROVIDER_ACCESS_GUID_STR        "{5CA72002-9BD8-4634-81E5-000014E7DAAB}"
#define NETDATA_WEL_PROVIDER_ACCESS_GUID_STR_W      WIDEN(NETDATA_WEL_PROVIDER_ACCESS_GUID_STR)
#define NETDATA_WEL_PROVIDER_HEALTH_GUID_STR        "{5CA72005-9BD8-4634-81E5-000014E7DAAA}"
#define NETDATA_WEL_PROVIDER_HEALTH_GUID_STR_W      WIDEN(NETDATA_WEL_PROVIDER_HEALTH_GUID_STR)
#define NETDATA_WEL_PROVIDER_ACLK_GUID_STR          "{5CA72001-9BD8-4634-81E5-000014E7DAA9}"
#define NETDATA_WEL_PROVIDER_ACLK_GUID_STR_W        WIDEN(NETDATA_WEL_PROVIDER_ACLK_GUID_STR)
