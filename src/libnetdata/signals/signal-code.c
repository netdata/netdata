...
#endif
    { SIGNAL_CODE_CREATE(SIGILL, SI_USER), "SIGILL/SI_USER" },
    { SIGNAL_CODE_CREATE(SIGILL, SI_KERNEL), "SIGILL/SI_KERNEL" },
...
#endif
    { SIGNAL_CODE_CREATE(SIGFPE, SI_USER), "SIGFPE/SI_USER" },
    { SIGNAL_CODE_CREATE(SIGFPE, SI_KERNEL), "SIGFPE/SI_KERNEL" },
...
#endif
    { SIGNAL_CODE_CREATE(SIGSEGV, SI_USER), "SIGSEGV/SI_USER" },
    { SIGNAL_CODE_CREATE(SIGSEGV, SI_KERNEL), "SIGSEGV/SI_KERNEL" },
...
#endif
    { SIGNAL_CODE_CREATE(SIGBUS, SI_USER), "SIGBUS/SI_USER" },
    { SIGNAL_CODE_CREATE(SIGBUS, SI_KERNEL), "SIGBUS/SI_KERNEL" },
...
#endif
    { SIGNAL_CODE_CREATE(SIGTRAP, SI_KERNEL), "SIGABRT/SI_KERNEL" },
    { SIGNAL_CODE_CREATE(SIGTRAP, SI_USER), "SIGTRAP/SI_USER" },
    { SIGNAL_CODE_CREATE(SIGTRAP, SI_KERNEL), "SIGTRAP/SI_KERNEL" },

    // SIGABRT codes
    { SIGNAL_CODE_CREATE(SIGABRT, SI_ASYNCNL), "SIGABRT/SI_ASYNCNL" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_DETHREAD), "SIGABRT/SI_DETHREAD" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_TKILL), "SIGABRT/SI_TKILL" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_SIGIO), "SIGABRT/SI_SIGIO" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_ASYNCIO), "SIGABRT/SI_ASYNCIO" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_MESGQ), "SIGABRT/SI_MESGQ" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_TIMER), "SIGABRT/SI_TIMER" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_QUEUE), "SIGABRT/SI_QUEUE" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_USER), "SIGABRT/SI_USER" },
    { SIGNAL_CODE_CREATE(SIGABRT, SI_KERNEL), "SIGABRT/SI_KERNEL" },
