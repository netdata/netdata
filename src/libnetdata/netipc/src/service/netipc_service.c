...
bool nipc_service_posix_ensure_buffer(uint8_t **buf, size_t *buf_size, size_t need, int fault_site)
{
...
bool nipc_service_platform_ensure_client_send_buffer(nipc_client_ctx_t *ctx,
                                                     size_t need)
{
    return nipc_service_posix_ensure_buffer(&ctx->send_buf, &ctx->send_buf_size, need,
