...
typedef enum {
    ...
    TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_TIER1_MALLOC,
    TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_TIER1_ARAL,
    TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_G512,
    TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_GBIG,
    TIMING_STEP_DBENGINE_EVICT_FREE_MAIN_PGD_GMALLOC,
