...
// Defined in perflib-udp.c
void function_udp_stats(const char *transaction, char *function, usec_t *stop_monotonic_ut,
...
int main(int argc, char **argv)
{
    ...
    struct functions_evloop_globals *wg =
        functions_evloop_init(1, "NV-WIN", &stdout_mutex, &plugin_should_exit, NULL);
