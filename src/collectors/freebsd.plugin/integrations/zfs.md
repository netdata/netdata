...
description: "Monitor FreeBSD ZFS ARC, L2ARC, transaction, I/O, and filesystem performance metrics."
meta_yaml: "https://github.com/netdata/netdata/edit/master/src/collectors/freebsd.plugin/metadata.yaml"
message: "DO NOT EDIT THIS FILE DIRECTLY, IT IS GENERATED BY THE COLLECTOR'S metadata.yaml FILE"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/storage-and-filesystems/zfs"
slug: "/collecting-metrics/collectors/storage-and-filesystems/zfs"
-->
...
<img src="https://netdata.cloud/img/filesystem.svg" width="150" alt="zfs"/>
...
| zfs.memory_ops | ZFS Memory Operations | throttled | operations/s |
...
| zfs.trim_bytes | Successfully TRIMmed bytes | TRIMmed | bytes |
| zfs.trim_requests | TRIM requests | successful, failed, unsupported | requests |
