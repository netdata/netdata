...
description: "Monitor per-core CPU temperatures on FreeBSD through the sysctl interface."
meta_yaml: "https://github.com/netdata/netdata/edit/master/src/collectors/freebsd.plugin/metadata.yaml"
message: "DO NOT EDIT THIS FILE DIRECTLY, IT IS GENERATED BY THE COLLECTOR'S metadata.yaml FILE"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/hardware-and-sensors/dev.cpu.temperature"
slug: "/collecting-metrics/collectors/hardware-and-sensors/dev.cpu.temperature"
-->
...
<img src="https://netdata.cloud/img/freebsd.svg" width="150" alt="dev.cpu.temperature"/>
...
|:------|:------------|:----------|:----|
| cpu.temperature | Core temperature | a dimension per core | Celsius |
