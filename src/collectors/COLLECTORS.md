...
| [UDP Stack](https://github.com/netdata/netdata/blob/master/src/collectors/network-viewer.plugin/integrations/udp_stack.md) | Monitor UDP datagram counters on Windows systems. |
