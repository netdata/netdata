<!--
custom_edit_url: "https://github.com/netdata//edit/master/tmp/learn-sim/netdata/src/collectors/idlejitter.plugin/README.md"
sidebar_label: "Idle OS Jitter"
learn_status: "Published"
toc_max_heading_level: 6
toc_collapsible: true
learn_rel_path: "Collecting Metrics/Collectors/Synthetic Testing"
keywords: "['latency', 'jitter']"
description: "Monitor OS scheduling delays that affect latency-sensitive applications, helping identify jitter and inconsistent process wake-up timing."
...
<img src="https://netdata.cloud/img/syslog.png" width="150" alt="Idle OS Jitter"/>
...
|:------|:------------|:----------|:----|
| system.idlejitter | CPU Idle Jitter | min, max, average | microseconds lost/s |
