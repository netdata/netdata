...
keywords: [syscall, eBPF, hard disk, memory]
description: "Monitor syscall responsible to move data from memory to storage device."
meta_yaml: "https://github.com/netdata/netdata/edit/master/src/collectors/ebpf.plugin/metadata.yaml"
message: "DO NOT EDIT THIS FILE DIRECTLY, IT IS GENERATED BY THE COLLECTOR'S metadata.yaml FILE"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/storage-and-filesystems/ebpf-sync"
slug: "/collecting-metrics/collectors/storage-and-filesystems/ebpf-sync"
-->
...
<img src="https://netdata.cloud/img/ebpf.jpg" width="150" alt="eBPF Sync"/>
