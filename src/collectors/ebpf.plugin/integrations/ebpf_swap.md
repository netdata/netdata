...
keywords: [SWAP, memory, eBPF, Hard Disk]
description: "Monitor Linux swap reads and writes by tracing kernel swap I/O functions with eBPF."
meta_yaml: "https://github.com/netdata/netdata/edit/master/src/collectors/ebpf.plugin/metadata.yaml"
message: "DO NOT EDIT THIS FILE DIRECTLY, IT IS GENERATED BY THE COLLECTOR'S metadata.yaml FILE"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/operating-systems/ebpf-swap"
slug: "/collecting-metrics/collectors/operating-systems/ebpf-swap"
-->
...
<img src="https://netdata.cloud/img/ebpf.jpg" width="150" alt="eBPF SWAP"/>
