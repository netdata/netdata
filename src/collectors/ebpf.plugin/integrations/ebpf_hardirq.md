...
description: "Measure the latency of available Linux hardware interrupts through eBPF kernel tracepoints."
meta_yaml: "https://github.com/netdata/netdata/edit/master/src/collectors/ebpf.plugin/metadata.yaml"
message: "DO NOT EDIT THIS FILE DIRECTLY, IT IS GENERATED BY THE COLLECTOR'S metadata.yaml FILE"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/operating-systems/ebpf-hardirq"
slug: "/collecting-metrics/collectors/operating-systems/ebpf-hardirq"
-->
...
<img src="https://netdata.cloud/img/ebpf.jpg" width="150" alt="eBPF Hardirq"/>
...
|:------|:------------|:----------|:----|
| system.hardirq_latency | Hard IRQ latency | hardirq names | milliseconds |
