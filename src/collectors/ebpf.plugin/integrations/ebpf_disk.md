...
This thread attaches tracepoints for disk I/O requests. To allow this specific feaure, it is necessary to mount `debugfs` (`mount -t debugfs none /sys/kernel/debug/`).
