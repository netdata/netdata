...
This thread attaches tracepoints for mount and unmount system calls. To allow this specific feaure, it is necessary to mount `debugfs` (`mount -t debugfs none /sys/kernel/debug/`).
