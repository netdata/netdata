...
description: "Monitor syscall responsible to manipulate shared memory."
keywords: ['syscall', 'shared memory', 'eBPF']
...
<img src="https://netdata.cloud/img/ebpf.jpg" width="150" alt="eBPF SHM"/>
...
This thread attaches tracepoints for shared-memory system calls. To allow this specific feaure, it is necessary to mount `debugfs` (`mount -t debugfs none /sys/kernel/debug/`).
