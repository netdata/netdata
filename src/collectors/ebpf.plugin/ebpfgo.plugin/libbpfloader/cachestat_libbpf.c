 ...
 * Define NETDATA_CACHESTAT_HAS_SKELETON at compile time when building with
 * real skeletons to enable CO-RE loading.  Without it, only the legacy
 * kprobe path is compiled in.
 */
#ifdef NETDATA_CACHESTAT_HAS_SKELETON
...
#endif /* NETDATA_CACHESTAT_HAS_SKELETON */
#endif /* libbpf >= 1 */
