...
import (
	...
	raw "github.com/netdata/netdata/src/collectors/ebpf.plugin/ebpfgo.plugin/netipc/service/raw"
	"github.com/netdata/netdata/src/collectors/ebpf.plugin/ebpfgo.plugin/netipc/transport/posix"
)
