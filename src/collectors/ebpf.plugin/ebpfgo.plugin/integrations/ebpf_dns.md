...
description: "Monitor DNS query and response traffic at the kernel level, broken down by transport protocol (UDP/TCP) and IP family (IPv4/IPv6)."
...
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/operating-systems/ebpf-dns"
slug: "/collecting-metrics/collectors/operating-systems/ebpf-dns"
-->
...
<img src="https://netdata.cloud/img/ebpf.jpg" width="150" alt="eBPF DNS"/>
