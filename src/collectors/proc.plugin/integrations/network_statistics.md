...
description: "Monitor host-wide IP, TCP, UDP, ICMP, broadcast, multicast, fragmentation, and ECN activity from Linux kernel protocol counters."
...
<img src="https://netdata.cloud/img/network-wired.svg" width="150" alt="Network statistics"/>
