...
keywords: [edac, ecc, dimm, ram, hardware]
description: "Monitor correctable and uncorrectable ECC memory errors reported by Linux EDAC for each memory controller and DIMM."
meta_yaml: "https://github.com/netdata/netdata/edit/master/src/collectors/proc.plugin/metadata.yaml"
message: "DO NOT EDIT THIS FILE DIRECTLY, IT IS GENERATED BY THE COLLECTOR'S metadata.yaml FILE"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/hardware-and-sensors/memory-modules-dimms"
slug: "/collecting-metrics/collectors/hardware-and-sensors/memory-modules-dimms"
-->
...
<img src="https://netdata.cloud/img/microchip.svg" width="150" alt="Memory modules (DIMMs)"/>
