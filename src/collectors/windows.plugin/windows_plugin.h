...
enum PERFLIB_PRIO {
    ...
    PRIO_TCP_IPV4_CONNECTIONS,
    PRIO_TCP_IPV4_SEGMENTS,
    PRIO_TCP_IPV4_CONNECTIONS_STATE_COUNT,
    PRIO_TCP_IPV6_CONNECTIONS,
    PRIO_TCP_IPV6_SEGMENTS,
    PRIO_TCP_IPV6_CONNECTIONS_STATE_COUNT,
