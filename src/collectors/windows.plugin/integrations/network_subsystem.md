...
description: "Monitor Windows network interface traffic, errors, drops, queue length, and offload activity through Perflib."
...
<img src="https://netdata.cloud/img/windows.svg" width="150" alt="Network Subsystem"/>
