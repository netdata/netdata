...
This collector is enabled by default. It automatically detects all available SMB share instances and metrics, and disables itself on systems where the 'SMB Server Shares' object is not available.
