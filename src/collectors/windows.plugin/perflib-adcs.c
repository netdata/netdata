...
static void netdata_adcs_issued_requets(struct adcs_certificate *ac,
                                        PERF_DATA_BLOCK *pDataBlock,
                                        PERF_OBJECT_TYPE *pObjectType,
                                        int update_every)
{
    ...
    if  (!ac->st_adcs_issued_requests_total) {
        ...
        ac->st_adcs_issued_requests_total =  rrdset_create_localhost("adcs"
                                                                    , id
                                                                    , NULL
                                                                    , "requests"
        ...
        ac->rd_adcs_issued_requests_total = rrddim_add(ac->st_adcs_issued_requests_total,
                                                       "issued",
                                                       NULL,
                                                       1,
                                                       1,
    ...
    rrddim_set_by_pointer(ac->st_adcs_issued_requests_total,
...
static void netdata_adcs_challenge_response(struct adcs_certificate *ac,
                                            PERF_DATA_BLOCK *pDataBlock,
                                            PERF_OBJECT_TYPE *pObjectType,
                                            int update_every)
{
...
static void netdata_adcs_crypto_singing_time(struct adcs_certificate *ac,
                                              PERF_DATA_BLOCK *pDataBlock,
                                              PERF_OBJECT_TYPE *pObjectType,
                                              int update_every)
{
    ...
    if  (!ac->st_adcs_request_cryptographic_signing_time_seconds) {
        ...
        ac->st_adcs_request_cryptographic_signing_time_seconds =  rrdset_create_localhost("adcs"
                                                                                         , id
                                                                                         , NULL
                                                                                         , "timings"
        ...
        rrdlabels_add(ac->st_adcs_request_cryptographic_signing_time_seconds->rrdlabels, "cert", ac->name, RRDLABEL_SRC_AUTO);
    }

    rrddim_set_by_pointer(ac->st_adcs_request_cryptographic_signing_time_seconds,
...
static void netdata_adcs_challenge_response_processing_time(struct adcs_certificate *ac,
                                                            PERF_DATA_BLOCK *pDataBlock,
                                                            PERF_OBJECT_TYPE *pObjectType,
                                                            int update_every)
{
