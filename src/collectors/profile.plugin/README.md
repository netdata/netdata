...
slug: "/developer-and-contributor-corner/external-plugins/profile.plugin"
-->
...
Edit the `netdata.conf` configuration file using [`edit-config`](/docs/netdata-agent/configuration/README.md#edit-configuration-files) from the [Netdata config directory](/docs/netdata-agent/configuration/README.md#locate-your-config-directory), which is typically at `/etc/netdata`.
