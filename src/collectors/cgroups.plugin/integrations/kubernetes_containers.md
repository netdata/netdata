...
keywords: [k8s, kubernetes, pods, containers, openshift, rancher, rke, rke2, k3s, microk8s, eks, gke, aks, tanzu, minikube, kind, containerd, cri-o, kubelet, kubepods]
description: "Monitor Kubernetes pod and container CPU, memory, disk I/O, and network utilization through Linux cgroups."
meta_yaml: "https://github.com/netdata/netdata/edit/master/src/collectors/cgroups.plugin/metadata.yaml"
message: "DO NOT EDIT THIS FILE DIRECTLY, IT IS GENERATED BY THE COLLECTOR'S metadata.yaml FILE"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/containers-and-vms/kubernetes-containers"
slug: "/collecting-metrics/collectors/containers-and-vms/kubernetes-containers"
-->
...
<img src="https://netdata.cloud/img/kubernetes.svg" width="150" alt="Kubernetes Containers"/>
...
Monitor Kubernetes pod and container resource utilization — CPU, memory, disk I/O, and network — via Linux cgroups.
