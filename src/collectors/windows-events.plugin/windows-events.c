...
int main(int argc __maybe_unused, char **argv __maybe_unused) {
    ...
    if(argc >= 2 && strcmp(argv[argc - 1], "debug") == 0) {
        ...
        struct {
            ...
            { "windows-events after:1725738894 before:1726343694 last:200 facets:HdUoSYab5wV,Cq2r7mRUv4a,LAnVlsIQfeD,BnPLNbA5VWT,KeCITtVD5AD,HytMJ9kj82B,JM3OPW3kHn6,H106l8MXSSr,HREiMN.4Ahu,ClaDGnYSQE7,ApYltST_icg,PtkRm91M0En source:All" },
