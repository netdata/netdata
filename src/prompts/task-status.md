...
- "in-progress": You are currently working on this task - you are not yet ready to provide your final report/answer ({{{metaReminderShort}}})
- "completed": You completed the task and you are now ready to provide your final report/answer ({{{metaReminderShort}}})
...
- If you are providing your final report, state that here ({{{metaReminderShort}}})

Field `ready_for_final_report`:
- Set to true when you have enough information to provide your final report/answer ({{{metaReminderShort}}})
...
- If you tried everything and you still cannot proceed to complete the task, provide your final report/answer, honestly stating the limitations you faced. ({{{metaReminderShort}}})
...
- status: "completed", done: "Found 3 critical errors", pending: "All done", now: "Compile the final report/answer", ready_for_final_report: true, need_to_run_more_tools: false, and at the same time providing the final report/answer ({{{metaReminderShort}}})

**Best Practices:**
- Call agent__task_status alongside other tools or your final report/answer (calling it alone wastes turns) ({{{metaReminderShort}}})
