...
- "in-progress": You are currently working on this task - you are not yet ready to provide your final report/answer ({{ meta_reminder_short }})
- "completed": You completed the task and you are now ready to provide your final report/answer ({{ meta_reminder_short }})
...
- If you are providing your final report, state that here ({{ meta_reminder_short }})

Field `ready_for_final_report`:
- Set to true when you have enough information to provide your final report/answer ({{ meta_reminder_short }})
...
- If you tried everything and you still cannot proceed to complete the task, provide your final report/answer, honestly stating the limitations you faced. ({{ meta_reminder_short }})
...
- status: "completed", done: "Found 3 critical errors", pending: "All done", now: "Compile the final report/answer", ready_for_final_report: true, need_to_run_more_tools: false, and at the same time providing the final report/answer ({{ meta_reminder_short }})

**Best Practices:**
- Call agent__task_status alongside other tools or your final report/answer (calling it alone wastes turns) ({{ meta_reminder_short }})
