...
description: "Annotate network flows with network-identity labels from any JSON-over-HTTP IPAM or CMDB endpoint."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/network-flows/enrichment-methods/generic-json-over-http-ipam"
slug: "/network-performance-monitoring/network-flows/enrichment-methods/generic-json-over-http-ipam"
-->
...
<img src="https://netdata.cloud/img/network-wired.svg" width="150" alt="Generic JSON-over-HTTP IPAM"/>
