...
description: "Enrich network flows with ASN and geographic context from DB-IP Lite MMDB databases."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/network-flows/enrichment-methods/db-ip-ip-intelligence"
slug: "/network-performance-monitoring/network-flows/enrichment-methods/db-ip-ip-intelligence"
-->
...
<img src="https://netdata.cloud/img/network-wired.svg" width="150" alt="DB-IP IP Intelligence"/>
...
See the [Enrichment Intel Downloader](https://github.com/netdata/netdata/blob/master/docs/npm/network-flows/intel-downloader.md)
