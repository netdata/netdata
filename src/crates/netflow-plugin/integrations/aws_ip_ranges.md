...
learn_rel_path: "Network Performance Monitoring/Network Flows/Enrichment Methods"
keywords: [aws, amazon, cloud, ip ranges, vpc, ec2, prefix list, service tags]
description: "Annotate network flows with AWS service and region labels from AWS public IP ranges."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/network-flows/enrichment-methods/aws-ip-ranges"
slug: "/network-performance-monitoring/network-flows/enrichment-methods/aws-ip-ranges"
-->
...
<img src="https://netdata.cloud/img/network-wired.svg" width="150" alt="AWS IP Ranges"/>
...
cross-cutting [Network Identity](https://github.com/netdata/netdata/blob/master/docs/npm/network-flows/enrichment.md)
