//! Chart definitions for the log-viewer plugin
//!
...
#[schemars(
    extend("x-chart-id" = "log_viewer.journal_calls"),
    ...
    extend("x-chart-context" = "log_viewer.journal_calls"),
)]
...
#[derive(JsonSchema, NetdataChart, Default, Clone, PartialEq, Serialize, Deserialize)]
#[schemars(
    extend("x-chart-id" = "log_viewer.bucket_lru_cache_size"),
    extend("x-chart-title" = "LRU Bucket Cache Size"),
    extend("x-chart-units" = "entries"),
    extend("x-chart-type" = "line"),
    extend("x-chart-family" = "cache"),
    extend("x-chart-context" = "log_viewer.bucket_lru_cache_size"),
)]
...
#[derive(JsonSchema, NetdataChart, Default, Clone, PartialEq, Serialize, Deserialize)]
#[schemars(
    extend("x-chart-id" = "log_viewer.bucket_responses"),
    ...
    extend("x-chart-context" = "log_viewer.bucket_responses"),
)]
...
#[derive(JsonSchema, NetdataChart, Default, Clone, PartialEq, Serialize, Deserialize)]
#[schemars(
    extend("x-chart-id" = "log_viewer.histogram_requests"),
    extend("x-chart-title" = "Histogram Request Details"),
    extend("x-chart-units" = "count/s"),
    extend("x-chart-type" = "line"),
    extend("x-chart-family" = "requests"),
    extend("x-chart-context" = "log_viewer.histogram_requests"),
)]
