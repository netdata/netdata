...
int health_readfile(RRDHOST *host, const char *path, const char *file) {
    debug(D_HEALTH, "Health configuration reading file '%s/%s'", path, file);
    ...
    char *filename = strdupz_path_subpath(path, file);
