...
custom_edit_url: https://github.com/netdata/netdata/edit/master/src/exporting/WALKTHROUGH.md
...
page](/src/exporting/prometheus/#using-netdata-with-prometheus). The key point here is that Netdata can export metrics from
