...
description: "Use the JSON connector for the exporting engine to archive your Agent's metrics to JSON document databases for long-term storage, further analysis, or…"
