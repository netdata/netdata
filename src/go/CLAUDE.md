...
2. Review the code to ensure that different versions of the monitored application can be monitored. Our cost **MUST** support all possible versions that may be in production out there and gracefully enable/disable features based on what is available.
