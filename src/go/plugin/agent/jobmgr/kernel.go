...
type CommandKernel struct {
	...
	functionMutationStopped  chan struct{}
	...
	shutdownPhase            commandShutdownPhase
	shutdownCancelCursor     *commandOperation
	shutdownCancelDone       bool
	shutdownInputBodyReady   bool
	ownershipChains          int
