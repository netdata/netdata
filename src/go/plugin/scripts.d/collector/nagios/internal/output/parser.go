...
func (p ParsedOutput) StatusLine() string { return p.statusLine }

func (p ParsedOutput) LongOutput() string { return p.longOutput }
...
func parsePerfToken(token string) (PerfDatum, bool) {
	...
	valueStr := fields[0]
	warnStr, critStr := getField(fields, 1), getField(fields, 2)
