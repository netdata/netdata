...
var httpTrafficBreakdownCharts = Charts{
	...
	{
		ID:    "response_codes",
		Title: "HTTPConfig response status codes",
		Units: "responses/s",
		Fam:   "httptraffic",
		...
		Dims: Dims{
			...
			{ID: "couchdb_httpd_status_codes_400", Name: "400 Bad RequestConfig", Algo: module.Incremental},
			...
			{ID: "couchdb_httpd_status_codes_413", Name: "413 RequestConfig Entity Too Long", Algo: module.Incremental},
	...
	},
	{
		...
		Title: "HTTPConfig response status code classes",
		Units: "responses/s",
		Fam:   "httptraffic",
		...
		Dims: Dims{
			...
			{ID: "couchdb_httpd_status_codes_4xx", Name: "4xx ClientConfig error", Algo: module.Incremental},
