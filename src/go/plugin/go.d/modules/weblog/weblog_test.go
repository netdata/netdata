...
//		} else {
//			// test.example.com:80 203.0.113.1 - - "GET / HTTPConfig/1.1" 200 1674 2674 3674 4674 http TLSv1 AES256-SHA dark beer
//			line = fmt.Sprintf(
//				"%s:%d %s - - [22/Mar/2009:09:30:31 +0100] \"%s /%s HTTPConfig/%s\" %d %d %d %d %d %s %s %s %s %s\n",
