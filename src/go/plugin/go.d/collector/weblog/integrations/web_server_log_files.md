...
keywords: ['webserver', 'apache', 'httpd', 'nginx', 'lighttpd', 'logs']
...
|  | url_patterns.match | Used to match against full original request URI. Match syntax in [matcher](https://github.com/netdata/netdata/tree/master/src/go/pkg/matcher#supported-format). |  | yes |
...
Pattern values use the [matcher library](https://github.com/netdata/netdata/tree/master/src/go/pkg/matcher#supported-format) syntax:
