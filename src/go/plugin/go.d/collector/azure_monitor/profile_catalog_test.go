...
// Duplicate-stock-basename and invalid-basename rejection are generic loader
// mechanics owned and tested by pkg/profilecatalog; they are not re-tested
// through the azure_monitor wrapper.
