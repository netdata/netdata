...
func measurementTestProject(t *testing.T, client *protocolClient, nodes ...*graphNode) []measurement.Observation {
	t.Helper()
	if client.measurement == nil {
	...
	result, err := client.measurement.Project(resources, false, time.Unix(10, 0))
