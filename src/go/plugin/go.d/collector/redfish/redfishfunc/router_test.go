		...
		Components: []measurement.Component{
			{
				...
				TotalCores:                new(float64(32)),
				EnabledCores:              new(float64(0)),
				TotalThreads:              new(float64(64)),
				CapacityBytes:             new(float64(34359738368)),
				MemoryType:                "DDR5",
				MediaType:                 "SSD",
				DriveProtocol:             "NVMe",
				RAIDType:                  "RAID1",
				ReleaseDate:               now.Add(-24 * time.Hour),
				HardwareVersion:           "HW-3",
				EngineeringRevision:       "EC-4",
			},
