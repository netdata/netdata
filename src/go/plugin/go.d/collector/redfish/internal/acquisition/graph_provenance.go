...
func (c *Client) reconcileSensorExcerptIdentities(graph *resourceGraph) {
...
func (c *Client) mergeProvenSensorExcerpts(graph *resourceGraph) map[string]*graphNode {
...
func (c *Client) reconcileSensorMembership(aliases map[string]*graphNode) {
