...
func (c *Client) acquireLinkedValues(
	ctx context.Context,
...
func (c *Client) acquireLinkedURI(
	ctx context.Context,
	rel graphRelationship,
	rawURI string,
	stats *wireStats,
...
func (c *Client) fetchGraphCollectionMembers(
	ctx context.Context,
...
func (c *Client) unavailableGraphNode(kind, uri, state string) *graphNode {
	node := &graphNode{
		Kind:             kind,
		URI:              uri,
		Locator:          uri,
...
func (c *Client) graphNodeFromResponse(
	kind string,
...
func (c *Client) graphNodeFromData(
	kind string,
	response *responseData,
	data map[string]any,
	source string,
