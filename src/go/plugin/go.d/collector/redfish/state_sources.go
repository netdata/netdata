...
var additionalStateSources = []stateSource{
	...
	{Kind: "drive", Path: "StatusIndicator", Metric: "drive_status_indicator", States: []string{"ok", "fail", "rebuild", "predictive_failure_analysis", "hotspare", "in_a_critical_array", "in_a_failed_array", "unknown"}},
	{Kind: "volume", Path: "WriteCacheState", Metric: "volume_write_cache_state", States: []string{"unprotected", "protected", "degraded", "unknown"}},
	{Kind: "ethernet_interface", Path: "LinkStatus", Metric: "ethernet_interface_link_status", States: []string{"link_up", "no_link", "link_down", "unknown"}},
	{Kind: "network_port", Path: "LinkStatus", Metric: "network_port_link_status", States: []string{"down", "up", "starting", "training", "unknown"}},
	{Kind: "network_port", Path: "SignalDetected", Metric: "network_port_signal_detected", BooleanFalse: "clear", BooleanTrue: "detected", States: []string{"clear", "detected", "unknown"}},
	{Kind: "port", Path: "LinkState", Metric: "port_link_state", States: []string{"enabled", "disabled", "unknown"}},
	{Kind: "port", Path: "LinkStatus", Metric: "port_link_status", States: []string{"link_up", "starting", "training", "link_down", "no_link", "unknown"}},
	...
	{Kind: "system", Path: "ProcessorSummary.Status.HealthRollup", Metric: "system_processor_summary_health_rollup", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "system", Path: "ProcessorSummary.Status.State", Metric: "system_processor_summary_state", States: []string{"enabled", "disabled", "standby_offline", "standby_spare", "in_test", "starting", "absent", "unavailable_offline", "deferring", "quiesced", "updating", "qualified", "degraded", "unknown"}},
	{Kind: "system", Path: "MemorySummary.Status.Health", Metric: "system_memory_summary_health", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "system", Path: "MemorySummary.Status.HealthRollup", Metric: "system_memory_summary_health_rollup", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "system", Path: "MemorySummary.Status.State", Metric: "system_memory_summary_state", States: []string{"enabled", "disabled", "standby_offline", "standby_spare", "in_test", "starting", "absent", "unavailable_offline", "deferring", "quiesced", "updating", "qualified", "degraded", "unknown"}},
	{Kind: "storage_controller", Path: "CacheSummary.Status.Health", Metric: "storage_controller_cache_health", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "storage_controller", Path: "CacheSummary.Status.HealthRollup", Metric: "storage_controller_cache_health_rollup", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "storage_controller", Path: "CacheSummary.Status.State", Metric: "storage_controller_cache_state", States: []string{"enabled", "disabled", "standby_offline", "standby_spare", "in_test", "starting", "absent", "unavailable_offline", "deferring", "quiesced", "updating", "qualified", "degraded", "unknown"}},
	{Kind: "power_supply", Document: "power_supply_metrics", Path: "Status.Health", Metric: "power_supply_metrics_health", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "power_supply", Document: "power_supply_metrics", Path: "Status.HealthRollup", Metric: "power_supply_metrics_health_rollup", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "power_supply", Document: "power_supply_metrics", Path: "Status.State", Metric: "power_supply_metrics_state", States: []string{"enabled", "disabled", "standby_offline", "standby_spare", "in_test", "starting", "absent", "unavailable_offline", "deferring", "quiesced", "updating", "qualified", "degraded", "unknown"}},
	{Kind: "battery", Document: "battery_metrics", Path: "Status.Health", Metric: "battery_metrics_health", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "battery", Document: "battery_metrics", Path: "Status.HealthRollup", Metric: "battery_metrics_health_rollup", States: []string{"ok", "warning", "critical", "unknown"}},
	{Kind: "battery", Document: "battery_metrics", Path: "Status.State", Metric: "battery_metrics_state", States: []string{"enabled", "disabled", "standby_offline", "standby_spare", "in_test", "starting", "absent", "unavailable_offline", "deferring", "quiesced", "updating", "qualified", "degraded", "unknown"}},
}
...
var sourceFlagSets = []flagSet{
	...
	{Kind: "network_device_function", Document: "network_device_function_metrics", Metric: "network_device_function_queue_empty_state", Members: []flagMember{
		{"RXQueuesEmpty", "received", false},
		{"TXQueuesEmpty", "sent", false},
	}},
	{Kind: "storage_controller", Document: "storage_controller_metrics", Metric: "storage_controller_nvme_critical_warnings", Members: []flagMember{
