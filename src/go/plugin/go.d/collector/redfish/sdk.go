...
func (c *protocolClient) sdkConfig() gofish.ClientConfig {
...
func (c *protocolClient) connectSDK(
	ctx context.Context,
...
func (c *protocolClient) get(ctx context.Context, target *url.URL, stats *wireStats) (*responseData, error) {
	return c.getWithClient(ctx, c.sdk, target, stats)
}

func (c *protocolClient) getWithClient(
	ctx context.Context,
