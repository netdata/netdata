...
keywords: [big data, stream processing, message broker]
description: "Monitor Kafka consumer lag metrics for efficient message queue management and performance."
...
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/collectors/databases/kafka-consumer-lag"
slug: "/collecting-metrics/collectors/databases/kafka-consumer-lag"
-->
...
<img src="https://netdata.cloud/img/kafka.svg" width="150" alt="Kafka Consumer Lag"/>
