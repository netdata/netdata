...
// AnalysisStats reports deterministic work performed by an Analyzer.
...
func (a *Analyzer) Stats() AnalysisStats { return a.stats }
...
func (a *Analyzer) step(operations int) error {
	...
	if operations < 0 || a.stats.Operations > a.budget.MaxOperations-operations {
