					...
					BGP: []topologyBGPPeerDetailRow{
						{
							...
							EstablishedUptime:     int64PtrForTest(7200),
							LastReceivedUpdateAge: int64PtrForTest(15),
							LocalAS:               "64512",
					...
					BGP: []topologyBGPPeerDetailRow{
						{
							...
							EstablishedUptime:     int64PtrForTest(7100),
							LastReceivedUpdateAge: int64PtrForTest(20),
							LocalAS:               "64513",
