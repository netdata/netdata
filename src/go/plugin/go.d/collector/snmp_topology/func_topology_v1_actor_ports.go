...
func snmpTopologyV1PortValues(port topologyengine.ProjectionPortDetail) map[string]any {
	return pruneNilAttributes(map[string]any{
		"if_index":                 nullableOptionalUintValue(port.IfIndex, port.HasIfIndex),
		"port_id":                  port.PortID,
		...
		"mac":                      port.MAC,
		"speed":                    nullableOptionalUint64Value(port.Speed, port.HasSpeed),
		...
		"fdb_mac_count":            nullableOptionalUintValue(port.FDBMACCount, port.HasFDBMACCount),
		"link_count":               nullableOptionalUintValue(port.LinkCount, port.HasLinkCount),
		"neighbor_count":           nullableOptionalUintValue(port.NeighborCount, port.HasNeighborCount),
