...
var userCharts = collectorapi.Charts{
	{
		ID:    "%s_user_traffic",
		Title: "User Traffic",
		Units: "kilobits/s",
		...
		Type:  collectorapi.Area,
		Dims: collectorapi.Dims{
			{ID: "%s_bytes_in", Name: "in", Algo: collectorapi.Incremental, Mul: 8, Div: 1000},
			{ID: "%s_bytes_out", Name: "out", Algo: collectorapi.Incremental, Mul: -8, Div: 1000},
		},
	},
	{
