...
[Full documentation](/src/go/plugin/go.d/collector/mysql/integrations/functions/percona_mysql-top-queries.md)

<a id="deadlock-info"></a>
### Deadlock Info

Retrieves the latest detected InnoDB deadlock from `SHOW ENGINE INNODB STATUS`.

[Full documentation](/src/go/plugin/go.d/collector/mysql/integrations/functions/percona_mysql-deadlock-info.md)
...
[Full documentation](/src/go/plugin/go.d/collector/mysql/integrations/functions/percona_mysql-error-info.md)
