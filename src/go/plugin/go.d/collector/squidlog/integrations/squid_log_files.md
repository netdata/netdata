...
description: "his collector monitors Squid servers by parsing their access log files."
keywords: ['squid', 'logs']
...
<img src="https://netdata.cloud/img/squid.png" width="150" alt="Squid log files"/>
...
In addition, to make `Squid` [native log format](https://wiki.squid-cache.org/Features/LogFormat#squid-native-accesslog-format-in-detail) csv parsable, squidlog understands these groups of codes:
