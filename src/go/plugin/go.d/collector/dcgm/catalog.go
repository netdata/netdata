...
var groupCatalog = []groupSpec{
	...
	{Suffix: "interconnect.connectx.link", Title: "ConnectX Link", Units: "value", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.connectx.temperature", Title: "ConnectX Temperature", Units: "Celsius", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.connectx.errors", Title: "ConnectX Errors", Units: "errors/s", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.nvswitch.status", Title: "NVSwitch Status", Units: "state", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.nvswitch.topology", Title: "NVSwitch Topology", Units: "value", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.nvswitch.throughput", Title: "NVSwitch Throughput", Units: "bytes/s", Family: "interconnect", Type: module.Area},
	{Suffix: "interconnect.nvswitch.latency", Title: "NVSwitch Link Latency", Units: "events/s", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.nvswitch.errors", Title: "NVSwitch Errors", Units: "errors/s", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.nvswitch.temperature", Title: "NVSwitch Temperature", Units: "Celsius", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.nvswitch.power", Title: "NVSwitch Power", Units: "Watts", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.nvswitch.current", Title: "NVSwitch Current", Units: "value", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.nvswitch.voltage", Title: "NVSwitch Voltage", Units: "mV", Family: "interconnect", Type: module.Line},
	{Suffix: "interconnect.connectx.error_status", Title: "ConnectX Error Status", Units: "state", Family: "interconnect", Type: module.Line},
...
func buildContextCatalog() map[string]contextSpec {
	entities := []metricEntity{entityGPU, entityMIG, entityLink, entitySwitch, entityCPU, entityCPUCore, entityExporter}
