...
var groupCatalog = []groupSpec{
	...
	{Suffix: "reliability.row_remap_status", Title: "Row Remap Status", Units: "state", Family: "reliability", Type: module.Line},
	{Suffix: "reliability.row_remap_events", Title: "Row Remap Events", Units: "rows/s", Family: "reliability", Type: module.Line},
	{Suffix: "reliability.memory_health", Title: "Memory Health", Units: "state", Family: "reliability", Type: module.Line},
	{Suffix: "reliability.recovery_action", Title: "Recovery Action", Units: "state", Family: "reliability", Type: module.Line},
	{Suffix: "clock.frequency", Title: "Clock Frequency", Units: "MHz", Family: "clock", Type: module.Line},
	{Suffix: "throttle.reasons", Title: "Throttle Reasons", Units: "bitmask", Family: "throttle", Type: module.Line},
	{Suffix: "thermal.temperature", Title: "Temperature", Units: "Celsius", Family: "thermal", Type: module.Line},
	{Suffix: "thermal.fan_speed", Title: "Fan Speed", Units: "percentage", Family: "thermal", Type: module.Line},
	{Suffix: "power.usage", Title: "Power Usage", Units: "Watts", Family: "power", Type: module.Line},
	{Suffix: "power.energy", Title: "Energy Consumption Rate", Units: "mJ/s", Family: "power", Type: module.Line},
	...
	{Suffix: "interconnect.throughput", Title: "Interconnect Throughput", Units: "bytes/s", Family: "interconnect/overview", Type: module.Area},
	...
	{Suffix: "interconnect.traffic", Title: "Interconnect Traffic", Units: "events/s", Family: "interconnect/overview", Type: module.Line},
	...
	{Suffix: "interconnect.ber", Title: "Interconnect Bit Error Rate", Units: "ratio", Family: "interconnect/overview", Type: module.Line},
	...
	{Suffix: "interconnect.state", Title: "Interconnect State", Units: "state", Family: "interconnect/overview", Type: module.Line},
	{Suffix: "interconnect.nvlink.congestion", Title: "NVLink Congestion", Units: "events/s", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.congestion", Title: "Interconnect Congestion", Units: "events/s", Family: "interconnect/overview", Type: module.Line},
	{Suffix: "interconnect.fabric", Title: "Fabric State", Units: "state", Family: "interconnect/overview", Type: module.Line},
	...
	{Suffix: "interconnect.errors", Title: "Interconnect Errors", Units: "errors", Family: "interconnect/overview", Type: module.Line},
	{Suffix: "interconnect.error_rate", Title: "Interconnect Error Rate", Units: "errors/s", Family: "interconnect/overview", Type: module.Line},
	{Suffix: "interconnect.connectx.status", Title: "ConnectX Status", Units: "state", Family: "interconnect/pcie", Type: module.Line},
	{Suffix: "interconnect.connectx.link", Title: "ConnectX Link", Units: "value", Family: "interconnect/pcie", Type: module.Line},
	{Suffix: "interconnect.connectx.temperature", Title: "ConnectX Temperature", Units: "Celsius", Family: "interconnect/pcie", Type: module.Line},
	{Suffix: "interconnect.connectx.errors", Title: "ConnectX Errors", Units: "errors/s", Family: "interconnect/pcie", Type: module.Line},
	{Suffix: "interconnect.nvswitch.status", Title: "NVSwitch Status", Units: "state", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.nvswitch.topology", Title: "NVSwitch Topology", Units: "value", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.nvswitch.throughput", Title: "NVSwitch Throughput", Units: "bytes/s", Family: "interconnect/nvlink", Type: module.Area},
	{Suffix: "interconnect.nvswitch.latency", Title: "NVSwitch Link Latency", Units: "events/s", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.nvswitch.errors", Title: "NVSwitch Errors", Units: "errors/s", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.nvswitch.temperature", Title: "NVSwitch Temperature", Units: "Celsius", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.nvswitch.power", Title: "NVSwitch Power", Units: "Watts", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.nvswitch.current", Title: "NVSwitch Current", Units: "value", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.nvswitch.voltage", Title: "NVSwitch Voltage", Units: "mV", Family: "interconnect/nvlink", Type: module.Line},
	{Suffix: "interconnect.connectx.error_status", Title: "ConnectX Error Status", Units: "state", Family: "interconnect/pcie", Type: module.Line},
	{Suffix: "reliability.xid", Title: "XID Errors", Units: "code", Family: "reliability", Type: module.Line},
	{Suffix: "health.status", Title: "Health Status", Units: "state", Family: "health", Type: module.Line},
	{Suffix: "state.performance", Title: "Performance State", Units: "state", Family: "state", Type: module.Line},
	{Suffix: "state.virtualization", Title: "Virtualization State", Units: "state", Family: "state", Type: module.Line},
	{Suffix: "state.configuration", Title: "Configuration State", Units: "state", Family: "state", Type: module.Line},
	{Suffix: "virtualization.vgpu.license", Title: "vGPU License", Units: "state", Family: "virtualization", Type: module.Line},
	{Suffix: "virtualization.vgpu.type", Title: "vGPU Type", Units: "value", Family: "virtualization", Type: module.Line},
	{Suffix: "virtualization.vgpu.instance", Title: "vGPU Instance", Units: "value", Family: "virtualization", Type: module.Line},
	{Suffix: "virtualization.vgpu.vm", Title: "vGPU VM", Units: "value", Family: "virtualization", Type: module.Line},
	{Suffix: "virtualization.vgpu.memory", Title: "vGPU Memory", Units: "bytes", Family: "virtualization", Type: module.Line},
	{Suffix: "virtualization.vgpu.frame_rate", Title: "vGPU Frame Rate", Units: "fps", Family: "virtualization", Type: module.Line},
	{Suffix: "virtualization.vgpu.utilization", Title: "vGPU Utilization", Units: "percentage", Family: "virtualization", Type: module.Line},
	{Suffix: "virtualization.vgpu.sessions", Title: "vGPU Sessions", Units: "value", Family: "virtualization", Type: module.Line},
	{Suffix: "virtualization.vgpu.software", Title: "vGPU Software", Units: "value", Family: "virtualization", Type: module.Line},
	{Suffix: "workload.sessions", Title: "Workload Sessions", Units: "value", Family: "workload", Type: module.Line},
	{Suffix: "cpu.utilization", Title: "CPU Utilization", Units: "percentage", Family: "cpu", Type: module.Line},
	{Suffix: "cpu.temperature", Title: "CPU Temperature", Units: "Celsius", Family: "cpu", Type: module.Line},
	{Suffix: "cpu.power", Title: "CPU Power", Units: "Watts", Family: "cpu", Type: module.Line},
	{Suffix: "cpu.info", Title: "CPU Information", Units: "value", Family: "cpu", Type: module.Line},
	{Suffix: "diagnostics.status", Title: "Diagnostics Status", Units: "state", Family: "diagnostics", Type: module.Line},
	{Suffix: "diagnostics.results", Title: "Diagnostics Results", Units: "state", Family: "diagnostics", Type: module.Line},
	{Suffix: "inventory.identity", Title: "Inventory Identity", Units: "value", Family: "inventory", Type: module.Line},
	{Suffix: "inventory.software", Title: "Software and Firmware", Units: "value", Family: "inventory", Type: module.Line},
	{Suffix: "inventory.platform", Title: "Platform Inventory", Units: "value", Family: "inventory", Type: module.Line},
	{Suffix: "topology.affinity", Title: "Topology and Affinity", Units: "value", Family: "topology", Type: module.Line},
	{Suffix: "capability.support", Title: "Capability Support", Units: "state", Family: "capability", Type: module.Line},
	{Suffix: "internal.boundary", Title: "Internal Boundary Fields", Units: "state", Family: "internal", Type: module.Line},
	{Suffix: "state", Title: "Device State", Units: "state", Family: "state", Type: module.Line},
	{Suffix: "other.gauge", Title: "Other Metrics", Units: "value", Family: "other", Type: module.Line},
	{Suffix: "other.counter", Title: "Other Metric Rate", Units: "events/s", Family: "other", Type: module.Line},
}
