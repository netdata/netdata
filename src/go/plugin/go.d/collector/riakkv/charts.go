...
const (
	prioKvNodeOperations = collectorapi.Priority + iota
	prioDtVnodeUpdates
	prioSearchQueries
	prioSearchDocuments
...
*/
var (
	kvNodeOperationsChart = collectorapi.Chart{
		...
		Dims: collectorapi.Dims{
			{ID: "node_gets_total", Name: "gets", Algo: collectorapi.Incremental},
			{ID: "node_puts_total", Name: "puts", Algo: collectorapi.Incremental},
		},
	}
	dtVnodeUpdatesChart = collectorapi.Chart{
		ID:       "dt_vnode_updates",
		...
		Dims: collectorapi.Dims{
			{ID: "vnode_counter_update_total", Name: "counters", Algo: collectorapi.Incremental},
			{ID: "vnode_set_update_total", Name: "sets", Algo: collectorapi.Incremental},
			{ID: "vnode_map_update_total", Name: "maps", Algo: collectorapi.Incremental},
		},
	}
	searchQueriesChart = collectorapi.Chart{
		ID:       "dt_vnode_updates",
		...
		Dims: collectorapi.Dims{
			{ID: "search_query_throughput_count", Name: "queries", Algo: collectorapi.Incremental},
		},
	}
	searchDocumentsChart = collectorapi.Chart{
		ID:       "search_documents",
		...
		Dims: collectorapi.Dims{
			{ID: "search_index_throughput_count", Name: "indexed", Algo: collectorapi.Incremental},
		},
	}
	consistentOperationsChart = collectorapi.Chart{
		...
		Dims: collectorapi.Dims{
			{ID: "consistent_gets_total", Name: "gets", Algo: collectorapi.Incremental},
			{ID: "consistent_puts_total", Name: "puts", Algo: collectorapi.Incremental},
		},
	}
)
...
*/
var (
	kvLatencyGetChart = collectorapi.Chart{
		ID:       "kv_latency_get",
	...
	kvLatencyPutChart = collectorapi.Chart{
		ID:       "kv_latency_put",
	...
	dtLatencyCounterChart = collectorapi.Chart{
	...
	dtLatencySetChart = collectorapi.Chart{
		ID:       "dt_latency_counter",
	...
	dtLatencyMapChart = collectorapi.Chart{
		ID:       "dt_latency_map",
	...
	searchLatencyQueryChart = collectorapi.Chart{
	...
	searchLatencyIndexChart = collectorapi.Chart{
	...
	consistentLatencyGetChart = collectorapi.Chart{
	...
	consistentLatencyPutChart = collectorapi.Chart{
...
*/
var (
	vmProcessesCountChart = collectorapi.Chart{
		ID:       "vm_processes",
	...
	vmProcessesMemoryChart = collectorapi.Chart{
		ID:       "vm_processes",
...
var (
	...
	kvSiblingsEncounteredGetChart = collectorapi.Chart{
	...
	kvObjectSizeGetChart = collectorapi.Chart{
		ID:       "kv_siblings_encountered_get",
	...
	searchVnodeqSizeChart = collectorapi.Chart{
		ID:       "kv_siblings_encountered_get",
	...
	searchIndexErrorsChart = collectorapi.Chart{
	...
	corePbsChart = collectorapi.Chart{
		ID:       "core_pbc",
	...
	coreRepairsChart = collectorapi.Chart{
		ID:       "core_repairs",
	...
	coreFsmActiveChart = collectorapi.Chart{
		ID:       "core_fsm_active",
	...
	coreFsmRejectedChart = collectorapi.Chart{
...
func (c *Collector) adjustCharts(mx map[string]int64) {
	...
	for _, chart := range *c.Charts() {
		chart.Dims = slices.DeleteFunc(chart.Dims, func(dim *collectorapi.Dim) bool {
			_, ok := mx[dim.ID]
			if !ok {
