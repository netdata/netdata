...
// Creator composes the log-backend collector with the Redfish feature runtime.
func Creator(runtime *redfishruntime.Runtime) collectorapi.Creator {
	if runtime == nil {
		panic("redfish_logs Creator requires a non-nil runtime")
	}
