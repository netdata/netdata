<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/city_com_b.v._snmp_traps.md"
sidebar_label: "City Com B.V. SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [city-com-bv, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from City Com B.V."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/city-com-b.v.-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/city-com-b.v.-snmp-traps"
-->
...
# City Com B.V. SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="City Com B.V. SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from City Com B.V. devices with Netdata. The bundled City Com B.V. trap profile decodes 2 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the City Com B.V. enterprise OID space, and decodes the varbinds using the bundled City Com B.V. trap profile. No per-trap configuration.
...
Traps from City Com B.V. devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from City Com B.V. across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 1
...
|:----|----:|
| `ADTX-RAID-AVCL-MIB` | 1 |
| `ADTX-RAID-AVCL-S2-MIB` | 1 |
