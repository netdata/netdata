<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/schleifenbauer_products_b.v._snmp_traps.md"
sidebar_label: "Schleifenbauer Products B.V. SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [schleifenbauer-products-bv, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Schleifenbauer Products B.V."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/schleifenbauer-products-b.v.-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/schleifenbauer-products-b.v.-snmp-traps"
-->
...
# Schleifenbauer Products B.V. SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Schleifenbauer Products B.V. SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Schleifenbauer Products B.V. devices with Netdata. The bundled Schleifenbauer Products B.V. trap profile decodes 10 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Schleifenbauer Products B.V. enterprise OID space, and decodes the varbinds using the bundled Schleifenbauer Products B.V. trap profile. No per-trap configuration.
...
Traps from Schleifenbauer Products B.V. devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Schleifenbauer Products B.V. across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 8 · `notice` 2

**By category:** `state_change` 2 · `diagnostic` 8

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SCHLEIFENBAUER-DATABUS-MIB` | 10 |
