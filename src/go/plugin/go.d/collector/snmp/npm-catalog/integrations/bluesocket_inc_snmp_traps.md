<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/bluesocket_inc_snmp_traps.md"
sidebar_label: "Bluesocket Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [bluesocket-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Bluesocket Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/bluesocket-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/bluesocket-inc-snmp-traps"
-->
...
# Bluesocket Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Bluesocket Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Bluesocket Inc devices with Netdata. The bundled Bluesocket Inc trap profile decodes 26 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Bluesocket Inc enterprise OID space, and decodes the varbinds using the bundled Bluesocket Inc trap profile. No per-trap configuration.
...
Traps from Bluesocket Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **26 trap definitions** from Bluesocket Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `err` 1 · `warning` 9 · `notice` 14

**By category:** `state_change` 4 · `config_change` 13 · `auth` 2 · `diagnostic` 7
...
|:----|----:|
| `BLUESERVER-MIB` | 22 |
| `BLUE-NOTIFICATION-MIB` | 4 |

### Sample decoded traps

- `BLUESERVER-MIB::cctSystemConfChange`
- `BLUESERVER-MIB::cctUserConfChange`
