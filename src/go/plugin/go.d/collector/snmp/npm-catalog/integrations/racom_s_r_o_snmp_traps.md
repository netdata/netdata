<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/racom_s_r_o_snmp_traps.md"
sidebar_label: "Racom S R O SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [racom-s-r-o, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Racom S R O devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/racom-s-r-o-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/racom-s-r-o-snmp-traps"
-->
...
# Racom S R O SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Racom S R O SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Racom S R O devices with Netdata. The bundled Racom S R O trap profile decodes 37 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Racom S R O enterprise OID space, and decodes the varbinds using the bundled Racom S R O trap profile. No per-trap configuration.
...
Traps from Racom S R O devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **37 trap definitions** from Racom S R O across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 2 · `warning` 28 · `notice` 6

**By category:** `state_change` 14 · `diagnostic` 23
