<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/the_advantage_group_snmp_traps.md"
sidebar_label: "The Advantage Group SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [the-advantage-group, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from The Advantage Group devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/the-advantage-group-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/the-advantage-group-snmp-traps"
-->
...
# The Advantage Group SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="The Advantage Group SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from The Advantage Group devices with Netdata. The bundled The Advantage Group trap profile decodes 5 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the The Advantage Group enterprise OID space, and decodes the varbinds using the bundled The Advantage Group trap profile. No per-trap configuration.
...
Traps from The Advantage Group devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from The Advantage Group across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 1 · `notice` 3
...
|:----|----:|
| `MITSUBISHI-UPS-MIB` | 5 |

### Sample decoded traps

- `MITSUBISHI-UPS-MIB::alarmCritical`
- `MITSUBISHI-UPS-MIB::alarmWarning`
