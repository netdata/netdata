<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/generic_bgp_bgp4-mib.md"
sidebar_label: "Generic BGP (BGP4-MIB)"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/BGP Monitoring/Integrations"
keywords: [bgp, bgp4-mib, snmp, routing, peering, npm]
description: "Monitor BGP peering and routing health on any device that implements the standard BGP4-MIB, over SNMP with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/bgp-monitoring/integrations/generic-bgp-bgp4-mib"
slug: "/network-performance-monitoring/bgp-monitoring/integrations/generic-bgp-bgp4-mib"
-->
...
# Generic BGP (BGP4-MIB)


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Generic BGP (BGP4-MIB)"/>
