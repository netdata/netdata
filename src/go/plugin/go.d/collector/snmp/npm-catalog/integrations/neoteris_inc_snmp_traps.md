<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/neoteris_inc_snmp_traps.md"
sidebar_label: "Neoteris Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [neoteris-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Neoteris Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/neoteris-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/neoteris-inc-snmp-traps"
-->
...
# Neoteris Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Neoteris Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Neoteris Inc devices with Netdata. The bundled Neoteris Inc trap profile decodes 38 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Neoteris Inc enterprise OID space, and decodes the varbinds using the bundled Neoteris Inc trap profile. No per-trap configuration.
...
Traps from Neoteris Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **38 trap definitions** from Neoteris Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `err` 1 · `warning` 27 · `notice` 9

**By category:** `state_change` 10 · `config_change` 2 · `security` 3 · `auth` 2 · `license` 3 · `diagnostic` 18

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `PULSESECURE-PSG-MIB` | 38 |

### Sample decoded traps

- `PULSESECURE-PSG-MIB::iveLogNearlyFull`
- `PULSESECURE-PSG-MIB::iveLogFull`
