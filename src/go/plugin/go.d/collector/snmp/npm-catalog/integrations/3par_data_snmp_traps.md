<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/3par_data_snmp_traps.md"
sidebar_label: "3Par Data SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [3par-data, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from 3Par Data devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/3par-data-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/3par-data-snmp-traps"
-->
...
# 3Par Data SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="3Par Data SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from 3Par Data devices with Netdata. The bundled 3Par Data trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the 3Par Data enterprise OID space, and decodes the varbinds using the bundled 3Par Data trap profile. No per-trap configuration.
...
Traps from 3Par Data devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from 3Par Data across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
