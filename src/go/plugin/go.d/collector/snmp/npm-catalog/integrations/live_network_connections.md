...
description: "Map application dependencies on a host. The network-viewer plugin reads the kernel's live socket table and draws which local process talks to which, and which…"
