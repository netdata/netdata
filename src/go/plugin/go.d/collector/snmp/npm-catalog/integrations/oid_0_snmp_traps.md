<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/oid_0_snmp_traps.md"
sidebar_label: "Oid 0 SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [oid-0, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Oid 0 devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/oid-0-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/oid-0-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Oid 0 SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Oid 0 devices with Netdata. The bundled Oid 0 trap profile decodes 9 trap definitions across 5 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Oid 0 enterprise OID space, and decodes the varbinds using the bundled Oid 0 trap profile. No per-trap configuration.
...
Traps from Oid 0 devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **9 trap definitions** from Oid 0 across **5 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 1 · `err` 1 · `warning` 3 · `notice` 3

**By category:** `state_change` 6 · `security` 1 · `diagnostic` 2

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `H323-GATEKEEPER-MIB` | 3 |
| `H323GW-MIB` | 3 |
| `H225-MIB` | 1 |
| `H323MC-MIB` | 1 |
| `RAS-MIB` | 1 |
...
- `H225-MIB::callReleaseComplete`
- `RAS-MIB::admissionReject`
