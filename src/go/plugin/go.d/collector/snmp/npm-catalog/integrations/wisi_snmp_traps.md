<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/wisi_snmp_traps.md"
sidebar_label: "Wisi SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [wisi, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Wisi devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/wisi-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/wisi-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Wisi SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Wisi devices with Netdata. The bundled Wisi trap profile decodes 22 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Wisi enterprise OID space, and decodes the varbinds using the bundled Wisi trap profile. No per-trap configuration.
...
Traps from Wisi devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **22 trap definitions** from Wisi across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 2 · `warning` 6 · `notice` 13

**By category:** `state_change` 7 · `config_change` 1 · `diagnostic` 13 · `unknown` 1

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `WISI-GTSENSORS-MIB` | 13 |
| `WISI-GTMODULES-MIB` | 6 |
| `WISI-GTSETTINGS-MIB` | 2 |
| `WISI-TANGRAM-MIB` | 1 |
