<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nokia_formerly_lumentis_ab_snmp_traps.md"
sidebar_label: "Nokia Formerly Lumentis AB SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [nokia-formerly-lumentis-ab, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Nokia Formerly Lumentis AB devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/nokia-formerly-lumentis-ab-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/nokia-formerly-lumentis-ab-snmp-traps"
-->
...
# Nokia Formerly Lumentis AB SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Nokia Formerly Lumentis AB SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Nokia Formerly Lumentis AB devices with Netdata. The bundled Nokia Formerly Lumentis AB trap profile decodes 52 trap definitions across 13 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Nokia Formerly Lumentis AB enterprise OID space, and decodes the varbinds using the bundled Nokia Formerly Lumentis AB trap profile. No per-trap configuration.
...
Traps from Nokia Formerly Lumentis AB devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
**By severity:** `crit` 6 · `warning` 26 · `notice` 18 · `info` 2

**By category:** `state_change` 33 · `config_change` 1 · `diagnostic` 18
