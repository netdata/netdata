<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/volubill_snmp_traps.md"
sidebar_label: "Volubill SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [volubill, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Volubill devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/volubill-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/volubill-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Volubill SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Volubill devices with Netdata. The bundled Volubill trap profile decodes 42 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Volubill enterprise OID space, and decodes the varbinds using the bundled Volubill trap profile. No per-trap configuration.
...
Traps from Volubill devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **42 trap definitions** from Volubill across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 1 · `crit` 8 · `err` 2 · `warning` 17 · `notice` 12 · `info` 2

**By category:** `state_change` 9 · `config_change` 3 · `security` 1 · `diagnostic` 29

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `KENYA-COMPONENT-TRAPS` | 42 |

### Sample decoded traps

- `KENYA-COMPONENT-TRAPS::procMissing`
- `KENYA-COMPONENT-TRAPS::procMissingAfterRespawn`
