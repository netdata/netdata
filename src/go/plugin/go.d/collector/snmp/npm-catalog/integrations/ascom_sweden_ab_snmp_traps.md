<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/ascom_sweden_ab_snmp_traps.md"
sidebar_label: "Ascom Sweden AB SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [ascom-sweden-ab, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Ascom Sweden AB devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/ascom-sweden-ab-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/ascom-sweden-ab-snmp-traps"
-->
...
# Ascom Sweden AB SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Ascom Sweden AB SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Ascom Sweden AB devices with Netdata. The bundled Ascom Sweden AB trap profile decodes 14 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Ascom Sweden AB enterprise OID space, and decodes the varbinds using the bundled Ascom Sweden AB trap profile. No per-trap configuration.
...
Traps from Ascom Sweden AB devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **14 trap definitions** from Ascom Sweden AB across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 4 · `warning` 6 · `notice` 4

**By category:** `state_change` 3 · `auth` 1 · `diagnostic` 10
...
- `ASCOM-IPDECT-MIB::ascomColdStart`
- `ASCOM-IPDECT-MIB::ascomWarmStart`
