<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/timeplex_snmp_traps.md"
sidebar_label: "Timeplex SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [timeplex, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Timeplex devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/timeplex-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/timeplex-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Timeplex SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Timeplex devices with Netdata. The bundled Timeplex trap profile decodes 22 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Timeplex enterprise OID space, and decodes the varbinds using the bundled Timeplex trap profile. No per-trap configuration.
...
Traps from Timeplex devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **22 trap definitions** from Timeplex across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 2 · `warning` 10 · `notice` 7 · `info` 2

**By category:** `state_change` 1 · `config_change` 1 · `diagnostic` 20
...
- `HPNSATRAP-MIB::rtConfigUpdated`
- `HPNSATRAP-MIB::rtPhysicalDriveStateChange`
