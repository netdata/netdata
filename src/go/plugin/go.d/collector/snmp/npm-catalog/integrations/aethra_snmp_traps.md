<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/aethra_snmp_traps.md"
sidebar_label: "Aethra SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [aethra, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Aethra devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/aethra-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/aethra-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Aethra SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Aethra devices with Netdata. The bundled Aethra trap profile decodes 8 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Aethra enterprise OID space, and decodes the varbinds using the bundled Aethra trap profile. No per-trap configuration.
...
Traps from Aethra devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Aethra across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 3 · `notice` 5

**By category:** `state_change` 4 · `config_change` 1 · `auth` 2 · `diagnostic` 1
...
- `AETHRA-MIB::genericTrap`
- `AETHRA-MIB::interfaceUp`
