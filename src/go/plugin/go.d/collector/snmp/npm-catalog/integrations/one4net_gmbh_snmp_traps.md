<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/one4net_gmbh_snmp_traps.md"
sidebar_label: "One4Net GmbH SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [one4net-gmbh, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from One4Net GmbH devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/one4net-gmbh-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/one4net-gmbh-snmp-traps"
-->
...
# One4Net GmbH SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="One4Net GmbH SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from One4Net GmbH devices with Netdata. The bundled One4Net GmbH trap profile decodes 4 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the One4Net GmbH enterprise OID space, and decodes the varbinds using the bundled One4Net GmbH trap profile. No per-trap configuration.
...
Traps from One4Net GmbH devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from One4Net GmbH across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 1 · `notice` 2

**By category:** `state_change` 3 · `license` 1
