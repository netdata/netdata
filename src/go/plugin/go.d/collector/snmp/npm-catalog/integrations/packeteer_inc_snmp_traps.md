<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/packeteer_inc_snmp_traps.md"
sidebar_label: "Packeteer Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [packeteer-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Packeteer Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/packeteer-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/packeteer-inc-snmp-traps"
-->
...
# Packeteer Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Packeteer Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Packeteer Inc devices with Netdata. The bundled Packeteer Inc trap profile decodes 13 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Packeteer Inc enterprise OID space, and decodes the varbinds using the bundled Packeteer Inc trap profile. No per-trap configuration.
...
Traps from Packeteer Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **13 trap definitions** from Packeteer Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 8 · `warning` 4

**By category:** `state_change` 1 · `diagnostic` 12
...
- `PACKETEER-MIB::psAlarmSiteRouter`
- `PACKETEER-MIB::psAlarmPowerSystemOne`
