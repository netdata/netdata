<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/loral_wdl_snmp_traps.md"
sidebar_label: "Loral Wdl SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [loral-wdl, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Loral Wdl devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/loral-wdl-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/loral-wdl-snmp-traps"
-->
...
# Loral Wdl SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Loral Wdl SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Loral Wdl devices with Netdata. The bundled Loral Wdl trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Loral Wdl enterprise OID space, and decodes the varbinds using the bundled Loral Wdl trap profile. No per-trap configuration.
...
Traps from Loral Wdl devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Loral Wdl across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
