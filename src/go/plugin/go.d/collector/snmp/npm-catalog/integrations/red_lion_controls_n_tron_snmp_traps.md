<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/red_lion_controls_n_tron_snmp_traps.md"
sidebar_label: "Red Lion Controls N Tron SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [red-lion-controls-n-tron, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Red Lion Controls N Tron devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/red-lion-controls-n-tron-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/red-lion-controls-n-tron-snmp-traps"
-->
...
# Red Lion Controls N Tron SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Red Lion Controls N Tron SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Red Lion Controls N Tron devices with Netdata. The bundled Red Lion Controls N Tron trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Red Lion Controls N Tron enterprise OID space, and decodes the varbinds using the bundled Red Lion Controls N Tron trap profile. No per-trap configuration.
...
Traps from Red Lion Controls N Tron devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Red Lion Controls N Tron across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
