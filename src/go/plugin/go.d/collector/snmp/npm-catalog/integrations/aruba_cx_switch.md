...
description: "Monitor Aruba CX Switch (switch) with Netdata over SNMP."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/device-metrics/integrations/aruba-cx-switch"
slug: "/network-performance-monitoring/device-metrics/integrations/aruba-cx-switch"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Aruba CX Switch"/>
...
| `snmp.device_prof_arubaWiredFanStateEnum` | `{status}` | per aruba_wired_fan_name, aruba_wired_fan_product_name, aruba_wired_fan_serial_number, aruba_wired_fan_airflow_direction | Current status for the fan |
