<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/convertronic_gmbh_snmp_traps.md"
sidebar_label: "Convertronic GmbH SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [convertronic-gmbh, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Convertronic GmbH devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/convertronic-gmbh-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/convertronic-gmbh-snmp-traps"
-->
...
# Convertronic GmbH SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Convertronic GmbH SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Convertronic GmbH devices with Netdata. The bundled Convertronic GmbH trap profile decodes 32 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Convertronic GmbH enterprise OID space, and decodes the varbinds using the bundled Convertronic GmbH trap profile. No per-trap configuration.
...
Traps from Convertronic GmbH devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **32 trap definitions** from Convertronic GmbH across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 5 · `crit` 6 · `warning` 16 · `notice` 5

**By category:** `state_change` 1 · `diagnostic` 31
...
- `STS_SEQUENZ-MIB::source_mains_failue_present_trap`
- `STS_SEQUENZ-MIB::source_inverter_failure_present`
