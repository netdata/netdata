<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/synso_inc_snmp_traps.md"
sidebar_label: "Synso Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [synso-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Synso Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/synso-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/synso-inc-snmp-traps"
-->
...
# Synso Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Synso Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Synso Inc devices with Netdata. The bundled Synso Inc trap profile decodes 7 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Synso Inc enterprise OID space, and decodes the varbinds using the bundled Synso Inc trap profile. No per-trap configuration.
...
Traps from Synso Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Synso Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 4 · `warning` 3

**By category:** `diagnostic` 7
...
- `SYNSO-UPSMIB::syupsTrapOverTemperature`
- `SYNSO-UPSMIB::syupsTrapOverCurrent`
