<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/periphonics_corporation_snmp_traps.md"
sidebar_label: "Periphonics Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [periphonics-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Periphonics Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/periphonics-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/periphonics-corporation-snmp-traps"
-->
...
# Periphonics Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Periphonics Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Periphonics Corporation devices with Netdata. The bundled Periphonics Corporation trap profile decodes 10 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Periphonics Corporation enterprise OID space, and decodes the varbinds using the bundled Periphonics Corporation trap profile. No per-trap configuration.
...
Traps from Periphonics Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Periphonics Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 4 · `notice` 6

**By category:** `state_change` 7 · `diagnostic` 3

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `PERIPHONICS-VRU-NETWORK-MIB` | 10 |
