<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/mitel_corp_snmp_traps.md"
sidebar_label: "Mitel Corp SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [mitel-corp, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Mitel Corp devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/mitel-corp-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/mitel-corp-snmp-traps"
-->
...
# Mitel Corp SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Mitel Corp SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Mitel Corp devices with Netdata. The bundled Mitel Corp trap profile decodes 19 trap definitions across 11 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Mitel Corp enterprise OID space, and decodes the varbinds using the bundled Mitel Corp trap profile. No per-trap configuration.
...
Traps from Mitel Corp devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **19 trap definitions** from Mitel Corp across **11 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `crit` 1 · `err` 2 · `warning` 8 · `notice` 5

**By category:** `state_change` 8 · `security` 1 · `diagnostic` 10

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `MITEL-IperaVoiceLAN-MIB` | 6 |
| `MITEL-DHCP-MIB` | 2 |
| `MITEL-MN3100-CALL-CONTROL-MIB` | 2 |
| `MITEL-VOICE-MAIL-MIB` | 2 |
| `MITEL-APPLICATION-MON-MIB` | 1 |
| `MITEL-CMNALM-MIB` | 1 |
| `MITEL-ERN` | 1 |
| `MITEL-IPFILTER-MIB` | 1 |
| `MITEL-LOGICAL-MIB` | 1 |
| `MITEL-MN3100-T1-TRAP-MIB` | 1 |
| `MITEL-SX2000-MIB` | 1 |

### Sample decoded traps

- `MITEL-SX2000-MIB::mitelCs2000NotifAlarm`
- `MITEL-IperaVoiceLAN-MIB::mitelIpera3000NotifAlarm`
