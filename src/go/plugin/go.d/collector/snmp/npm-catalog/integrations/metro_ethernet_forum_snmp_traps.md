<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/metro_ethernet_forum_snmp_traps.md"
sidebar_label: "Metro Ethernet Forum SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [metro-ethernet-forum, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Metro Ethernet Forum devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/metro-ethernet-forum-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/metro-ethernet-forum-snmp-traps"
-->
...
# Metro Ethernet Forum SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Metro Ethernet Forum SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Metro Ethernet Forum devices with Netdata. The bundled Metro Ethernet Forum trap profile decodes 5 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Metro Ethernet Forum enterprise OID space, and decodes the varbinds using the bundled Metro Ethernet Forum trap profile. No per-trap configuration.
...
Traps from Metro Ethernet Forum devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Metro Ethernet Forum across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
