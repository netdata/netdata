<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/netbotz_snmp_traps.md"
sidebar_label: "Netbotz SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [netbotz, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Netbotz devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/netbotz-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/netbotz-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Netbotz SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Netbotz devices with Netdata. The bundled Netbotz trap profile decodes 449 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Netbotz enterprise OID space, and decodes the varbinds using the bundled Netbotz trap profile. No per-trap configuration.
...
Traps from Netbotz devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **449 trap definitions** from Netbotz across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 258 · `notice` 190

**By category:** `state_change` 63 · `security` 2 · `auth` 1 · `diagnostic` 383
...
- `NETBOTZ-MIB::netBotz-prd-bot-low-trap`
- `NETBOTZ-MIB::netBotz-prd-bot-high-trap`
