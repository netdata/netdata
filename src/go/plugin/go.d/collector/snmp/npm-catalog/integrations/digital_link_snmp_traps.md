<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/digital_link_snmp_traps.md"
sidebar_label: "Digital Link SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [digital-link, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Digital Link devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/digital-link-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/digital-link-snmp-traps"
-->
...
# Digital Link SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Digital Link SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Digital Link devices with Netdata. The bundled Digital Link trap profile decodes 93 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Digital Link enterprise OID space, and decodes the varbinds using the bundled Digital Link trap profile. No per-trap configuration.
...
Traps from Digital Link devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **93 trap definitions** from Digital Link across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 4 · `crit` 18 · `err` 1 · `warning` 23 · `notice` 44 · `info` 3

**By category:** `state_change` 26 · `config_change` 3 · `diagnostic` 64
...
- `DL5400-MIB::dl5400ModulesAppear`
- `DL5400-MIB::dl5400ModulesDisappear`
