<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cherokee_international_corporation_snmp_traps.md"
sidebar_label: "Cherokee International Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cherokee-international-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cherokee International Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cherokee-international-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cherokee-international-corporation-snmp-traps"
-->
...
# Cherokee International Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cherokee International Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cherokee International Corporation devices with Netdata. The bundled Cherokee International Corporation trap profile decodes 3 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cherokee International Corporation enterprise OID space, and decodes the varbinds using the bundled Cherokee International Corporation trap profile. No per-trap configuration.
...
Traps from Cherokee International Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **3 trap definitions** from Cherokee International Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 3

**By category:** `diagnostic` 3

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SITE-MONITORING-MIB` | 3 |
