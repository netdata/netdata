<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/shiva_corporation_snmp_traps.md"
sidebar_label: "Shiva Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [shiva-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Shiva Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/shiva-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/shiva-corporation-snmp-traps"
-->
...
# Shiva Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Shiva Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Shiva Corporation devices with Netdata. The bundled Shiva Corporation trap profile decodes 9 trap definitions across 5 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Shiva Corporation enterprise OID space, and decodes the varbinds using the bundled Shiva Corporation trap profile. No per-trap configuration.
...
Traps from Shiva Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **9 trap definitions** from Shiva Corporation across **5 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 2 · `warning` 5 · `notice` 2

**By category:** `state_change` 1 · `diagnostic` 8
...
- `SHIVA-ACCT-MIB::acctLostRecordTrap`
- `SHIVA-ACCT-MIB::acctMemoryUnavailableTrap`
