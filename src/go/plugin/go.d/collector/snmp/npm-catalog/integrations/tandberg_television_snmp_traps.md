<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/tandberg_television_snmp_traps.md"
sidebar_label: "Tandberg Television SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [tandberg-television, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Tandberg Television devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/tandberg-television-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/tandberg-television-snmp-traps"
-->
...
# Tandberg Television SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Tandberg Television SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Tandberg Television devices with Netdata. The bundled Tandberg Television trap profile decodes 9 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Tandberg Television enterprise OID space, and decodes the varbinds using the bundled Tandberg Television trap profile. No per-trap configuration.
...
Traps from Tandberg Television devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **9 trap definitions** from Tandberg Television across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 2 · `warning` 5 · `notice` 2

**By category:** `state_change` 2 · `config_change` 1 · `diagnostic` 6
...
- `ETV-Trap-MIB::statusTrap`
- `ETV-AlarmTrap-MIB::alarmNormal`
