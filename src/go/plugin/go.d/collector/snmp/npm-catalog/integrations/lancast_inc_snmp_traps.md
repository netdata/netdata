<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/lancast_inc_snmp_traps.md"
sidebar_label: "Lancast Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [lancast-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Lancast Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/lancast-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/lancast-inc-snmp-traps"
-->
...
# Lancast Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Lancast Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Lancast Inc devices with Netdata. The bundled Lancast Inc trap profile decodes 17 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Lancast Inc enterprise OID space, and decodes the varbinds using the bundled Lancast Inc trap profile. No per-trap configuration.
...
Traps from Lancast Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **17 trap definitions** from Lancast Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 2 · `warning` 5 · `notice` 10

**By category:** `state_change` 10 · `config_change` 1 · `diagnostic` 6

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `LC-PHYSICAL-ENTITIES-MIB` | 16 |
| `LC-ENTITY-MIB` | 1 |

### Sample decoded traps

- `LC-ENTITY-MIB::entConfigChange`
- `LC-PHYSICAL-ENTITIES-MIB::tempStatusChange`
