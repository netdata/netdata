<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/tait_international_limited_snmp_traps.md"
sidebar_label: "Tait International Limited SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [tait-international-limited, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Tait International Limited devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/tait-international-limited-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/tait-international-limited-snmp-traps"
-->
...
# Tait International Limited SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Tait International Limited SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Tait International Limited devices with Netdata. The bundled Tait International Limited trap profile decodes 48 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Tait International Limited enterprise OID space, and decodes the varbinds using the bundled Tait International Limited trap profile. No per-trap configuration.
...
Traps from Tait International Limited devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **48 trap definitions** from Tait International Limited across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 8 · `warning` 28 · `notice` 10 · `info` 1

**By category:** `state_change` 28 · `auth` 3 · `license` 2 · `diagnostic` 15
