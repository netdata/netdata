<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/deep_sea_electronics_plc_snmp_traps.md"
sidebar_label: "Deep Sea Electronics PLC SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [deep-sea-electronics-plc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Deep Sea Electronics PLC devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/deep-sea-electronics-plc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/deep-sea-electronics-plc-snmp-traps"
-->
...
# Deep Sea Electronics PLC SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Deep Sea Electronics PLC SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Deep Sea Electronics PLC devices with Netdata. The bundled Deep Sea Electronics PLC trap profile decodes 422 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Deep Sea Electronics PLC enterprise OID space, and decodes the varbinds using the bundled Deep Sea Electronics PLC trap profile. No per-trap configuration.
...
Traps from Deep Sea Electronics PLC devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **422 trap definitions** from Deep Sea Electronics PLC across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 1 · `alert` 41 · `crit` 22 · `err` 1 · `warning` 349 · `notice` 8

**By category:** `state_change` 12 · `diagnostic` 410
