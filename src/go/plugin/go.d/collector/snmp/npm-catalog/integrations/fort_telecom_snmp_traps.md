<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/fort_telecom_snmp_traps.md"
sidebar_label: "Fort Telecom SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [fort-telecom, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Fort Telecom devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/fort-telecom-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/fort-telecom-snmp-traps"
-->
...
# Fort Telecom SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Fort Telecom SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Fort Telecom devices with Netdata. The bundled Fort Telecom trap profile decodes 88 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Fort Telecom enterprise OID space, and decodes the varbinds using the bundled Fort Telecom trap profile. No per-trap configuration.
...
Traps from Fort Telecom devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **88 trap definitions** from Fort Telecom across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 4 · `err` 7 · `warning` 38 · `notice` 38

**By category:** `state_change` 32 · `config_change` 4 · `security` 3 · `auth` 4 · `diagnostic` 45
...
- `FORT-TELECOM-MIB::stpTopologyChanged`
- `FORT-TELECOM-MIB::specialFunctionNoLink`
