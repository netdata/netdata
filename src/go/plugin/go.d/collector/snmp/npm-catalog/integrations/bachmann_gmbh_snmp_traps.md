<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/bachmann_gmbh_snmp_traps.md"
sidebar_label: "Bachmann GmbH SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [bachmann-gmbh, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Bachmann GmbH devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/bachmann-gmbh-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/bachmann-gmbh-snmp-traps"
-->
...
# Bachmann GmbH SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Bachmann GmbH SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Bachmann GmbH devices with Netdata. The bundled Bachmann GmbH trap profile decodes 60 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Bachmann GmbH enterprise OID space, and decodes the varbinds using the bundled Bachmann GmbH trap profile. No per-trap configuration.
...
Traps from Bachmann GmbH devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **60 trap definitions** from Bachmann GmbH across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `err` 1 · `warning` 45 · `notice` 12 · `info` 1

**By category:** `state_change` 3 · `config_change` 2 · `diagnostic` 54 · `unknown` 1
...
|:----|----:|
| `BLUENET-IRS` | 33 |
| `BACHMANN-BLUENET2-MIB` | 27 |

### Sample decoded traps

- `BLUENET-IRS::birsTrOidGeneric`
- `BLUENET-IRS::birsTrOidError`
