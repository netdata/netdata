<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/jds_uniphase_corporation_snmp_traps.md"
sidebar_label: "Jds Uniphase Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [jds-uniphase-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Jds Uniphase Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/jds-uniphase-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/jds-uniphase-corporation-snmp-traps"
-->
...
# Jds Uniphase Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Jds Uniphase Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Jds Uniphase Corporation devices with Netdata. The bundled Jds Uniphase Corporation trap profile decodes 5 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Jds Uniphase Corporation enterprise OID space, and decodes the varbinds using the bundled Jds Uniphase Corporation trap profile. No per-trap configuration.
...
Traps from Jds Uniphase Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Jds Uniphase Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 1 · `notice` 3 · `info` 1
