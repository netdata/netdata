<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nsc_snmp_traps.md"
sidebar_label: "Nsc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [nsc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Nsc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/nsc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/nsc-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Nsc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Nsc devices with Netdata. The bundled Nsc trap profile decodes 23 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Nsc enterprise OID space, and decodes the varbinds using the bundled Nsc trap profile. No per-trap configuration.
...
Traps from Nsc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **23 trap definitions** from Nsc across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 12 · `notice` 10

**By category:** `state_change` 18 · `config_change` 1 · `diagnostic` 4
...
|:----|----:|
| `NSCTRAP` | 19 |
| `NSC-BORDERGUARD-TRAP` | 3 |
| `NSCDXCDA-MIB` | 1 |

### Sample decoded traps

- `NSCDXCDA-MIB::nscDxTrace`
- `NSC-BORDERGUARD-TRAP::nscBorderGuardBadCRC`
