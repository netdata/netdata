<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/webscreen_technology_ltd_snmp_traps.md"
sidebar_label: "Webscreen Technology Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [webscreen-technology-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Webscreen Technology Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/webscreen-technology-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/webscreen-technology-ltd-snmp-traps"
-->
...
# Webscreen Technology Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Webscreen Technology Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Webscreen Technology Ltd devices with Netdata. The bundled Webscreen Technology Ltd trap profile decodes 291 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Webscreen Technology Ltd enterprise OID space, and decodes the varbinds using the bundled Webscreen Technology Ltd trap profile. No per-trap configuration.
...
Traps from Webscreen Technology Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **291 trap definitions** from Webscreen Technology Ltd across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 33 · `crit` 2 · `warning` 141 · `notice` 114 · `info` 1

**By category:** `state_change` 35 · `config_change` 7 · `security` 172 · `license` 6 · `diagnostic` 71
