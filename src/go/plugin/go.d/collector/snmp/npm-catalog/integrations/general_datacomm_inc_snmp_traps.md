<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/general_datacomm_inc_snmp_traps.md"
sidebar_label: "General Datacomm Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [general-datacomm-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from General Datacomm Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/general-datacomm-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/general-datacomm-inc-snmp-traps"
-->
...
# General Datacomm Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="General Datacomm Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from General Datacomm Inc devices with Netdata. The bundled General Datacomm Inc trap profile decodes 13 trap definitions across 7 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the General Datacomm Inc enterprise OID space, and decodes the varbinds using the bundled General Datacomm Inc trap profile. No per-trap configuration.
...
Traps from General Datacomm Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **13 trap definitions** from General Datacomm Inc across **7 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 8 · `notice` 3 · `info` 1

**By category:** `state_change` 4 · `config_change` 1 · `diagnostic` 8
