<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/pdu5_snmp_traps.md"
sidebar_label: "Pdu5 SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [pdu5, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Pdu5 devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/pdu5-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/pdu5-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Pdu5 SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Pdu5 devices with Netdata. The bundled Pdu5 trap profile decodes 17 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Pdu5 enterprise OID space, and decodes the varbinds using the bundled Pdu5 trap profile. No per-trap configuration.
...
Traps from Pdu5 devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **17 trap definitions** from Pdu5 across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 1 · `warning` 4 · `notice` 11

**By category:** `state_change` 11 · `auth` 3 · `diagnostic` 3

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SCHLEIFENBAUER-GENERIC-MIB` | 17 |

### Sample decoded traps

- `SCHLEIFENBAUER-GENERIC-MIB::systemStarted`
- `SCHLEIFENBAUER-GENERIC-MIB::systemRebooted`
