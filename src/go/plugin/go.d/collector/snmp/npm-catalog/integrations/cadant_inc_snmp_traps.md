<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cadant_inc_snmp_traps.md"
sidebar_label: "Cadant Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cadant-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cadant Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cadant-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cadant-inc-snmp-traps"
-->
...
# Cadant Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cadant Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cadant Inc devices with Netdata. The bundled Cadant Inc trap profile decodes 31 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cadant Inc enterprise OID space, and decodes the varbinds using the bundled Cadant Inc trap profile. No per-trap configuration.
...
Traps from Cadant Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **31 trap definitions** from Cadant Inc across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 2 · `warning` 20 · `notice` 7 · `info` 1

**By category:** `state_change` 10 · `auth` 4 · `diagnostic` 17

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `CADANT-CMTS-EQUIPMENT-MIB` | 17 |
| `CADANT-CMTS-NOTIFICATION-MIB` | 10 |
| `CADANT-CMTS-EXPORTIMPORT-MIB` | 2 |
| `CADANT-CMTS-PROCESS-MIB` | 2 |

### Sample decoded traps

- `CADANT-CMTS-PROCESS-MIB::cardOverloadNotification`
- `CADANT-CMTS-PROCESS-MIB::sysOverloadNotification`
