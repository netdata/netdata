<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/luxn_inc_snmp_traps.md"
sidebar_label: "Luxn Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [luxn-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Luxn Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/luxn-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/luxn-inc-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Luxn Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Luxn Inc devices with Netdata. The bundled Luxn Inc trap profile decodes 285 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Luxn Inc enterprise OID space, and decodes the varbinds using the bundled Luxn Inc trap profile. No per-trap configuration.
...
Traps from Luxn Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **285 trap definitions** from Luxn Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 84 · `warning` 56 · `notice` 131 · `info` 12

**By category:** `state_change` 64 · `config_change` 40 · `security` 5 · `auth` 3 · `diagnostic` 173
...
- `LUXN-MIB::luxNGenericTrap`
- `LUXN-MIB::luxNVoadmDetectorFailureTrap`
