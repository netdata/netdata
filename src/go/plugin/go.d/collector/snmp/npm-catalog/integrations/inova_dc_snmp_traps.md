<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/inova_dc_snmp_traps.md"
sidebar_label: "Inova Dc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [inova-dc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Inova Dc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/inova-dc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/inova-dc-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Inova Dc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Inova Dc devices with Netdata. The bundled Inova Dc trap profile decodes 6 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Inova Dc enterprise OID space, and decodes the varbinds using the bundled Inova Dc trap profile. No per-trap configuration.
...
Traps from Inova Dc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **6 trap definitions** from Inova Dc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 1 · `notice` 4
...
- `PowerNet-Inova::rpduCriticalCondition`
- `PowerNet-Inova::rpduCriticalConditionCleared`
