<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/papouch_elektronika_snmp_traps.md"
sidebar_label: "Papouch Elektronika SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [papouch-elektronika, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Papouch Elektronika devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/papouch-elektronika-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/papouch-elektronika-snmp-traps"
-->
...
# Papouch Elektronika SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Papouch Elektronika SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Papouch Elektronika devices with Netdata. The bundled Papouch Elektronika trap profile decodes 2 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Papouch Elektronika enterprise OID space, and decodes the varbinds using the bundled Papouch Elektronika trap profile. No per-trap configuration.
...
Traps from Papouch Elektronika devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Papouch Elektronika across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
