<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/deva_broadcast_ltd_snmp_traps.md"
sidebar_label: "Deva Broadcast Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [deva-broadcast-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Deva Broadcast Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/deva-broadcast-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/deva-broadcast-ltd-snmp-traps"
-->
...
# Deva Broadcast Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Deva Broadcast Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Deva Broadcast Ltd devices with Netdata. The bundled Deva Broadcast Ltd trap profile decodes 33 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Deva Broadcast Ltd enterprise OID space, and decodes the varbinds using the bundled Deva Broadcast Ltd trap profile. No per-trap configuration.
...
Traps from Deva Broadcast Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **33 trap definitions** from Deva Broadcast Ltd across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 19 · `notice` 12 · `info` 2

**By category:** `state_change` 9 · `auth` 1 · `diagnostic` 22 · `unknown` 1
...
- `DB7001-MIB::notifTest`
- `DB7001-MIB::notifRflvlOk`
