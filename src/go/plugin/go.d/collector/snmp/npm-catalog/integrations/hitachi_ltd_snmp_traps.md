<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/hitachi_ltd_snmp_traps.md"
sidebar_label: "Hitachi Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [hitachi-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Hitachi Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/hitachi-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/hitachi-ltd-snmp-traps"
-->
...
# Hitachi Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Hitachi Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Hitachi Ltd devices with Netdata. The bundled Hitachi Ltd trap profile decodes 144 trap definitions across 5 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Hitachi Ltd enterprise OID space, and decodes the varbinds using the bundled Hitachi Ltd trap profile. No per-trap configuration.
...
Traps from Hitachi Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **144 trap definitions** from Hitachi Ltd across **5 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 8 · `alert` 6 · `crit` 36 · `err` 4 · `warning` 56 · `notice` 10 · `info` 24

**By category:** `state_change` 2 · `diagnostic` 142

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SystemManager-MIB` | 98 |
| `HitachiComputeRackEx-MIB` | 21 |
| `Hitachi-DF-RAID-LAN-MIB` | 20 |
| `HM800MIB` | 4 |
| `RAID450MIB` | 1 |

### Sample decoded traps

- `Hitachi-DF-RAID-LAN-MIB::systemDown`
- `Hitachi-DF-RAID-LAN-MIB::driveFailure`
