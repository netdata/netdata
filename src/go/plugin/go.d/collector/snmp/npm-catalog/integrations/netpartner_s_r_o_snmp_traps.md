<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/netpartner_s_r_o_snmp_traps.md"
sidebar_label: "Netpartner S R O SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [netpartner-s-r-o, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Netpartner S R O devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/netpartner-s-r-o-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/netpartner-s-r-o-snmp-traps"
-->
...
# Netpartner S R O SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Netpartner S R O SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Netpartner S R O devices with Netdata. The bundled Netpartner S R O trap profile decodes 22 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Netpartner S R O enterprise OID space, and decodes the varbinds using the bundled Netpartner S R O trap profile. No per-trap configuration.
...
Traps from Netpartner S R O devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **22 trap definitions** from Netpartner S R O across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 19 · `notice` 1 · `info` 1

**By category:** `diagnostic` 22
...
- `IMCO-BIG-MIB::imco3TrapNoDevice`
- `IMCO-BIG-MIB::imco3TrapOnBattery`
