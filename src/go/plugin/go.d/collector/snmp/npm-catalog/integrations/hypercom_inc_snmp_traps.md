<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/hypercom_inc_snmp_traps.md"
sidebar_label: "Hypercom Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [hypercom-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Hypercom Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/hypercom-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/hypercom-inc-snmp-traps"
-->
...
# Hypercom Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Hypercom Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Hypercom Inc devices with Netdata. The bundled Hypercom Inc trap profile decodes 179 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Hypercom Inc enterprise OID space, and decodes the varbinds using the bundled Hypercom Inc trap profile. No per-trap configuration.
...
Traps from Hypercom Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **179 trap definitions** from Hypercom Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 66 · `crit` 16 · `err` 19 · `warning` 22 · `notice` 23 · `info` 33

**By category:** `state_change` 21 · `config_change` 3 · `security` 4 · `diagnostic` 151
...
- `HYPERCOM-MIB::hypTrap03`
- `HYPERCOM-MIB::hypTrap08`
