<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/scte_snmp_traps.md"
sidebar_label: "Scte SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [scte, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Scte devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/scte-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/scte-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Scte SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Scte devices with Netdata. The bundled Scte trap profile decodes 5 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Scte enterprise OID space, and decodes the varbinds using the bundled Scte trap profile. No per-trap configuration.
...
Traps from Scte devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Scte across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
|:----|----:|
| `SCTE-HMS-COMMON-MIB` | 2 |
| `SCTE-HMS-ALARMS-MIB` | 1 |
| `SCTE-HMS-HE-COMMON-MIB` | 1 |
| `SCTE-HMS-HMTS-MIB` | 1 |

### Sample decoded traps

- `SCTE-HMS-COMMON-MIB::hmsColdStart`
- `SCTE-HMS-ALARMS-MIB::hmsAlarmEvent`
