<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/avista_labs_inc_snmp_traps.md"
sidebar_label: "Avista Labs Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [avista-labs-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Avista Labs Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/avista-labs-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/avista-labs-inc-snmp-traps"
-->
...
# Avista Labs Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Avista Labs Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Avista Labs Inc devices with Netdata. The bundled Avista Labs Inc trap profile decodes 9 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Avista Labs Inc enterprise OID space, and decodes the varbinds using the bundled Avista Labs Inc trap profile. No per-trap configuration.
...
Traps from Avista Labs Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **9 trap definitions** from Avista Labs Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 2 · `warning` 2 · `notice` 5

**By category:** `state_change` 3 · `diagnostic` 6

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `PLUG-POWER-ESERIES-MIB` | 9 |

### Sample decoded traps

- `PLUG-POWER-ESERIES-MIB::fcsETrapMJAlarmEntryAdded`
- `PLUG-POWER-ESERIES-MIB::fcsETrapMJAlarmEntryRemoved`
