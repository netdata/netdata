<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/inovonics_inc_snmp_traps.md"
sidebar_label: "Inovonics Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [inovonics-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Inovonics Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/inovonics-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/inovonics-inc-snmp-traps"
-->
...
# Inovonics Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Inovonics Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Inovonics Inc devices with Netdata. The bundled Inovonics Inc trap profile decodes 8 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Inovonics Inc enterprise OID space, and decodes the varbinds using the bundled Inovonics Inc trap profile. No per-trap configuration.
...
Traps from Inovonics Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Inovonics Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 8

**By category:** `diagnostic` 8

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `INOVONICS-MODEL640-MIB` | 4 |
| `INOVONICS-MODEL650-MIB` | 4 |

### Sample decoded traps

- `INOVONICS-MODEL640-MIB::audioLossTrap`
- `INOVONICS-MODEL640-MIB::lowSignalTrap`
