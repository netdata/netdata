<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/innovaphone_gmbh_snmp_traps.md"
sidebar_label: "Innovaphone GmbH SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [innovaphone-gmbh, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Innovaphone GmbH devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/innovaphone-gmbh-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/innovaphone-gmbh-snmp-traps"
-->
...
# Innovaphone GmbH SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Innovaphone GmbH SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Innovaphone GmbH devices with Netdata. The bundled Innovaphone GmbH trap profile decodes 8 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Innovaphone GmbH enterprise OID space, and decodes the varbinds using the bundled Innovaphone GmbH trap profile. No per-trap configuration.
...
Traps from Innovaphone GmbH devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Innovaphone GmbH across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `err` 1 · `warning` 3 · `notice` 3

**By category:** `state_change` 3 · `auth` 1 · `diagnostic` 4
...
- `INNO-MIB::innoColdStart`
- `INNO-MIB::innoWarmStart`
