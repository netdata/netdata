<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/netscaler_snmp_traps.md"
sidebar_label: "Netscaler SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [netscaler, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Netscaler devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/netscaler-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/netscaler-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Netscaler SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Netscaler devices with Netdata. The bundled Netscaler trap profile decodes 288 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Netscaler enterprise OID space, and decodes the varbinds using the bundled Netscaler trap profile. No per-trap configuration.
...
Traps from Netscaler devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **288 trap definitions** from Netscaler across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 23 · `crit` 23 · `err` 8 · `warning` 116 · `notice` 114 · `info` 4

**By category:** `state_change` 107 · `config_change` 15 · `security` 30 · `auth` 3 · `license` 14 · `diagnostic` 119
...
|:----|----:|
| `NS-ROOT-MIB` | 166 |
| `MAS-MIB-SMIV2-MIB` | 66 |
| `SDX-ROOT-MIB` | 56 |

### Sample decoded traps

- `NS-ROOT-MIB::changeToPrimary`
- `NS-ROOT-MIB::changeToSecondary`
