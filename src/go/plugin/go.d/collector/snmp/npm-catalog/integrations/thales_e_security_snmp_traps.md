<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/thales_e_security_snmp_traps.md"
sidebar_label: "Thales E Security SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [thales-e-security, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Thales E Security devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/thales-e-security-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/thales-e-security-snmp-traps"
-->
...
# Thales E Security SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Thales E Security SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Thales E Security devices with Netdata. The bundled Thales E Security trap profile decodes 15 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Thales E Security enterprise OID space, and decodes the varbinds using the bundled Thales E Security trap profile. No per-trap configuration.
...
Traps from Thales E Security devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **15 trap definitions** from Thales E Security across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `crit` 1 · `warning` 6 · `notice` 5

**By category:** `config_change` 2 · `security` 4 · `license` 1 · `diagnostic` 8

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `THALES-ESECURITY-PAYSHIELD-MIB` | 15 |

### Sample decoded traps

- `THALES-ESECURITY-PAYSHIELD-MIB::payShieldPowerOnAlarm`
- `THALES-ESECURITY-PAYSHIELD-MIB::payShieldRestartAlarm`
