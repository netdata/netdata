<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/k2net_snmp_traps.md"
sidebar_label: "K2Net SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [k2net, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from K2Net devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/k2net-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/k2net-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="K2Net SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from K2Net devices with Netdata. The bundled K2Net trap profile decodes 33 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the K2Net enterprise OID space, and decodes the varbinds using the bundled K2Net trap profile. No per-trap configuration.
...
Traps from K2Net devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **33 trap definitions** from K2Net across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `err` 2 · `warning` 19 · `notice` 11

**By category:** `state_change` 6 · `config_change` 11 · `security` 1 · `diagnostic` 15
...
- `CFG-PLCY-MIB::sitaraCfgPlcyNotifnsPlcyUpdate`
- `CFG-PLCY-MIB::sitaraCfgPlcyNotifnsCbqdReStart`
