<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/bytesphere_llc_snmp_traps.md"
sidebar_label: "Bytesphere LLC SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [bytesphere-llc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Bytesphere LLC devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/bytesphere-llc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/bytesphere-llc-snmp-traps"
-->
...
# Bytesphere LLC SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Bytesphere LLC SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Bytesphere LLC devices with Netdata. The bundled Bytesphere LLC trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Bytesphere LLC enterprise OID space, and decodes the varbinds using the bundled Bytesphere LLC trap profile. No per-trap configuration.
...
Traps from Bytesphere LLC devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Bytesphere LLC across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
|:----|----:|
| `BYTESPHERE-EVENTLOG-MIB` | 1 |

### Sample decoded traps

- `BYTESPHERE-EVENTLOG-MIB::eventGenerated`
