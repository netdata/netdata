<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/altergy_systems_snmp_traps.md"
sidebar_label: "Altergy Systems SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [altergy-systems, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Altergy Systems devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/altergy-systems-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/altergy-systems-snmp-traps"
-->
...
# Altergy Systems SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Altergy Systems SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Altergy Systems devices with Netdata. The bundled Altergy Systems trap profile decodes 13 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Altergy Systems enterprise OID space, and decodes the varbinds using the bundled Altergy Systems trap profile. No per-trap configuration.
...
Traps from Altergy Systems devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **13 trap definitions** from Altergy Systems across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 5 · `notice` 7

**By category:** `state_change` 4 · `diagnostic` 9
...
- `ALT-DEV-MIB::altergyTrapStart`
- `ALT-DEV-MIB::altergyTrapStop`
