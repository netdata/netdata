<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/pacific_broadband_communications_snmp_traps.md"
sidebar_label: "Pacific Broadband Communications SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [pacific-broadband-communications, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Pacific Broadband Communications devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/pacific-broadband-communications-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/pacific-broadband-communications-snmp-traps"
-->
...
# Pacific Broadband Communications SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Pacific Broadband Communications SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Pacific Broadband Communications devices with Netdata. The bundled Pacific Broadband Communications trap profile decodes 11 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Pacific Broadband Communications enterprise OID space, and decodes the varbinds using the bundled Pacific Broadband Communications trap profile. No per-trap configuration.
...
Traps from Pacific Broadband Communications devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **11 trap definitions** from Pacific Broadband Communications across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 8 · `notice` 1 · `info` 1 · `debug` 1

**By category:** `state_change` 2 · `config_change` 1 · `diagnostic` 8
