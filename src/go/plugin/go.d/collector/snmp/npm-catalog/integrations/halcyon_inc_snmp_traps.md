<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/halcyon_inc_snmp_traps.md"
sidebar_label: "Halcyon Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [halcyon-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Halcyon Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/halcyon-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/halcyon-inc-snmp-traps"
-->
...
# Halcyon Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Halcyon Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Halcyon Inc devices with Netdata. The bundled Halcyon Inc trap profile decodes 7 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Halcyon Inc enterprise OID space, and decodes the varbinds using the bundled Halcyon Inc trap profile. No per-trap configuration.
...
Traps from Halcyon Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Halcyon Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 3 · `notice` 4

**By category:** `state_change` 3 · `diagnostic` 4

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `HALCYON-PRIMEALERT-MIB` | 7 |

### Sample decoded traps

- `HALCYON-PRIMEALERT-MIB::eventOpenTrap`
- `HALCYON-PRIMEALERT-MIB::eventCloseTrap`
