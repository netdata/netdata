<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/ligowave_snmp_traps.md"
sidebar_label: "Ligowave SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [ligowave, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Ligowave devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/ligowave-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/ligowave-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Ligowave SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Ligowave devices with Netdata. The bundled Ligowave trap profile decodes 23 trap definitions across 5 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Ligowave enterprise OID space, and decodes the varbinds using the bundled Ligowave trap profile. No per-trap configuration.
...
Traps from Ligowave devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **23 trap definitions** from Ligowave across **5 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 13 · `notice` 8 · `info` 1

**By category:** `state_change` 7 · `mobility` 5 · `diagnostic` 11
...
|:----|----:|
| `LIGO-WIRELESS-MIB` | 7 |
| `LIGO-802DOT11-EXT-MIB` | 5 |
| `LIGO-W-JET-MIB` | 5 |
| `LIGO-GENERIC-MIB` | 4 |
| `LIGO-RADIO3-DRV-MIB` | 2 |

### Sample decoded traps

- `LIGO-GENERIC-MIB::ligoPowerLoss`
- `LIGO-GENERIC-MIB::ligoAdministrativeReboot`
