<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/ups_manufacturing_snmp_traps.md"
sidebar_label: "Ups Manufacturing SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [ups-manufacturing, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Ups Manufacturing devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/ups-manufacturing-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/ups-manufacturing-snmp-traps"
-->
...
# Ups Manufacturing SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Ups Manufacturing SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Ups Manufacturing devices with Netdata. The bundled Ups Manufacturing trap profile decodes 24 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Ups Manufacturing enterprise OID space, and decodes the varbinds using the bundled Ups Manufacturing trap profile. No per-trap configuration.
...
Traps from Ups Manufacturing devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **24 trap definitions** from Ups Manufacturing across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 4 · `warning` 10 · `notice` 9 · `info` 1

**By category:** `state_change` 6 · `security` 1 · `diagnostic` 17
...
- `SENSORTRAP-MIB::sensorAlarmTMax`
- `SENSORTRAP-MIB::sensorAlarmTMaxRemoved`
