<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/sonicwall_inc_snmp_traps.md"
sidebar_label: "Sonicwall Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [sonicwall-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Sonicwall Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/sonicwall-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/sonicwall-inc-snmp-traps"
-->
...
# Sonicwall Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Sonicwall Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Sonicwall Inc devices with Netdata. The bundled Sonicwall Inc trap profile decodes 12 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Sonicwall Inc enterprise OID space, and decodes the varbinds using the bundled Sonicwall Inc trap profile. No per-trap configuration.
...
Traps from Sonicwall Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **12 trap definitions** from Sonicwall Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `crit` 3 · `warning` 4 · `notice` 2

**By category:** `state_change` 2 · `security` 5 · `diagnostic` 5

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SONICWALL-FIREWALL-TRAP-MIB` | 6 |
| `SONICWALL-GMS-TRAP-MIB` | 6 |

### Sample decoded traps

- `SONICWALL-FIREWALL-TRAP-MIB::swFwTrapAttack`
- `SONICWALL-FIREWALL-TRAP-MIB::swFwTrapSysError`
