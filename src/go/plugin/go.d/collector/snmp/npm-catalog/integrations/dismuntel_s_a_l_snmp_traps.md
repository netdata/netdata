<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/dismuntel_s_a_l_snmp_traps.md"
sidebar_label: "Dismuntel S A L SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [dismuntel-s-a-l, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Dismuntel S A L devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/dismuntel-s-a-l-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/dismuntel-s-a-l-snmp-traps"
-->
...
# Dismuntel S A L SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Dismuntel S A L SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Dismuntel S A L devices with Netdata. The bundled Dismuntel S A L trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Dismuntel S A L enterprise OID space, and decodes the varbinds using the bundled Dismuntel S A L trap profile. No per-trap configuration.
...
Traps from Dismuntel S A L devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Dismuntel S A L across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
