<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/f5_networks_inc_snmp_traps.md"
sidebar_label: "F5 Networks Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [f5-networks-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from F5 Networks Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/f5-networks-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/f5-networks-inc-snmp-traps"
-->
...
# F5 Networks Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="F5 Networks Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from F5 Networks Inc devices with Netdata. The bundled F5 Networks Inc trap profile decodes 45 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the F5 Networks Inc enterprise OID space, and decodes the varbinds using the bundled F5 Networks Inc trap profile. No per-trap configuration.
...
Traps from F5 Networks Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **45 trap definitions** from F5 Networks Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 16 · `warning` 27 · `notice` 2

**By category:** `state_change` 1 · `diagnostic` 44

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `F5OS-APPLIANCE-ALERT-NOTIF-MIB` | 45 |
