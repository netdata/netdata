<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/vpnet_snmp_traps.md"
sidebar_label: "Vpnet SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [vpnet, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Vpnet devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/vpnet-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/vpnet-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Vpnet SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Vpnet devices with Netdata. The bundled Vpnet trap profile decodes 7 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Vpnet enterprise OID space, and decodes the varbinds using the bundled Vpnet trap profile. No per-trap configuration.
...
Traps from Vpnet devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Vpnet across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 7

**By category:** `security` 4 · `auth` 1 · `diagnostic` 2
