<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/agfeo_gmbh_co_kg_snmp_traps.md"
sidebar_label: "Agfeo GmbH Co KG SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [agfeo-gmbh-co-kg, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Agfeo GmbH Co KG devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/agfeo-gmbh-co-kg-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/agfeo-gmbh-co-kg-snmp-traps"
-->
...
# Agfeo GmbH Co KG SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Agfeo GmbH Co KG SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Agfeo GmbH Co KG devices with Netdata. The bundled Agfeo GmbH Co KG trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Agfeo GmbH Co KG enterprise OID space, and decodes the varbinds using the bundled Agfeo GmbH Co KG trap profile. No per-trap configuration.
...
Traps from Agfeo GmbH Co KG devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Agfeo GmbH Co KG across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
