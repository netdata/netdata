<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/equallogic_snmp_traps.md"
sidebar_label: "Equallogic SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [equallogic, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Equallogic devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/equallogic-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/equallogic-snmp-traps"
-->
...
# Equallogic SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Equallogic SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Equallogic devices with Netdata. The bundled Equallogic trap profile decodes 26 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Equallogic enterprise OID space, and decodes the varbinds using the bundled Equallogic trap profile. No per-trap configuration.
...
Traps from Equallogic devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **26 trap definitions** from Equallogic across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `crit` 14 · `warning` 9

**By category:** `state_change` 1 · `diagnostic` 25
...
- `EQLMEMBER-MIB::eqlMemberHealthTempSensorHighThreshold`
- `EQLMEMBER-MIB::eqlMemberHealthTempSensorLowThreshold`
