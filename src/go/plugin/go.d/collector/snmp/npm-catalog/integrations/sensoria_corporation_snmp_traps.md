<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/sensoria_corporation_snmp_traps.md"
sidebar_label: "Sensoria Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [sensoria-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Sensoria Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/sensoria-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/sensoria-corporation-snmp-traps"
-->
...
# Sensoria Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Sensoria Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Sensoria Corporation devices with Netdata. The bundled Sensoria Corporation trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Sensoria Corporation enterprise OID space, and decodes the varbinds using the bundled Sensoria Corporation trap profile. No per-trap configuration.
...
Traps from Sensoria Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Sensoria Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `notice` 2

**By category:** `config_change` 2

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `TRANZEO-ENROUTE-MUNIWIFI-MIB` | 2 |
