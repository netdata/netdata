<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/bdt_gmbh_co_kg_snmp_traps.md"
sidebar_label: "Bdt GmbH Co KG SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [bdt-gmbh-co-kg, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Bdt GmbH Co KG devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/bdt-gmbh-co-kg-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/bdt-gmbh-co-kg-snmp-traps"
-->
...
# Bdt GmbH Co KG SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Bdt GmbH Co KG SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Bdt GmbH Co KG devices with Netdata. The bundled Bdt GmbH Co KG trap profile decodes 12 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Bdt GmbH Co KG enterprise OID space, and decodes the varbinds using the bundled Bdt GmbH Co KG trap profile. No per-trap configuration.
...
Traps from Bdt GmbH Co KG devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **12 trap definitions** from Bdt GmbH Co KG across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 1 · `err` 1 · `warning` 3 · `notice` 6
