<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cyan_snmp_traps.md"
sidebar_label: "Cyan SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cyan, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cyan devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cyan-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cyan-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cyan SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cyan devices with Netdata. The bundled Cyan trap profile decodes 84 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cyan enterprise OID space, and decodes the varbinds using the bundled Cyan trap profile. No per-trap configuration.
...
Traps from Cyan devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **84 trap definitions** from Cyan across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 26 · `warning` 56

**By category:** `state_change` 1 · `security` 1 · `diagnostic` 82
