<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/codan_limited_snmp_traps.md"
sidebar_label: "Codan Limited SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [codan-limited, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Codan Limited devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/codan-limited-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/codan-limited-snmp-traps"
-->
...
# Codan Limited SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Codan Limited SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Codan Limited devices with Netdata. The bundled Codan Limited trap profile decodes 55 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Codan Limited enterprise OID space, and decodes the varbinds using the bundled Codan Limited trap profile. No per-trap configuration.
...
Traps from Codan Limited devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **55 trap definitions** from Codan Limited across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 5 · `crit` 4 · `err` 1 · `warning` 29 · `notice` 15 · `info` 1

**By category:** `state_change` 19 · `config_change` 1 · `security` 2 · `diagnostic` 33
...
- `CODAN-MIB::wvIduOduCableFaultStart`
- `CODAN-MIB::wvIduOduCableFaultStop`
