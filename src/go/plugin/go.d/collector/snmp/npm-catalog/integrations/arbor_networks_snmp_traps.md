<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/arbor_networks_snmp_traps.md"
sidebar_label: "Arbor Networks SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [arbor-networks, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Arbor Networks devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/arbor-networks-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/arbor-networks-snmp-traps"
-->
...
# Arbor Networks SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Arbor Networks SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Arbor Networks devices with Netdata. The bundled Arbor Networks trap profile decodes 123 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Arbor Networks enterprise OID space, and decodes the varbinds using the bundled Arbor Networks trap profile. No per-trap configuration.
...
Traps from Arbor Networks devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **123 trap definitions** from Arbor Networks across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 21 · `crit` 13 · `warning` 36 · `notice` 50 · `info` 3

**By category:** `state_change` 53 · `config_change` 5 · `security` 27 · `license` 2 · `diagnostic` 36
...
- `PEAKFLOW-DOS-MIB::bandwidthAnomaly`
- `PEAKFLOW-DOS-MIB::tcpflagsAnomaly`
