<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/vmware_inc_snmp_traps.md"
sidebar_label: "Vmware Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [vmware-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Vmware Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/vmware-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/vmware-inc-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/vmware.svg" width="150" alt="Vmware Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Vmware Inc devices with Netdata. The bundled Vmware Inc trap profile decodes 1445 trap definitions across 14 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Vmware Inc enterprise OID space, and decodes the varbinds using the bundled Vmware Inc trap profile. No per-trap configuration.
...
Traps from Vmware Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1445 trap definitions** from Vmware Inc across **14 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 87 · `crit` 197 · `err` 34 · `warning` 620 · `notice` 499 · `info` 8

**By category:** `state_change` 505 · `config_change` 57 · `security` 54 · `auth` 9 · `license` 9 · `diagnostic` 811
...
| `VMWARE-NSX-MIB` | 608 |
| `VMWARE-VRNI-MIB` | 416 |
| `VMWARE-NSX-MANAGER-MIB` | 294 |
| `VMWARE-VCOPS-EVENT-MIB` | 55 |
| `VMWARE-ENV-MIB` | 20 |
| `VMWARE-SRM-EVENT-MIB` | 16 |
| `VMWARE-VCHA-MIB` | 15 |
| `VMWARE-OBSOLETE-MIB` | 6 |
| `VMWARE-VMINFO-MIB` | 5 |
| `VMWARE-VROPS-MIB` | 4 |
| `VMWARE-VC-EVENT-MIB` | 3 |
| `VMWARE-CIMOM-MIB` | 1 |
| `VMWARE-HEARTBEAT-MIB` | 1 |
| `VMWARE-TRAPS-MIB` | 1 |
