<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/linksys_snmp_traps.md"
sidebar_label: "Linksys SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [linksys, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Linksys devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/linksys-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/linksys-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Linksys SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Linksys devices with Netdata. The bundled Linksys trap profile decodes 20 trap definitions across 5 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Linksys enterprise OID space, and decodes the varbinds using the bundled Linksys trap profile. No per-trap configuration.
...
Traps from Linksys devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **20 trap definitions** from Linksys across **5 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `warning` 10 · `notice` 3 · `info` 4

**By category:** `state_change` 8 · `config_change` 4 · `security` 2 · `diagnostic` 6

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `LINKSYS-Physicaldescription-MIB` | 7 |
| `LINKSYS-COPY-MIB` | 5 |
| `LINKSYS-rlBrgMulticast-MIB` | 3 |
| `LINKSYS-WLAN-ACCESS-POINT-MIB` | 3 |
| `LINKSYS-LLDP-MIB` | 2 |

### Sample decoded traps

- `LINKSYS-rlBrgMulticast-MIB::rlMacMulticastUnregFilterFailed`
- `LINKSYS-COPY-MIB::rlCopyFinished`
