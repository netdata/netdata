<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/oneaccess_snmp_traps.md"
sidebar_label: "Oneaccess SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [oneaccess, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Oneaccess devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/oneaccess-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/oneaccess-snmp-traps"
-->
...
# Oneaccess SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Oneaccess SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Oneaccess devices with Netdata. The bundled Oneaccess trap profile decodes 38 trap definitions across 11 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Oneaccess enterprise OID space, and decodes the varbinds using the bundled Oneaccess trap profile. No per-trap configuration.
...
Traps from Oneaccess devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **38 trap definitions** from Oneaccess across **11 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 3 · `warning` 20 · `notice` 15

**By category:** `state_change` 20 · `config_change` 1 · `security` 9 · `diagnostic` 8

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `ONEACCESS-IPSEC-MIB` | 17 |
| `ONEACCESS-ACL-MIB` | 6 |
| `OneAccess-RoundTripTime-MIB` | 3 |
| `ONEACCESS-ISDN-MIB` | 2 |
| `ONEACCESS-NAT-MIB` | 2 |
| `ONEACCESS-PSTN-MIB` | 2 |
| `ONEACCESS-UPS-MIB` | 2 |
| `ONEACCESS-CONFIGMGMT-MIB` | 1 |
| `ONEACCESS-EVENTS-MIB` | 1 |
| `ONEACCESS-SHDSL-MIB` | 1 |
| `ONEACCESS-VRRP-MIB` | 1 |

### Sample decoded traps

- `ONEACCESS-EVENTS-MIB::oacEvent`
- `ONEACCESS-NAT-MIB::oacNatNotificationMaximumSessionReached`
