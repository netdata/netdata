<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/stratus_computer_snmp_traps.md"
sidebar_label: "Stratus Computer SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [stratus-computer, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Stratus Computer devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/stratus-computer-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/stratus-computer-snmp-traps"
-->
...
# Stratus Computer SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Stratus Computer SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Stratus Computer devices with Netdata. The bundled Stratus Computer trap profile decodes 15 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Stratus Computer enterprise OID space, and decodes the varbinds using the bundled Stratus Computer trap profile. No per-trap configuration.
...
Traps from Stratus Computer devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **15 trap definitions** from Stratus Computer across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 6 · `warning` 5 · `notice` 4

**By category:** `state_change` 5 · `diagnostic` 10
...
- `STRATUS-MIB::ftsmTrapEnterBrokenState`
- `STRATUS-MIB::ftsmTrapLeaveBrokenState`
