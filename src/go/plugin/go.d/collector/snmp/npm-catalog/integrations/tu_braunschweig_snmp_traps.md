<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/tu_braunschweig_snmp_traps.md"
sidebar_label: "Tu Braunschweig SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [tu-braunschweig, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Tu Braunschweig devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/tu-braunschweig-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/tu-braunschweig-snmp-traps"
-->
...
# Tu Braunschweig SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Tu Braunschweig SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Tu Braunschweig devices with Netdata. The bundled Tu Braunschweig trap profile decodes 2 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Tu Braunschweig enterprise OID space, and decodes the varbinds using the bundled Tu Braunschweig trap profile. No per-trap configuration.
...
Traps from Tu Braunschweig devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Tu Braunschweig across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 1 · `info` 1
...
|:----|----:|
| `TUBS-IBR-LINUX-NETFILTER-MIB` | 1 |
| `TUBS-IBR-PING-MIB` | 1 |
