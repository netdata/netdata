<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/image_project_inc_snmp_traps.md"
sidebar_label: "Image Project Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [image-project-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Image Project Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/image-project-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/image-project-inc-snmp-traps"
-->
...
# Image Project Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Image Project Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Image Project Inc devices with Netdata. The bundled Image Project Inc trap profile decodes 9 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Image Project Inc enterprise OID space, and decodes the varbinds using the bundled Image Project Inc trap profile. No per-trap configuration.
...
Traps from Image Project Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **9 trap definitions** from Image Project Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 7 · `notice` 2
...
|:----|----:|
| `WEBSITEPULSE-NOTIFY-MIB` | 9 |

### Sample decoded traps

- `WEBSITEPULSE-NOTIFY-MIB::webSitePulseConnectionFailure`
- `WEBSITEPULSE-NOTIFY-MIB::webSitePulseContentFailure`
