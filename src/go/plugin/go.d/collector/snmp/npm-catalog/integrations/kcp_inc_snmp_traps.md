<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/kcp_inc_snmp_traps.md"
sidebar_label: "Kcp Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [kcp-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Kcp Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/kcp-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/kcp-inc-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Kcp Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Kcp Inc devices with Netdata. The bundled Kcp Inc trap profile decodes 291 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Kcp Inc enterprise OID space, and decodes the varbinds using the bundled Kcp Inc trap profile. No per-trap configuration.
...
Traps from Kcp Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **291 trap definitions** from Kcp Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 2 · `warning` 285 · `notice` 2 · `info` 1

**By category:** `diagnostic` 291
...
- `HHMSAGENT-MIB::hhmsUnknownStatus`
- `HHMSAGENT-MIB::hhmsNormalStatus`
