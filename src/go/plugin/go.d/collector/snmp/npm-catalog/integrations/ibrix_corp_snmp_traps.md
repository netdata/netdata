<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/ibrix_corp_snmp_traps.md"
sidebar_label: "Ibrix Corp SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [ibrix-corp, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Ibrix Corp devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/ibrix-corp-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/ibrix-corp-snmp-traps"
-->
...
# Ibrix Corp SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Ibrix Corp SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Ibrix Corp devices with Netdata. The bundled Ibrix Corp trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Ibrix Corp enterprise OID space, and decodes the varbinds using the bundled Ibrix Corp trap profile. No per-trap configuration.
...
Traps from Ibrix Corp devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Ibrix Corp across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
