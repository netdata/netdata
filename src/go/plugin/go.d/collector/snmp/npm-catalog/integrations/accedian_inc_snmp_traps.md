<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/accedian_inc_snmp_traps.md"
sidebar_label: "Accedian Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [accedian-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Accedian Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/accedian-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/accedian-inc-snmp-traps"
-->
...
# Accedian Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Accedian Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Accedian Inc devices with Netdata. The bundled Accedian Inc trap profile decodes 3 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Accedian Inc enterprise OID space, and decodes the varbinds using the bundled Accedian Inc trap profile. No per-trap configuration.
...
Traps from Accedian Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **3 trap definitions** from Accedian Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
