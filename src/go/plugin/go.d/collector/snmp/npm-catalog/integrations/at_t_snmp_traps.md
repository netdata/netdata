<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/at_t_snmp_traps.md"
sidebar_label: "At T SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [at-t, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from At T devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/at-t-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/at-t-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="At T SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from At T devices with Netdata. The bundled At T trap profile decodes 29 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the At T enterprise OID space, and decodes the varbinds using the bundled At T trap profile. No per-trap configuration.
...
Traps from At T devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **29 trap definitions** from At T across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 4 · `crit` 2 · `err` 1 · `warning` 11 · `notice` 9 · `info` 1 · `debug` 1

**By category:** `state_change` 14 · `config_change` 1 · `security` 2 · `auth` 3 · `diagnostic` 9
...
|:----|----:|
| `ATT-NETGATE-MIB` | 20 |
| `ATT-VPN-GATEWAY-MIB` | 9 |

### Sample decoded traps

- `ATT-NETGATE-MIB::ngevIpConntrackTable`
- `ATT-NETGATE-MIB::ngevIpConntrackTableFull`
