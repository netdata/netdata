<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/exanet_snmp_traps.md"
sidebar_label: "Exanet SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [exanet, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Exanet devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/exanet-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/exanet-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Exanet SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Exanet devices with Netdata. The bundled Exanet trap profile decodes 14 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Exanet enterprise OID space, and decodes the varbinds using the bundled Exanet trap profile. No per-trap configuration.
...
Traps from Exanet devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **14 trap definitions** from Exanet across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 5 · `warning` 3 · `notice` 3 · `info` 1

**By category:** `state_change` 6 · `security` 1 · `diagnostic` 7

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `CentricStorFS-MIB` | 14 |

### Sample decoded traps

- `CentricStorFS-MIB::centricStorFSCluOK`
- `CentricStorFS-MIB::centricStorFSCluDegraded`
