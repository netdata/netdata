<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nxnetworks_snmp_traps.md"
sidebar_label: "Nxnetworks SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [nxnetworks, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Nxnetworks devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/nxnetworks-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/nxnetworks-snmp-traps"
-->
...
# Nxnetworks SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Nxnetworks SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Nxnetworks devices with Netdata. The bundled Nxnetworks trap profile decodes 4 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Nxnetworks enterprise OID space, and decodes the varbinds using the bundled Nxnetworks trap profile. No per-trap configuration.
...
Traps from Nxnetworks devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from Nxnetworks across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 2 · `notice` 2

**By category:** `security` 1 · `diagnostic` 3
...
|:----|----:|
| `PROTEON-MIB` | 2 |
| `CHANNEL-CHANGE-MIB` | 1 |
| `DECserver-Accounting-MIB` | 1 |

### Sample decoded traps

- `PROTEON-MIB::proElsTrapV1`
