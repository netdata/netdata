<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/netline_snmp_traps.md"
sidebar_label: "Netline SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [netline, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Netline devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/netline-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/netline-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Netline SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Netline devices with Netdata. The bundled Netline trap profile decodes 10 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Netline enterprise OID space, and decodes the varbinds using the bundled Netline trap profile. No per-trap configuration.
...
Traps from Netline devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Netline across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 6 · `notice` 4

**By category:** `state_change` 5 · `security` 3 · `auth` 1 · `diagnostic` 1
...
- `Cxr-connect-MIB::coldStart`
- `Cxr-connect-MIB::linkDown`
