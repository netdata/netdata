<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/deltanet_ag_snmp_traps.md"
sidebar_label: "Deltanet AG SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [deltanet-ag, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Deltanet AG devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/deltanet-ag-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/deltanet-ag-snmp-traps"
-->
...
# Deltanet AG SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Deltanet AG SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Deltanet AG devices with Netdata. The bundled Deltanet AG trap profile decodes 44 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Deltanet AG enterprise OID space, and decodes the varbinds using the bundled Deltanet AG trap profile. No per-trap configuration.
...
Traps from Deltanet AG devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **44 trap definitions** from Deltanet AG across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 5 · `warning` 20 · `notice` 18 · `info` 1

**By category:** `state_change` 18 · `security` 1 · `auth` 1 · `diagnostic` 24

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `Lambdatrail2s-MIB` | 44 |
