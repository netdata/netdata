<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/ieee_802_snmp_traps.md"
sidebar_label: "Ieee 802 SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [ieee-802, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Ieee 802 devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/ieee-802-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/ieee-802-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Ieee 802 SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Ieee 802 devices with Netdata. The bundled Ieee 802 trap profile decodes 9 trap definitions across 7 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Ieee 802 enterprise OID space, and decodes the varbinds using the bundled Ieee 802 trap profile. No per-trap configuration.
...
Traps from Ieee 802 devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **9 trap definitions** from Ieee 802 across **7 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 5 · `notice` 3

**By category:** `state_change` 5 · `diagnostic` 4

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `IEEE8021-SPANNING-TREE-MIB` | 2 |
| `IEEE8023-MAU-MIB` | 2 |
| `IEEE8021-CFM-MIB` | 1 |
| `IEEE8021-PBBTE-MIB` | 1 |
| `IEEE8021-TEIPS-MIB` | 1 |
| `IEEE8021-TEIPS-V2-MIB` | 1 |
| `LLDP-V2-MIB` | 1 |
