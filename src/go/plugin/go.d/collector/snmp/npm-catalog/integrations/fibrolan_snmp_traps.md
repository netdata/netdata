<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/fibrolan_snmp_traps.md"
sidebar_label: "Fibrolan SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [fibrolan, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Fibrolan devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/fibrolan-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/fibrolan-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Fibrolan SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Fibrolan devices with Netdata. The bundled Fibrolan trap profile decodes 129 trap definitions across 6 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Fibrolan enterprise OID space, and decodes the varbinds using the bundled Fibrolan trap profile. No per-trap configuration.
...
Traps from Fibrolan devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **129 trap definitions** from Fibrolan across **6 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 1 · `alert` 2 · `crit` 20 · `warning` 55 · `notice` 51

**By category:** `state_change` 62 · `config_change` 4 · `security` 1 · `diagnostic` 62

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `FIBROLAN-MIB-MS-TRAPS` | 109 |
| `FIBROLAN-SYNC-CENTER-MIB` | 7 |
| `FIBROLAN-DEVICE-MIB` | 6 |
| `FIBROLAN-SFP-MIB` | 3 |
| `FIBROLAN-ATOMIC-CLOCK-MIB` | 2 |
| `FIBROLAN-GPS-MIB` | 2 |

### Sample decoded traps

- `FIBROLAN-MIB-MS-TRAPS::moduleInstalled`
- `FIBROLAN-MIB-MS-TRAPS::moduleRemoved`
