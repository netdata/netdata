<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/oracle_snmp_traps.md"
sidebar_label: "Oracle SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [oracle, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Oracle devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/oracle-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/oracle-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Oracle SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Oracle devices with Netdata. The bundled Oracle trap profile decodes 7 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Oracle enterprise OID space, and decodes the varbinds using the bundled Oracle trap profile. No per-trap configuration.
...
Traps from Oracle devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Oracle across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 5 · `notice` 2
...
|:----|----:|
| `ORACLE-ENTERPRISE-MANAGER-4-MIB` | 3 |
| `ORAINTERCHANGE-MIB` | 2 |
| `ORACLE-AGENT-MIB` | 1 |
| `ORALISTENER-MIB` | 1 |

### Sample decoded traps

- `ORALISTENER-MIB::oraListenerStateChange`
- `ORAINTERCHANGE-MIB::oraNavigatorStateChange`
