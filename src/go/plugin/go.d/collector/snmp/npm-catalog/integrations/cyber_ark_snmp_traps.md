<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cyber_ark_snmp_traps.md"
sidebar_label: "Cyber Ark SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cyber-ark, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cyber Ark devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cyber-ark-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cyber-ark-snmp-traps"
-->
...
# Cyber Ark SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cyber Ark SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cyber Ark devices with Netdata. The bundled Cyber Ark trap profile decodes 16 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cyber Ark enterprise OID space, and decodes the varbinds using the bundled Cyber Ark trap profile. No per-trap configuration.
...
Traps from Cyber Ark devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **16 trap definitions** from Cyber Ark across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 6 · `notice` 3 · `info` 7

**By category:** `state_change` 4 · `diagnostic` 12
...
- `CYBER-ARK-MIB::osEventLogInfoNotification`
- `CYBER-ARK-MIB::osCpuUsageNotification`
