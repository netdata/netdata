<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/sap_ag_snmp_traps.md"
sidebar_label: "Sap AG SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [sap-ag, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Sap AG devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/sap-ag-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/sap-ag-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Sap AG SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Sap AG devices with Netdata. The bundled Sap AG trap profile decodes 84 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Sap AG enterprise OID space, and decodes the varbinds using the bundled Sap AG trap profile. No per-trap configuration.
...
Traps from Sap AG devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **84 trap definitions** from Sap AG across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 26 · `warning` 46 · `notice` 10 · `info` 1

**By category:** `state_change` 2 · `diagnostic` 82
...
- `SAP-MIB::r3trapInstanceStartUp`
- `SAP-MIB::r3trapInstanceShutDown`
