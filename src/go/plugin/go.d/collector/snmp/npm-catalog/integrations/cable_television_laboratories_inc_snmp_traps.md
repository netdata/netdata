<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cable_television_laboratories_inc_snmp_traps.md"
sidebar_label: "Cable Television Laboratories Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cable-television-laboratories-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cable Television Laboratories Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cable-television-laboratories-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cable-television-laboratories-inc-snmp-traps"
-->
...
# Cable Television Laboratories Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cable Television Laboratories Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cable Television Laboratories Inc devices with Netdata. The bundled Cable Television Laboratories Inc trap profile decodes 34 trap definitions across 8 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cable Television Laboratories Inc enterprise OID space, and decodes the varbinds using the bundled Cable Television Laboratories Inc trap profile. No per-trap configuration.
...
Traps from Cable Television Laboratories Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **34 trap definitions** from Cable Television Laboratories Inc across **8 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `err` 3 · `warning` 18 · `notice` 10

**By category:** `state_change` 6 · `config_change` 6 · `security` 1 · `diagnostic` 21
