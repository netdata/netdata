<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/telesend_inc_snmp_traps.md"
sidebar_label: "Telesend Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [telesend-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Telesend Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/telesend-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/telesend-inc-snmp-traps"
-->
...
# Telesend Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Telesend Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Telesend Inc devices with Netdata. The bundled Telesend Inc trap profile decodes 5 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Telesend Inc enterprise OID space, and decodes the varbinds using the bundled Telesend Inc trap profile. No per-trap configuration.
...
Traps from Telesend Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Telesend Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `err` 1 · `warning` 2 · `notice` 2

**By category:** `state_change` 3 · `diagnostic` 2
...
- `Cisco90Series-MIB::frxDownloadTrap`
- `Cisco90Series-MIB::frxUPerfTrap`
