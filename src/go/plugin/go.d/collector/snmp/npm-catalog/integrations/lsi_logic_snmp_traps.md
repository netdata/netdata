<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/lsi_logic_snmp_traps.md"
sidebar_label: "Lsi Logic SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [lsi-logic, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Lsi Logic devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/lsi-logic-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/lsi-logic-snmp-traps"
-->
...
# Lsi Logic SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Lsi Logic SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Lsi Logic devices with Netdata. The bundled Lsi Logic trap profile decodes 271 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Lsi Logic enterprise OID space, and decodes the varbinds using the bundled Lsi Logic trap profile. No per-trap configuration.
...
Traps from Lsi Logic devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **271 trap definitions** from Lsi Logic across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 13 · `crit` 47 · `err` 12 · `warning` 60 · `notice` 125 · `info` 14

**By category:** `state_change` 31 · `config_change` 13 · `security` 9 · `diagnostic` 218

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `LSI-MegaRAID-SAS-MIB` | 161 |
| `LSI-megaRAID-SAS-IR-MIB` | 103 |
| `Adapter-1030-MIB` | 7 |

### Sample decoded traps

- `Adapter-1030-MIB::rtConfigUpdated`
- `Adapter-1030-MIB::rtPhysicalDriveStateChange`
