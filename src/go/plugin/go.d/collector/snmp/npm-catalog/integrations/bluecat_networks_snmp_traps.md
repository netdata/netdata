<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/bluecat_networks_snmp_traps.md"
sidebar_label: "Bluecat Networks SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [bluecat-networks, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Bluecat Networks devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/bluecat-networks-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/bluecat-networks-snmp-traps"
-->
...
# Bluecat Networks SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Bluecat Networks SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Bluecat Networks devices with Netdata. The bundled Bluecat Networks trap profile decodes 18 trap definitions across 9 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Bluecat Networks enterprise OID space, and decodes the varbinds using the bundled Bluecat Networks trap profile. No per-trap configuration.
...
Traps from Bluecat Networks devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **18 trap definitions** from Bluecat Networks across **9 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 5 · `crit` 2 · `err` 1 · `warning` 8 · `notice` 2

**By category:** `state_change` 6 · `license` 1 · `diagnostic` 11
