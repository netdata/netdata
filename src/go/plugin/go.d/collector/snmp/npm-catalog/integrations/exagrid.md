...
description: "Monitor Exagrid (storage) with Netdata over SNMP. Netdata recognizes the device automatically by its sysObjectID (recognized across 1 device identifiers) and…"
