<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/tylink_snmp_traps.md"
sidebar_label: "Tylink SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [tylink, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Tylink devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/tylink-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/tylink-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Tylink SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Tylink devices with Netdata. The bundled Tylink trap profile decodes 50 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Tylink enterprise OID space, and decodes the varbinds using the bundled Tylink trap profile. No per-trap configuration.
...
Traps from Tylink devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **50 trap definitions** from Tylink across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `crit` 2 · `err` 4 · `warning` 16 · `notice` 25

**By category:** `state_change` 14 · `config_change` 3 · `auth` 1 · `diagnostic` 32
...
- `TY1250I-MIB::ty1250Trap`
- `TY1250I-MIB::ty1250LineFailureTrap`
