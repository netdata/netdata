<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/schechtertech_llc_snmp_traps.md"
sidebar_label: "Schechtertech LLC SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [schechtertech-llc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Schechtertech LLC devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/schechtertech-llc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/schechtertech-llc-snmp-traps"
-->
...
# Schechtertech LLC SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Schechtertech LLC SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Schechtertech LLC devices with Netdata. The bundled Schechtertech LLC trap profile decodes 4 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Schechtertech LLC enterprise OID space, and decodes the varbinds using the bundled Schechtertech LLC trap profile. No per-trap configuration.
...
Traps from Schechtertech LLC devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from Schechtertech LLC across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 3
...
|:----|----:|
| `TEMPERATUREALERT-MIB` | 4 |

### Sample decoded traps

- `TEMPERATUREALERT-MIB::taNormal`
