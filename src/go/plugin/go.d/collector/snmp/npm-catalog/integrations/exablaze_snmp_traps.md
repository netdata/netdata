<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/exablaze_snmp_traps.md"
sidebar_label: "Exablaze SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [exablaze, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Exablaze devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/exablaze-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/exablaze-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Exablaze SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Exablaze devices with Netdata. The bundled Exablaze trap profile decodes 9 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Exablaze enterprise OID space, and decodes the varbinds using the bundled Exablaze trap profile. No per-trap configuration.
...
Traps from Exablaze devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **9 trap definitions** from Exablaze across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 5 · `notice` 3

**By category:** `state_change` 2 · `config_change` 1 · `security` 1 · `diagnostic` 5

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `EXALINK-FUSION-MIB` | 9 |

### Sample decoded traps

- `EXALINK-FUSION-MIB::fusionPowerFail`
- `EXALINK-FUSION-MIB::fusionTamperAlert`
