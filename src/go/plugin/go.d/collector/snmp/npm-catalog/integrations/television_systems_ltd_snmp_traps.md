<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/television_systems_ltd_snmp_traps.md"
sidebar_label: "Television Systems Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [television-systems-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Television Systems Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/television-systems-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/television-systems-ltd-snmp-traps"
-->
...
# Television Systems Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Television Systems Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Television Systems Ltd devices with Netdata. The bundled Television Systems Ltd trap profile decodes 6 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Television Systems Ltd enterprise OID space, and decodes the varbinds using the bundled Television Systems Ltd trap profile. No per-trap configuration.
...
Traps from Television Systems Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **6 trap definitions** from Television Systems Ltd across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 5 · `notice` 1

**By category:** `state_change` 2 · `diagnostic` 4
