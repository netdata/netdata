<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/smartoptics_as_snmp_traps.md"
sidebar_label: "Smartoptics AS SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [smartoptics-as, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Smartoptics AS devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/smartoptics-as-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/smartoptics-as-snmp-traps"
-->
...
# Smartoptics AS SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Smartoptics AS SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Smartoptics AS devices with Netdata. The bundled Smartoptics AS trap profile decodes 10 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Smartoptics AS enterprise OID space, and decodes the varbinds using the bundled Smartoptics AS trap profile. No per-trap configuration.
...
Traps from Smartoptics AS devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Smartoptics AS across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 4 · `warning` 4 · `notice` 2
