<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/axis_communications_ab_snmp_traps.md"
sidebar_label: "Axis Communications AB SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [axis-communications-ab, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Axis Communications AB devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/axis-communications-ab-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/axis-communications-ab-snmp-traps"
-->
...
# Axis Communications AB SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Axis Communications AB SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Axis Communications AB devices with Netdata. The bundled Axis Communications AB trap profile decodes 3 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Axis Communications AB enterprise OID space, and decodes the varbinds using the bundled Axis Communications AB trap profile. No per-trap configuration.
...
Traps from Axis Communications AB devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **3 trap definitions** from Axis Communications AB across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
