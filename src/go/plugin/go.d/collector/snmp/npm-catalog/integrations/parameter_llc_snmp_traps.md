<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/parameter_llc_snmp_traps.md"
sidebar_label: "Parameter LLC SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [parameter-llc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Parameter LLC devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/parameter-llc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/parameter-llc-snmp-traps"
-->
...
# Parameter LLC SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Parameter LLC SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Parameter LLC devices with Netdata. The bundled Parameter LLC trap profile decodes 287 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Parameter LLC enterprise OID space, and decodes the varbinds using the bundled Parameter LLC trap profile. No per-trap configuration.
...
Traps from Parameter LLC devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **287 trap definitions** from Parameter LLC across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 6 · `crit` 1 · `warning` 139 · `notice` 141

**By category:** `state_change` 20 · `config_change` 1 · `security` 4 · `diagnostic` 262

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `RLE-FALCON-EM-MIB` | 281 |
| `RLE-FALCON-MIB` | 4 |
| `RLE-FDSPC-MIB` | 2 |

### Sample decoded traps

- `RLE-FALCON-MIB::falconAlarmEntryAdded`
- `RLE-FALCON-MIB::falconAlarmEntryRemoved`
