<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/elfiq_inc_snmp_traps.md"
sidebar_label: "Elfiq Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [elfiq-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Elfiq Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/elfiq-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/elfiq-inc-snmp-traps"
-->
...
# Elfiq Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Elfiq Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Elfiq Inc devices with Netdata. The bundled Elfiq Inc trap profile decodes 10 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Elfiq Inc enterprise OID space, and decodes the varbinds using the bundled Elfiq Inc trap profile. No per-trap configuration.
...
Traps from Elfiq Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Elfiq Inc across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 7 · `notice` 2

**By category:** `state_change` 3 · `diagnostic` 7

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `ELFIQ-MODULE-LB-MIB` | 5 |
| `ELFIQ-MODULE-COMMON-MIB` | 4 |
| `ELFIQ-MODULE-FOVE-MIB` | 1 |
