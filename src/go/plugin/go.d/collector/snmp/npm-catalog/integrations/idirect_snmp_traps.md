<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/idirect_snmp_traps.md"
sidebar_label: "Idirect SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [idirect, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Idirect devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/idirect-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/idirect-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Idirect SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Idirect devices with Netdata. The bundled Idirect trap profile decodes 41 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Idirect enterprise OID space, and decodes the varbinds using the bundled Idirect trap profile. No per-trap configuration.
...
Traps from Idirect devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **41 trap definitions** from Idirect across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 9 · `warning` 29 · `notice` 1

**By category:** `state_change` 3 · `diagnostic` 38

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `IDIRECT-REMOTE-MIB` | 41 |
