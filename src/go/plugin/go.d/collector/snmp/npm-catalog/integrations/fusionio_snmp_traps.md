<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/fusionio_snmp_traps.md"
sidebar_label: "Fusionio SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [fusionio, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Fusionio devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/fusionio-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/fusionio-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Fusionio SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Fusionio devices with Netdata. The bundled Fusionio trap profile decodes 19 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Fusionio enterprise OID space, and decodes the varbinds using the bundled Fusionio trap profile. No per-trap configuration.
...
Traps from Fusionio devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **19 trap definitions** from Fusionio across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 4 · `warning` 11 · `notice` 2

**By category:** `diagnostic` 19

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `FUSIONIO-IODIMM-MIB` | 19 |

### Sample decoded traps

- `FUSIONIO-IODIMM-MIB::fusionIoDimmWearoutTrap`
- `FUSIONIO-IODIMM-MIB::fusionIoDimmNonWritableTrap`
