<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/telco_systems_nac_snmp_traps.md"
sidebar_label: "Telco Systems Nac SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [telco-systems-nac, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Telco Systems Nac devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/telco-systems-nac-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/telco-systems-nac-snmp-traps"
-->
...
# Telco Systems Nac SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Telco Systems Nac SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Telco Systems Nac devices with Netdata. The bundled Telco Systems Nac trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Telco Systems Nac enterprise OID space, and decodes the varbinds using the bundled Telco Systems Nac trap profile. No per-trap configuration.
...
Traps from Telco Systems Nac devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Telco Systems Nac across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
