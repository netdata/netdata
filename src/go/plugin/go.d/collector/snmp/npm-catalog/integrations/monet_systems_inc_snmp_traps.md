<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/monet_systems_inc_snmp_traps.md"
sidebar_label: "Monet Systems Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [monet-systems-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Monet Systems Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/monet-systems-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/monet-systems-inc-snmp-traps"
-->
...
# Monet Systems Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Monet Systems Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Monet Systems Inc devices with Netdata. The bundled Monet Systems Inc trap profile decodes 30 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Monet Systems Inc enterprise OID space, and decodes the varbinds using the bundled Monet Systems Inc trap profile. No per-trap configuration.
...
Traps from Monet Systems Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **30 trap definitions** from Monet Systems Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 13 · `notice` 16

**By category:** `state_change` 17 · `config_change` 1 · `security` 5 · `diagnostic` 7
...
- `TWTRAP-MIB::rptr-Reset`
- `TWTRAP-MIB::rptr-FReset1`
