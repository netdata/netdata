<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/lanex_sp_z_o_o_snmp_traps.md"
sidebar_label: "Lanex Sp Z O O SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [lanex-sp-z-o-o, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Lanex Sp Z O O devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/lanex-sp-z-o-o-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/lanex-sp-z-o-o-snmp-traps"
-->
...
# Lanex Sp Z O O SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Lanex Sp Z O O SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Lanex Sp Z O O devices with Netdata. The bundled Lanex Sp Z O O trap profile decodes 14 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Lanex Sp Z O O enterprise OID space, and decodes the varbinds using the bundled Lanex Sp Z O O trap profile. No per-trap configuration.
...
Traps from Lanex Sp Z O O devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **14 trap definitions** from Lanex Sp Z O O across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 6 · `warning` 2 · `notice` 6

**By category:** `config_change` 2 · `diagnostic` 12
...
- `TM62-MIB::trapOptiLine4ALPActive`
- `TM62-MIB::trapOptiLine4ALNActive`
