<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/accuenergy_canada_inc_snmp_traps.md"
sidebar_label: "Accuenergy Canada Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [accuenergy-canada-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Accuenergy Canada Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/accuenergy-canada-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/accuenergy-canada-inc-snmp-traps"
-->
...
# Accuenergy Canada Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Accuenergy Canada Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Accuenergy Canada Inc devices with Netdata. The bundled Accuenergy Canada Inc trap profile decodes 14 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Accuenergy Canada Inc enterprise OID space, and decodes the varbinds using the bundled Accuenergy Canada Inc trap profile. No per-trap configuration.
...
Traps from Accuenergy Canada Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **14 trap definitions** from Accuenergy Canada Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `notice` 14

**By category:** `state_change` 14
...
- `ACCUENERGY-MIB::io11DI1StatusChanged`
- `ACCUENERGY-MIB::io11DI2StatusChanged`
