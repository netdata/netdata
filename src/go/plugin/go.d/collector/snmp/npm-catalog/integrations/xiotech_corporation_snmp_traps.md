<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/xiotech_corporation_snmp_traps.md"
sidebar_label: "Xiotech Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [xiotech-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Xiotech Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/xiotech-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/xiotech-corporation-snmp-traps"
-->
...
# Xiotech Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Xiotech Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Xiotech Corporation devices with Netdata. The bundled Xiotech Corporation trap profile decodes 5 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Xiotech Corporation enterprise OID space, and decodes the varbinds using the bundled Xiotech Corporation trap profile. No per-trap configuration.
...
Traps from Xiotech Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Xiotech Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 2 · `warning` 2 · `info` 1
...
- `XIO-HUB-MIB::xioHubUnknownEvent`
- `XIO-HUB-MIB::xioHubInfoEvent`
