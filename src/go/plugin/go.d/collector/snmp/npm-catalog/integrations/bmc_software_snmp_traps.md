<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/bmc_software_snmp_traps.md"
sidebar_label: "Bmc Software SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [bmc-software, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Bmc Software devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/bmc-software-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/bmc-software-snmp-traps"
-->
...
# Bmc Software SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Bmc Software SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Bmc Software devices with Netdata. The bundled Bmc Software trap profile decodes 5 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Bmc Software enterprise OID space, and decodes the varbinds using the bundled Bmc Software trap profile. No per-trap configuration.
...
Traps from Bmc Software devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Bmc Software across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
- `PATROL-MIB::patrolInformation`
- `PATROL-MIB::patrolChangeStatus`
