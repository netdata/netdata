<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/actidata_company_snmp_traps.md"
sidebar_label: "Actidata Company SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [actidata-company, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Actidata Company devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/actidata-company-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/actidata-company-snmp-traps"
-->
...
# Actidata Company SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Actidata Company SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Actidata Company devices with Netdata. The bundled Actidata Company trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Actidata Company enterprise OID space, and decodes the varbinds using the bundled Actidata Company trap profile. No per-trap configuration.
...
Traps from Actidata Company devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Actidata Company across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
