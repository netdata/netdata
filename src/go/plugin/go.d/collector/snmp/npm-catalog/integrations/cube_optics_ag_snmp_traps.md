<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cube_optics_ag_snmp_traps.md"
sidebar_label: "Cube Optics AG SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cube-optics-ag, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cube Optics AG devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cube-optics-ag-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cube-optics-ag-snmp-traps"
-->
...
# Cube Optics AG SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cube Optics AG SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cube Optics AG devices with Netdata. The bundled Cube Optics AG trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cube Optics AG enterprise OID space, and decodes the varbinds using the bundled Cube Optics AG trap profile. No per-trap configuration.
...
Traps from Cube Optics AG devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Cube Optics AG across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
