<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/2wire_inc_snmp_traps.md"
sidebar_label: "2Wire Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [2wire-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from 2Wire Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/2wire-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/2wire-inc-snmp-traps"
-->
...
# 2Wire Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="2Wire Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from 2Wire Inc devices with Netdata. The bundled 2Wire Inc trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the 2Wire Inc enterprise OID space, and decodes the varbinds using the bundled 2Wire Inc trap profile. No per-trap configuration.
...
Traps from 2Wire Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from 2Wire Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `notice` 2

**By category:** `state_change` 1 · `config_change` 1

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `RBBPROVISIONING-MIB` | 2 |
