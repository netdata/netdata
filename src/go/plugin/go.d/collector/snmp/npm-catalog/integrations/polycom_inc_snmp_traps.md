<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/polycom_inc_snmp_traps.md"
sidebar_label: "Polycom Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [polycom-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Polycom Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/polycom-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/polycom-inc-snmp-traps"
-->
...
# Polycom Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Polycom Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Polycom Inc devices with Netdata. The bundled Polycom Inc trap profile decodes 339 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Polycom Inc enterprise OID space, and decodes the varbinds using the bundled Polycom Inc trap profile. No per-trap configuration.
...
Traps from Polycom Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **339 trap definitions** from Polycom Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 6 · `crit` 52 · `err` 13 · `warning` 92 · `notice` 174 · `info` 2

**By category:** `state_change` 44 · `config_change` 19 · `security` 19 · `auth` 3 · `license` 5 · `diagnostic` 249
...
|:----|----:|
| `POLYCOM-RMX-MIB` | 296 |
| `POLYCOM-ENDPOINT-MIB` | 43 |

### Sample decoded traps

- `POLYCOM-RMX-MIB::rmxNoLicensingAlarmFault`
- `POLYCOM-RMX-MIB::rmxNoMeetingRoomAlarmFault`
