<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/racktivity_snmp_traps.md"
sidebar_label: "Racktivity SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [racktivity, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Racktivity devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/racktivity-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/racktivity-snmp-traps"
-->
...
# Racktivity SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Racktivity SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Racktivity devices with Netdata. The bundled Racktivity trap profile decodes 25 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Racktivity enterprise OID space, and decodes the varbinds using the bundled Racktivity trap profile. No per-trap configuration.
...
Traps from Racktivity devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **25 trap definitions** from Racktivity across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 10 · `notice` 14 · `info` 1

**By category:** `state_change` 10 · `diagnostic` 15

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `ES-RACKTIVITY-MIB` | 25 |
