<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/forcepoint_llc_snmp_traps.md"
sidebar_label: "Forcepoint LLC SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [forcepoint-llc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Forcepoint LLC devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/forcepoint-llc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/forcepoint-llc-snmp-traps"
-->
...
# Forcepoint LLC SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Forcepoint LLC SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Forcepoint LLC devices with Netdata. The bundled Forcepoint LLC trap profile decodes 10 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Forcepoint LLC enterprise OID space, and decodes the varbinds using the bundled Forcepoint LLC trap profile. No per-trap configuration.
...
Traps from Forcepoint LLC devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Forcepoint LLC across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 1 · `warning` 2 · `notice` 5

**By category:** `state_change` 4 · `config_change` 1 · `auth` 3 · `diagnostic` 2

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `FORCEPOINT-NGFW-ENGINE-MIB` | 10 |
