<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/emc_data_general_division_snmp_traps.md"
sidebar_label: "Emc Data General Division SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [emc-data-general-division, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Emc Data General Division devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/emc-data-general-division-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/emc-data-general-division-snmp-traps"
-->
...
# Emc Data General Division SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Emc Data General Division SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Emc Data General Division devices with Netdata. The bundled Emc Data General Division trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Emc Data General Division enterprise OID space, and decodes the varbinds using the bundled Emc Data General Division trap profile. No per-trap configuration.
...
Traps from Emc Data General Division devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Emc Data General Division across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
