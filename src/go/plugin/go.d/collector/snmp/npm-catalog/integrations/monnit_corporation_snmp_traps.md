<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/monnit_corporation_snmp_traps.md"
sidebar_label: "Monnit Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [monnit-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Monnit Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/monnit-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/monnit-corporation-snmp-traps"
-->
...
# Monnit Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Monnit Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Monnit Corporation devices with Netdata. The bundled Monnit Corporation trap profile decodes 8 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Monnit Corporation enterprise OID space, and decodes the varbinds using the bundled Monnit Corporation trap profile. No per-trap configuration.
...
Traps from Monnit Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Monnit Corporation across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 5 · `notice` 3

**By category:** `state_change` 2 · `diagnostic` 6
...
- `MONNIT-EGW-MIB::GW-online`
- `MONNIT-EGW-MIB::WD-online`
