<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/western_multiplex_snmp_traps.md"
sidebar_label: "Western Multiplex SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [western-multiplex, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Western Multiplex devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/western-multiplex-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/western-multiplex-snmp-traps"
-->
...
# Western Multiplex SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Western Multiplex SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Western Multiplex devices with Netdata. The bundled Western Multiplex trap profile decodes 13 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Western Multiplex enterprise OID space, and decodes the varbinds using the bundled Western Multiplex trap profile. No per-trap configuration.
...
Traps from Western Multiplex devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **13 trap definitions** from Western Multiplex across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 13

**By category:** `state_change` 3 · `diagnostic` 10

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `WESTERN-MULTIPLEX-RAD10006-MIB` | 11 |
| `WESTERN-MULTIPLEX-MIB` | 2 |

### Sample decoded traps

- `WESTERN-MULTIPLEX-MIB::logGenericTrap`
- `WESTERN-MULTIPLEX-MIB::trapsDisabled`
