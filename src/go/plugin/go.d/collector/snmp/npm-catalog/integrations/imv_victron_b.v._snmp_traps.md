<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/imv_victron_b.v._snmp_traps.md"
sidebar_label: "Imv Victron B.V. SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [imv-victron-bv, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Imv Victron B.V."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/imv-victron-b.v.-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/imv-victron-b.v.-snmp-traps"
-->
...
# Imv Victron B.V. SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Imv Victron B.V. SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Imv Victron B.V. devices with Netdata. The bundled Imv Victron B.V. trap profile decodes 611 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Imv Victron B.V. enterprise OID space, and decodes the varbinds using the bundled Imv Victron B.V. trap profile. No per-trap configuration.
...
Traps from Imv Victron B.V. devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **611 trap definitions** from Imv Victron B.V. across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 85 · `crit` 81 · `err` 4 · `warning` 165 · `notice` 276

**By category:** `state_change` 246 · `diagnostic` 365

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `GEPARALLELUPS-MIB` | 594 |
| `GE-PARALLELUPS` | 17 |

### Sample decoded traps

- `GE-PARALLELUPS::upsAlarmUpsOffAsRequested-gen`
- `GEPARALLELUPS-MIB::upsTrapAlarmBatteryBad`
