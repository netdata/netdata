<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/rapidstream_inc_snmp_traps.md"
sidebar_label: "Rapidstream Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [rapidstream-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Rapidstream Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/rapidstream-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/rapidstream-inc-snmp-traps"
-->
...
# Rapidstream Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Rapidstream Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Rapidstream Inc devices with Netdata. The bundled Rapidstream Inc trap profile decodes 10 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Rapidstream Inc enterprise OID space, and decodes the varbinds using the bundled Rapidstream Inc trap profile. No per-trap configuration.
...
Traps from Rapidstream Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Rapidstream Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 8 · `notice` 1

**By category:** `state_change` 1 · `security` 7 · `diagnostic` 2

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `RAPID-IPSEC-SA-MON-MIB-EXT` | 7 |
| `RAPID-SYSTEM-CONFIG-MIB` | 3 |

### Sample decoded traps

- `RAPID-SYSTEM-CONFIG-MIB::rsAlarmTrap`
- `RAPID-SYSTEM-CONFIG-MIB::rsSnmpStart`
