<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/infratec_plus_gmbh_snmp_traps.md"
sidebar_label: "Infratec Plus GmbH SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [infratec-plus-gmbh, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Infratec Plus GmbH devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/infratec-plus-gmbh-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/infratec-plus-gmbh-snmp-traps"
-->
...
# Infratec Plus GmbH SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Infratec Plus GmbH SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Infratec Plus GmbH devices with Netdata. The bundled Infratec Plus GmbH trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Infratec Plus GmbH enterprise OID space, and decodes the varbinds using the bundled Infratec Plus GmbH trap profile. No per-trap configuration.
...
Traps from Infratec Plus GmbH devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Infratec Plus GmbH across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 1 · `notice` 1

**By category:** `auth` 1 · `diagnostic` 1
