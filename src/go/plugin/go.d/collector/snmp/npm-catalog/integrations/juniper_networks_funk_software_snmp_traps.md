<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/juniper_networks_funk_software_snmp_traps.md"
sidebar_label: "Juniper Networks Funk Software SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [juniper-networks-funk-software, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Juniper Networks Funk Software devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/juniper-networks-funk-software-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/juniper-networks-funk-software-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/juniper.png" width="150" alt="Juniper Networks Funk Software SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Juniper Networks Funk Software devices with Netdata. The bundled Juniper Networks Funk Software trap profile decodes 117 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Juniper Networks Funk Software enterprise OID space, and decodes the varbinds using the bundled Juniper Networks Funk Software trap profile. No per-trap configuration.
...
Traps from Juniper Networks Funk Software devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **117 trap definitions** from Juniper Networks Funk Software across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 28 · `alert` 3 · `crit` 18 · `err` 8 · `warning` 35 · `notice` 25

**By category:** `state_change` 25 · `config_change` 2 · `auth` 4 · `license` 1 · `diagnostic` 85
...
- `FNKSBRTR-MIB::funkSbrTrapServiceStarted`
- `FNKSBRTR-MIB::funkSbrTrapServiceStopped`
