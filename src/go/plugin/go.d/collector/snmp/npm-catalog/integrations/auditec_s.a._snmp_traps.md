<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/auditec_s.a._snmp_traps.md"
sidebar_label: "Auditec S.A. SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [auditec-sa, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Auditec S.A."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/auditec-s.a.-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/auditec-s.a.-snmp-traps"
-->
...
# Auditec S.A. SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Auditec S.A. SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Auditec S.A. devices with Netdata. The bundled Auditec S.A. trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Auditec S.A. enterprise OID space, and decodes the varbinds using the bundled Auditec S.A. trap profile. No per-trap configuration.
...
Traps from Auditec S.A. devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Auditec S.A. across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
