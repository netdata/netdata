<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/enterprise_1004849_snmp_traps.md"
sidebar_label: "Enterprise 1004849 SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [enterprise-1004849, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Enterprise 1004849 devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/enterprise-1004849-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/enterprise-1004849-snmp-traps"
-->
...
# Enterprise 1004849 SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Enterprise 1004849 SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Enterprise 1004849 devices with Netdata. The bundled Enterprise 1004849 trap profile decodes 11 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Enterprise 1004849 enterprise OID space, and decodes the varbinds using the bundled Enterprise 1004849 trap profile. No per-trap configuration.
...
Traps from Enterprise 1004849 devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **11 trap definitions** from Enterprise 1004849 across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 4 · `notice` 5 · `info` 1
...
- `DAHUA-SNMP-MIB::snmpStatusEvent`
- `DAHUA-SNMP-MIB::videoMotionEvent`
