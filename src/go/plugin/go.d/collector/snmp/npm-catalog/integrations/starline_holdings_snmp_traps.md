<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/starline_holdings_snmp_traps.md"
sidebar_label: "Starline Holdings SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [starline-holdings, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Starline Holdings devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/starline-holdings-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/starline-holdings-snmp-traps"
-->
...
# Starline Holdings SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Starline Holdings SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Starline Holdings devices with Netdata. The bundled Starline Holdings trap profile decodes 28 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Starline Holdings enterprise OID space, and decodes the varbinds using the bundled Starline Holdings trap profile. No per-trap configuration.
...
Traps from Starline Holdings devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **28 trap definitions** from Starline Holdings across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 11 · `crit` 1 · `warning` 12 · `notice` 4

**By category:** `diagnostic` 28
...
- `UEC-STARLINE-MIB::cpmAcInfOvCurrAssertEv`
- `UEC-STARLINE-MIB::cpmAcInfOvCurrDeassertEv`
