<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/overland_data_inc_snmp_traps.md"
sidebar_label: "Overland Data Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [overland-data-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Overland Data Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/overland-data-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/overland-data-inc-snmp-traps"
-->
...
# Overland Data Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Overland Data Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Overland Data Inc devices with Netdata. The bundled Overland Data Inc trap profile decodes 12 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Overland Data Inc enterprise OID space, and decodes the varbinds using the bundled Overland Data Inc trap profile. No per-trap configuration.
...
Traps from Overland Data Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **12 trap definitions** from Overland Data Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 3 · `err` 1 · `warning` 4 · `notice` 2 · `info` 1

**By category:** `state_change` 2 · `security` 1 · `diagnostic` 9
