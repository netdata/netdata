<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/egenera_inc_snmp_traps.md"
sidebar_label: "Egenera Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [egenera-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Egenera Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/egenera-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/egenera-inc-snmp-traps"
-->
...
# Egenera Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Egenera Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Egenera Inc devices with Netdata. The bundled Egenera Inc trap profile decodes 359 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Egenera Inc enterprise OID space, and decodes the varbinds using the bundled Egenera Inc trap profile. No per-trap configuration.
...
Traps from Egenera Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **359 trap definitions** from Egenera Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 12 · `crit` 57 · `err` 16 · `warning` 99 · `notice` 171 · `info` 4

**By category:** `state_change` 148 · `config_change` 52 · `security` 1 · `auth` 3 · `license` 7 · `diagnostic` 148
...
- `EGENERA-MIB::bladeFrameUpTrap`
- `EGENERA-MIB::bladeFrameDownTrap`
