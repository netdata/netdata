<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/quantum_bridge_snmp_traps.md"
sidebar_label: "Quantum Bridge SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [quantum-bridge, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Quantum Bridge devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/quantum-bridge-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/quantum-bridge-snmp-traps"
-->
...
# Quantum Bridge SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Quantum Bridge SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Quantum Bridge devices with Netdata. The bundled Quantum Bridge trap profile decodes 21 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Quantum Bridge enterprise OID space, and decodes the varbinds using the bundled Quantum Bridge trap profile. No per-trap configuration.
...
Traps from Quantum Bridge devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **21 trap definitions** from Quantum Bridge across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 6 · `warning` 7 · `notice` 6

**By category:** `state_change` 9 · `config_change` 2 · `diagnostic` 10
...
- `QBSYS-SYSTEM-MIB::qbSysAlarm`
- `QBSYS-SYSTEM-MIB::qbSysEvent`
