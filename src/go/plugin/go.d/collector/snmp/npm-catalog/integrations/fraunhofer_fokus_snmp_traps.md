<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/fraunhofer_fokus_snmp_traps.md"
sidebar_label: "Fraunhofer Fokus SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [fraunhofer-fokus, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Fraunhofer Fokus devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/fraunhofer-fokus-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/fraunhofer-fokus-snmp-traps"
-->
...
# Fraunhofer Fokus SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Fraunhofer Fokus SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Fraunhofer Fokus devices with Netdata. The bundled Fraunhofer Fokus trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Fraunhofer Fokus enterprise OID space, and decodes the varbinds using the bundled Fraunhofer Fokus trap profile. No per-trap configuration.
...
Traps from Fraunhofer Fokus devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Fraunhofer Fokus across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
