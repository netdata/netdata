<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/fibronics_snmp_traps.md"
sidebar_label: "Fibronics SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [fibronics, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Fibronics devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/fibronics-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/fibronics-snmp-traps"
-->
...
# Fibronics SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Fibronics SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Fibronics devices with Netdata. The bundled Fibronics trap profile decodes 57 trap definitions across 6 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Fibronics enterprise OID space, and decodes the varbinds using the bundled Fibronics trap profile. No per-trap configuration.
...
Traps from Fibronics devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **57 trap definitions** from Fibronics across **6 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 8 · `warning` 21 · `notice` 27

**By category:** `state_change` 35 · `config_change` 7 · `security` 2 · `diagnostic` 13
...
- `Fx8210-private::sendGenericEvent`
- `EDB-snmp::fmPowerSupplyFail`
