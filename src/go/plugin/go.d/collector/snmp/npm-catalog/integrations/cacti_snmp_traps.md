<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cacti_snmp_traps.md"
sidebar_label: "Cacti SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cacti, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cacti devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cacti-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cacti-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cacti SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cacti devices with Netdata. The bundled Cacti trap profile decodes 7 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cacti enterprise OID space, and decodes the varbinds using the bundled Cacti trap profile. No per-trap configuration.
...
Traps from Cacti devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Cacti across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 3 · `notice` 1 · `info` 2

**By category:** `state_change` 2 · `diagnostic` 5
...
|:----|----:|
| `CACTI-MIB` | 5 |
| `CACTI-SNMPAGENT-MIB` | 1 |
| `CACTI-THOLD-MIB` | 1 |

### Sample decoded traps

- `CACTI-MIB::cactiNotify`
- `CACTI-MIB::cactiNotifyDeviceDown`
