<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/panasas_inc_snmp_traps.md"
sidebar_label: "Panasas Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [panasas-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Panasas Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/panasas-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/panasas-inc-snmp-traps"
-->
...
# Panasas Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Panasas Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Panasas Inc devices with Netdata. The bundled Panasas Inc trap profile decodes 45 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Panasas Inc enterprise OID space, and decodes the varbinds using the bundled Panasas Inc trap profile. No per-trap configuration.
...
Traps from Panasas Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **45 trap definitions** from Panasas Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 8 · `crit` 16 · `warning` 20 · `notice` 1

**By category:** `state_change` 2 · `security` 1 · `diagnostic` 42

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `PANASAS-NOTIFY-MIB-V1` | 45 |

### Sample decoded traps

- `PANASAS-NOTIFY-MIB-V1::panNotifyHwShelfFailure`
- `PANASAS-NOTIFY-MIB-V1::panNotifyHwBladeFailure`
