<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/zenitel_norway_as_snmp_traps.md"
sidebar_label: "Zenitel Norway AS SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [zenitel-norway-as, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Zenitel Norway AS devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/zenitel-norway-as-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/zenitel-norway-as-snmp-traps"
-->
...
# Zenitel Norway AS SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Zenitel Norway AS SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Zenitel Norway AS devices with Netdata. The bundled Zenitel Norway AS trap profile decodes 43 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Zenitel Norway AS enterprise OID space, and decodes the varbinds using the bundled Zenitel Norway AS trap profile. No per-trap configuration.
...
Traps from Zenitel Norway AS devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **43 trap definitions** from Zenitel Norway AS across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 8 · `warning` 20 · `notice` 11 · `info` 1 · `debug` 1

**By category:** `state_change` 16 · `diagnostic` 27
...
- `ALPHACOM-MIB::logEvent`
- `ALPHACOM-MIB::debugLogEvent`
