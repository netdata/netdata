<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/albentia_systems_s_a_snmp_traps.md"
sidebar_label: "Albentia Systems S A SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [albentia-systems-s-a, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Albentia Systems S A devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/albentia-systems-s-a-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/albentia-systems-s-a-snmp-traps"
-->
...
# Albentia Systems S A SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Albentia Systems S A SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Albentia Systems S A devices with Netdata. The bundled Albentia Systems S A trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Albentia Systems S A enterprise OID space, and decodes the varbinds using the bundled Albentia Systems S A trap profile. No per-trap configuration.
...
Traps from Albentia Systems S A devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Albentia Systems S A across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
- `ALBENTIA-MIB::albAlarmNotification`
