<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cumulus_networks_inc_snmp_traps.md"
sidebar_label: "Cumulus Networks Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cumulus-networks-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cumulus Networks Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cumulus-networks-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cumulus-networks-inc-snmp-traps"
-->
...
# Cumulus Networks Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cumulus Networks Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cumulus Networks Inc devices with Netdata. The bundled Cumulus Networks Inc trap profile decodes 4 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cumulus Networks Inc enterprise OID space, and decodes the varbinds using the bundled Cumulus Networks Inc trap profile. No per-trap configuration.
...
Traps from Cumulus Networks Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from Cumulus Networks Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 2 · `notice` 2

**By category:** `state_change` 4
...
|:----|----:|
| `CUMULUS-BGPUN-MIB` | 2 |
| `CUMULUS-BGPVRF-MIB` | 2 |

### Sample decoded traps

- `CUMULUS-BGPUN-MIB::bgpEstablished`
