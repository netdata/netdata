<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/swapcom_snmp_traps.md"
sidebar_label: "Swapcom SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [swapcom, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Swapcom devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/swapcom-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/swapcom-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Swapcom SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Swapcom devices with Netdata. The bundled Swapcom trap profile decodes 15 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Swapcom enterprise OID space, and decodes the varbinds using the bundled Swapcom trap profile. No per-trap configuration.
...
Traps from Swapcom devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **15 trap definitions** from Swapcom across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 2 · `crit` 4 · `warning` 4 · `notice` 3 · `info` 2

**By category:** `state_change` 3 · `diagnostic` 11 · `unknown` 1
...
- `SWAPCOM-SNMP::defaultNotification`
- `SWAPCOM-SNMP::platformStart`
