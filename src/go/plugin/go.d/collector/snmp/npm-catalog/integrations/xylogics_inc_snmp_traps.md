<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/xylogics_inc_snmp_traps.md"
sidebar_label: "Xylogics Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [xylogics-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Xylogics Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/xylogics-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/xylogics-inc-snmp-traps"
-->
...
# Xylogics Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Xylogics Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Xylogics Inc devices with Netdata. The bundled Xylogics Inc trap profile decodes 40 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Xylogics Inc enterprise OID space, and decodes the varbinds using the bundled Xylogics Inc trap profile. No per-trap configuration.
...
Traps from Xylogics Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **40 trap definitions** from Xylogics Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 5 · `warning` 15 · `notice` 15 · `info` 3

**By category:** `state_change` 14 · `security` 1 · `diagnostic` 25

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `XYLOGICS-TRAP-MIB` | 40 |

### Sample decoded traps

- `XYLOGICS-TRAP-MIB::suspectAttackTrap`
- `XYLOGICS-TRAP-MIB::acpdbmerrorTrap`
