<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/teracom_ltd_snmp_traps.md"
sidebar_label: "Teracom Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [teracom-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Teracom Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/teracom-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/teracom-ltd-snmp-traps"
-->
...
# Teracom Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Teracom Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Teracom Ltd devices with Netdata. The bundled Teracom Ltd trap profile decodes 16 trap definitions across 9 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Teracom Ltd enterprise OID space, and decodes the varbinds using the bundled Teracom Ltd trap profile. No per-trap configuration.
...
Traps from Teracom Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **16 trap definitions** from Teracom Ltd across **9 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 9 · `notice` 7

**By category:** `state_change` 2 · `diagnostic` 14

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `TERACOM-TCW111-MIB` | 5 |
| `TERACOM-TCW121-MIB` | 4 |
| `TERACOM-MIB` | 1 |
| `TERACOM-TCW181B-MIB` | 1 |
| `TERACOM-TCW210-TH-MIB` | 1 |
| `TERACOM-TCW220-MIB` | 1 |
| `TERACOM-TCW241-MIB` | 1 |
| `TERACOM-TCW242-MIB` | 1 |
| `TERACOM-TCW260-MIB` | 1 |

### Sample decoded traps

- `TERACOM-TCW181B-MIB::snmp-trap-notification`
- `TERACOM-TCW111-MIB::trcDigitalInputState`
