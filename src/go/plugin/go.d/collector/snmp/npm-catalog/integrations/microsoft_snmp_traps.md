<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/microsoft_snmp_traps.md"
sidebar_label: "Microsoft SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [microsoft, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Microsoft devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/microsoft-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/microsoft-snmp-traps"
-->
...
# Microsoft SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Microsoft SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Microsoft devices with Netdata. The bundled Microsoft trap profile decodes 15 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Microsoft enterprise OID space, and decodes the varbinds using the bundled Microsoft trap profile. No per-trap configuration.
...
Traps from Microsoft devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **15 trap definitions** from Microsoft across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 1 · `crit` 2 · `err` 1 · `warning` 4 · `notice` 4 · `info` 3

**By category:** `state_change` 3 · `auth` 5 · `diagnostic` 7
...
- `RFC1157::rfc1157AuthenticationFailure`
- `EVNTAGENT-MIB::w32NtpSynchSuccess`
