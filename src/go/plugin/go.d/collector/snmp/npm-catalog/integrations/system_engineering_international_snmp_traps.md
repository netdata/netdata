<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/system_engineering_international_snmp_traps.md"
sidebar_label: "System Engineering International SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [system-engineering-international, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from System Engineering International devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/system-engineering-international-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/system-engineering-international-snmp-traps"
-->
...
# System Engineering International SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="System Engineering International SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from System Engineering International devices with Netdata. The bundled System Engineering International trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the System Engineering International enterprise OID space, and decodes the varbinds using the bundled System Engineering International trap profile. No per-trap configuration.
...
Traps from System Engineering International devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from System Engineering International across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 1 · `notice` 1
