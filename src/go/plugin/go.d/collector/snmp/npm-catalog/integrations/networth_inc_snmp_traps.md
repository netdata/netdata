<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/networth_inc_snmp_traps.md"
sidebar_label: "Networth Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [networth-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Networth Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/networth-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/networth-inc-snmp-traps"
-->
...
# Networth Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Networth Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Networth Inc devices with Netdata. The bundled Networth Inc trap profile decodes 4 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Networth Inc enterprise OID space, and decodes the varbinds using the bundled Networth Inc trap profile. No per-trap configuration.
...
Traps from Networth Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from Networth Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 1 · `notice` 2
...
|:----|----:|
| `NETWORTH-FASTPIPES-MIB` | 4 |

### Sample decoded traps

- `NETWORTH-FASTPIPES-MIB::nwfpPowerSupplyDown`
