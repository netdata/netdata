<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/era_a_s_snmp_traps.md"
sidebar_label: "Era A S SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [era-a-s, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Era A S devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/era-a-s-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/era-a-s-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Era A S SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Era A S devices with Netdata. The bundled Era A S trap profile decodes 12 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Era A S enterprise OID space, and decodes the varbinds using the bundled Era A S trap profile. No per-trap configuration.
...
Traps from Era A S devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **12 trap definitions** from Era A S across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 2 · `warning` 5 · `notice` 3 · `info` 1

**By category:** `state_change` 2 · `diagnostic` 10
...
- `ERA-MIB::mssTrapStatusSystemError`
- `ERA-MIB::mssTrapStatusSystemDegraded`
