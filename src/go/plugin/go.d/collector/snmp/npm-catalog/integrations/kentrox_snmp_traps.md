<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/kentrox_snmp_traps.md"
sidebar_label: "Kentrox SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [kentrox, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Kentrox devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/kentrox-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/kentrox-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Kentrox SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Kentrox devices with Netdata. The bundled Kentrox trap profile decodes 8 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Kentrox enterprise OID space, and decodes the varbinds using the bundled Kentrox trap profile. No per-trap configuration.
...
Traps from Kentrox devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Kentrox across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
- `DATASMART-MIB::dsAcOnPowerTransition`
- `DATASMART-MIB::dsAcOffPowerTransition`
