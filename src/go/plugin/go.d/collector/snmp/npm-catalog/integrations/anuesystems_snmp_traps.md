<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/anuesystems_snmp_traps.md"
sidebar_label: "Anuesystems SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [anuesystems, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Anuesystems devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/anuesystems-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/anuesystems-snmp-traps"
-->
...
# Anuesystems SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Anuesystems SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Anuesystems devices with Netdata. The bundled Anuesystems trap profile decodes 19 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Anuesystems enterprise OID space, and decodes the varbinds using the bundled Anuesystems trap profile. No per-trap configuration.
...
Traps from Anuesystems devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **19 trap definitions** from Anuesystems across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 16 · `notice` 1 · `info` 1

**By category:** `state_change` 6 · `auth` 2 · `diagnostic` 11
