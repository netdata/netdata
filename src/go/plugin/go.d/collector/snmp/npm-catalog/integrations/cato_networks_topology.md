<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cato_networks_topology.md"
sidebar_label: "Cato Networks Topology"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/Topologies/Integrations"
keywords: [cato, sase, sd-wan, topology, npm]
description: "Map a Cato Networks SASE fabric. The Cato collector renders sites, sockets, and gateways with their tunnel and transport paths."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/topologies/integrations/cato-networks-topology"
slug: "/network-performance-monitoring/topologies/integrations/cato-networks-topology"
-->
...
<img src="https://netdata.cloud/img/network-wired.svg" width="150" alt="Cato Networks Topology"/>
...
The two required fields. `url` defaults to the Cato public GraphQL endpoint, and `update_every` must be at least 60.
