<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/protection_one_inc_snmp_traps.md"
sidebar_label: "Protection One Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [protection-one-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Protection One Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/protection-one-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/protection-one-inc-snmp-traps"
-->
...
# Protection One Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Protection One Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Protection One Inc devices with Netdata. The bundled Protection One Inc trap profile decodes 27 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Protection One Inc enterprise OID space, and decodes the varbinds using the bundled Protection One Inc trap profile. No per-trap configuration.
...
Traps from Protection One Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **27 trap definitions** from Protection One Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 13 · `notice` 14

**By category:** `state_change` 7 · `auth` 1 · `diagnostic` 19
