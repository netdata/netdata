<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/wordperfect_corp_snmp_traps.md"
sidebar_label: "Wordperfect Corp SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [wordperfect-corp, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Wordperfect Corp devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/wordperfect-corp-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/wordperfect-corp-snmp-traps"
-->
...
# Wordperfect Corp SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Wordperfect Corp SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Wordperfect Corp devices with Netdata. The bundled Wordperfect Corp trap profile decodes 23 trap definitions across 5 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Wordperfect Corp enterprise OID space, and decodes the varbinds using the bundled Wordperfect Corp trap profile. No per-trap configuration.
...
Traps from Wordperfect Corp devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **23 trap definitions** from Wordperfect Corp across **5 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 4 · `warning` 4 · `notice` 14

**By category:** `state_change` 20 · `diagnostic` 3
...
- `NGWASYNC::ngwasyncStartTrap`
- `NGWASYNC::ngwasyncStopTrap`
