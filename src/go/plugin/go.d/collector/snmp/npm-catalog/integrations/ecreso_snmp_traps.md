<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/ecreso_snmp_traps.md"
sidebar_label: "Ecreso SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [ecreso, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Ecreso devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/ecreso-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/ecreso-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Ecreso SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Ecreso devices with Netdata. The bundled Ecreso trap profile decodes 59 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Ecreso enterprise OID space, and decodes the varbinds using the bundled Ecreso trap profile. No per-trap configuration.
...
Traps from Ecreso devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **59 trap definitions** from Ecreso across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 8 · `crit` 1 · `err` 1 · `warning` 39 · `notice` 10

**By category:** `state_change` 11 · `config_change` 1 · `license` 8 · `diagnostic` 39

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `ECRESO-FM-TRANS-MIB` | 59 |
