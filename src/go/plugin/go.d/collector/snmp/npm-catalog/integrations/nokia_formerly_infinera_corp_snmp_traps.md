<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nokia_formerly_infinera_corp_snmp_traps.md"
sidebar_label: "Nokia Formerly Infinera Corp SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [nokia-formerly-infinera-corp, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Nokia Formerly Infinera Corp devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/nokia-formerly-infinera-corp-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/nokia-formerly-infinera-corp-snmp-traps"
-->
...
# Nokia Formerly Infinera Corp SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Nokia Formerly Infinera Corp SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Nokia Formerly Infinera Corp devices with Netdata. The bundled Nokia Formerly Infinera Corp trap profile decodes 10 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Nokia Formerly Infinera Corp enterprise OID space, and decodes the varbinds using the bundled Nokia Formerly Infinera Corp trap profile. No per-trap configuration.
...
Traps from Nokia Formerly Infinera Corp devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Nokia Formerly Infinera Corp across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 5 · `notice` 4

**By category:** `config_change` 4 · `security` 2 · `diagnostic` 4

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `INFINERA-NOTIFICATION-MIB` | 5 |
| `INFINERA-TRAP-MIB` | 5 |
