<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/gigamon_systems_llc_snmp_traps.md"
sidebar_label: "Gigamon Systems LLC SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [gigamon-systems-llc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Gigamon Systems LLC devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/gigamon-systems-llc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/gigamon-systems-llc-snmp-traps"
-->
...
# Gigamon Systems LLC SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Gigamon Systems LLC SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Gigamon Systems LLC devices with Netdata. The bundled Gigamon Systems LLC trap profile decodes 20 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Gigamon Systems LLC enterprise OID space, and decodes the varbinds using the bundled Gigamon Systems LLC trap profile. No per-trap configuration.
...
Traps from Gigamon Systems LLC devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **20 trap definitions** from Gigamon Systems LLC across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `warning` 11 · `notice` 7

**By category:** `state_change` 7 · `config_change` 2 · `auth` 1 · `diagnostic` 10
...
- `GIGAMON-SNMP-MIB::gigamonSnmpResetSystemNotification`
- `GIGAMON-SNMP-MIB::gigamonSnmpUserAuthFailNotification`
