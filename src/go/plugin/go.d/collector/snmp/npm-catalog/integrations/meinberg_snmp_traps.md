<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/meinberg_snmp_traps.md"
sidebar_label: "Meinberg SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [meinberg, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Meinberg devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/meinberg-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/meinberg-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Meinberg SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Meinberg devices with Netdata. The bundled Meinberg trap profile decodes 128 trap definitions across 8 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Meinberg enterprise OID space, and decodes the varbinds using the bundled Meinberg trap profile. No per-trap configuration.
...
Traps from Meinberg devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **128 trap definitions** from Meinberg across **8 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 11 · `err` 1 · `warning` 49 · `notice` 56 · `info` 9

**By category:** `state_change` 41 · `config_change` 2 · `license` 1 · `diagnostic` 84

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `MBG-SNMP-LTNG-MIB` | 50 |
| `MBG-SNMP-LT-MIB` | 33 |
| `MBG-SNMP-RSC-MDU-MIB` | 14 |
| `MBG-SNMP-XPT-MIB` | 13 |
| `MBG-SNMP-FDMXPT-MIB` | 11 |
| `MBG-SNMP-NTP-DISPLAY-MIB` | 4 |
| `MBG-MGMT-MIB` | 2 |
| `MEINBERG-OS-MIB` | 1 |
