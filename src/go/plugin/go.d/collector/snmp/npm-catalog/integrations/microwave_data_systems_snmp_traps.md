<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/microwave_data_systems_snmp_traps.md"
sidebar_label: "Microwave Data Systems SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [microwave-data-systems, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Microwave Data Systems devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/microwave-data-systems-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/microwave-data-systems-snmp-traps"
-->
...
# Microwave Data Systems SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Microwave Data Systems SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Microwave Data Systems devices with Netdata. The bundled Microwave Data Systems trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Microwave Data Systems enterprise OID space, and decodes the varbinds using the bundled Microwave Data Systems trap profile. No per-trap configuration.
...
Traps from Microwave Data Systems devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Microwave Data Systems across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
