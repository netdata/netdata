<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/croix_rouge_francaise_snmp_traps.md"
sidebar_label: "Croix Rouge Francaise SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [croix-rouge-francaise, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Croix Rouge Francaise devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/croix-rouge-francaise-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/croix-rouge-francaise-snmp-traps"
-->
...
# Croix Rouge Francaise SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Croix Rouge Francaise SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Croix Rouge Francaise devices with Netdata. The bundled Croix Rouge Francaise trap profile decodes 74 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Croix Rouge Francaise enterprise OID space, and decodes the varbinds using the bundled Croix Rouge Francaise trap profile. No per-trap configuration.
...
Traps from Croix Rouge Francaise devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **74 trap definitions** from Croix Rouge Francaise across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 6 · `crit` 6 · `warning` 33 · `notice` 21 · `info` 8

**By category:** `state_change` 14 · `config_change` 2 · `diagnostic` 58
