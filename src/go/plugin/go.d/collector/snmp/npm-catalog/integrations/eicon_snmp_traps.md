<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/eicon_snmp_traps.md"
sidebar_label: "Eicon SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [eicon, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Eicon devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/eicon-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/eicon-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Eicon SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Eicon devices with Netdata. The bundled Eicon trap profile decodes 10 trap definitions across 6 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Eicon enterprise OID space, and decodes the varbinds using the bundled Eicon trap profile. No per-trap configuration.
...
Traps from Eicon devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Eicon across **6 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `err` 1 · `warning` 3 · `notice` 4 · `info` 1

**By category:** `state_change` 6 · `diagnostic` 4
...
- `ECX25EXT-MIB::x25Reset`
- `EICON-MIB-SERVER::srvTrapHeartbeat`
