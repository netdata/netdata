<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/verax_systems_snmp_traps.md"
sidebar_label: "Verax Systems SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [verax-systems, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Verax Systems devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/verax-systems-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/verax-systems-snmp-traps"
-->
...
# Verax Systems SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Verax Systems SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Verax Systems devices with Netdata. The bundled Verax Systems trap profile decodes 56 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Verax Systems enterprise OID space, and decodes the varbinds using the bundled Verax Systems trap profile. No per-trap configuration.
...
Traps from Verax Systems devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **56 trap definitions** from Verax Systems across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 2 · `err` 3 · `warning` 20 · `notice` 27 · `info` 2

**By category:** `state_change` 19 · `security` 1 · `diagnostic` 36

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `VERAX-NMS-AGENT-MIB` | 56 |

### Sample decoded traps

- `VERAX-NMS-AGENT-MIB::genSyslogEvent`
- `VERAX-NMS-AGENT-MIB::genDiscoveredDeviceEvent`
