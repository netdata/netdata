<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/wyse_technology_snmp_traps.md"
sidebar_label: "Wyse Technology SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [wyse-technology, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Wyse Technology devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/wyse-technology-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/wyse-technology-snmp-traps"
-->
...
# Wyse Technology SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Wyse Technology SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Wyse Technology devices with Netdata. The bundled Wyse Technology trap profile decodes 7 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Wyse Technology enterprise OID space, and decodes the varbinds using the bundled Wyse Technology trap profile. No per-trap configuration.
...
Traps from Wyse Technology devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Wyse Technology across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 4 · `notice` 2 · `info` 1

**By category:** `state_change` 1 · `config_change` 2 · `diagnostic` 4
...
- `WYSE-MIB::wbt3TrapDHCPBuildMismatch`
- `WYSE-MIB::wbt3TrapDHCPUpdDone`
