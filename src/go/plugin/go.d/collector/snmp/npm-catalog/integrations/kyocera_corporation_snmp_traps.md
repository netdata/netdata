<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/kyocera_corporation_snmp_traps.md"
sidebar_label: "Kyocera Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [kyocera-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Kyocera Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/kyocera-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/kyocera-corporation-snmp-traps"
-->
...
# Kyocera Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Kyocera Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Kyocera Corporation devices with Netdata. The bundled Kyocera Corporation trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Kyocera Corporation enterprise OID space, and decodes the varbinds using the bundled Kyocera Corporation trap profile. No per-trap configuration.
...
Traps from Kyocera Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Kyocera Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
