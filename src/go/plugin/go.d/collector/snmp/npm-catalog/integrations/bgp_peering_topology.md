...
description: "Map routers to their BGP neighbors. Netdata reads BGP peer tables (BGP4-MIB plus vendor MIBs) and renders router-to-router peering links with remote AS and…"
