<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/terra_snmp_traps.md"
sidebar_label: "Terra SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [terra, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Terra devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/terra-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/terra-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Terra SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Terra devices with Netdata. The bundled Terra trap profile decodes 45 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Terra enterprise OID space, and decodes the varbinds using the bundled Terra trap profile. No per-trap configuration.
...
Traps from Terra devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **45 trap definitions** from Terra across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 27 · `notice` 18

**By category:** `state_change` 24 · `diagnostic` 21
