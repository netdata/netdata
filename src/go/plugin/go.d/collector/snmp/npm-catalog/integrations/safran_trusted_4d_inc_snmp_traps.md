<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/safran_trusted_4d_inc_snmp_traps.md"
sidebar_label: "Safran Trusted 4D Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [safran-trusted-4d-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Safran Trusted 4D Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/safran-trusted-4d-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/safran-trusted-4d-inc-snmp-traps"
-->
...
# Safran Trusted 4D Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Safran Trusted 4D Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Safran Trusted 4D Inc devices with Netdata. The bundled Safran Trusted 4D Inc trap profile decodes 24 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Safran Trusted 4D Inc enterprise OID space, and decodes the varbinds using the bundled Safran Trusted 4D Inc trap profile. No per-trap configuration.
...
Traps from Safran Trusted 4D Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **24 trap definitions** from Safran Trusted 4D Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 2 · `warning` 10 · `notice` 9 · `info` 1

**By category:** `state_change` 4 · `diagnostic` 20

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SPECTRACOM-XSYNC-MIB` | 24 |
