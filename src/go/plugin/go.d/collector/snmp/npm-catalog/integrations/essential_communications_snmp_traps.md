<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/essential_communications_snmp_traps.md"
sidebar_label: "Essential Communications SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [essential-communications, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Essential Communications devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/essential-communications-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/essential-communications-snmp-traps"
-->
...
# Essential Communications SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Essential Communications SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Essential Communications devices with Netdata. The bundled Essential Communications trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Essential Communications enterprise OID space, and decodes the varbinds using the bundled Essential Communications trap profile. No per-trap configuration.
...
Traps from Essential Communications devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Essential Communications across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
|:----|----:|
| `ESSENTIAL-ODS-ESS2000-HIPPI-SWITCH-MIB` | 1 |
