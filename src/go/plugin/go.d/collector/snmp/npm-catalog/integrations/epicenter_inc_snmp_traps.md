<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/epicenter_inc_snmp_traps.md"
sidebar_label: "Epicenter Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [epicenter-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Epicenter Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/epicenter-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/epicenter-inc-snmp-traps"
-->
...
# Epicenter Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Epicenter Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Epicenter Inc devices with Netdata. The bundled Epicenter Inc trap profile decodes 71 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Epicenter Inc enterprise OID space, and decodes the varbinds using the bundled Epicenter Inc trap profile. No per-trap configuration.
...
Traps from Epicenter Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **71 trap definitions** from Epicenter Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 48 · `notice` 21 · `info` 1

**By category:** `state_change` 7 · `config_change` 9 · `security` 7 · `auth` 2 · `diagnostic` 46
...
- `CPI-UNITY-MIB::maxCurrentxy1`
- `CPI-UNITY-MIB::maxCurrentyz1`
