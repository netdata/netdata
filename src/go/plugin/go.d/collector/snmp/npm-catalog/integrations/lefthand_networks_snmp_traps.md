<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/lefthand_networks_snmp_traps.md"
sidebar_label: "Lefthand Networks SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [lefthand-networks, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Lefthand Networks devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/lefthand-networks-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/lefthand-networks-snmp-traps"
-->
...
# Lefthand Networks SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Lefthand Networks SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Lefthand Networks devices with Netdata. The bundled Lefthand Networks trap profile decodes 22 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Lefthand Networks enterprise OID space, and decodes the varbinds using the bundled Lefthand Networks trap profile. No per-trap configuration.
...
Traps from Lefthand Networks devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **22 trap definitions** from Lefthand Networks across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 18 · `notice` 4
...
|:----|----:|
| `LEFTHAND-NETWORKS-NSM-NOTIFICATION-MIB` | 22 |
