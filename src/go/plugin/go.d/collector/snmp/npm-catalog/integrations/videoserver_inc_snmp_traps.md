<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/videoserver_inc_snmp_traps.md"
sidebar_label: "Videoserver Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [videoserver-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Videoserver Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/videoserver-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/videoserver-inc-snmp-traps"
-->
...
# Videoserver Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Videoserver Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Videoserver Inc devices with Netdata. The bundled Videoserver Inc trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Videoserver Inc enterprise OID space, and decodes the varbinds using the bundled Videoserver Inc trap profile. No per-trap configuration.
...
Traps from Videoserver Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Videoserver Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
