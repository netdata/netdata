<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/tegile_systems_inc_snmp_traps.md"
sidebar_label: "Tegile Systems Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [tegile-systems-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Tegile Systems Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/tegile-systems-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/tegile-systems-inc-snmp-traps"
-->
...
# Tegile Systems Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Tegile Systems Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Tegile Systems Inc devices with Netdata. The bundled Tegile Systems Inc trap profile decodes 153 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Tegile Systems Inc enterprise OID space, and decodes the varbinds using the bundled Tegile Systems Inc trap profile. No per-trap configuration.
...
Traps from Tegile Systems Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **153 trap definitions** from Tegile Systems Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 15 · `err` 31 · `warning` 32 · `notice` 54 · `info` 21

**By category:** `state_change` 28 · `config_change` 36 · `auth` 1 · `license` 1 · `diagnostic` 87
