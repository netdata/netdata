<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/western_digital_mycloud_ex2_ultra.md"
sidebar_label: "Western Digital Mycloud EX2 Ultra"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/Device Metrics/Integrations"
keywords: [western, digital, mycloud, ex2, ultra, snmp, storage, npm]
description: "Monitor Western Digital Mycloud EX2 Ultra (storage) with Netdata over SNMP."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/device-metrics/integrations/western-digital-mycloud-ex2-ultra"
slug: "/network-performance-monitoring/device-metrics/integrations/western-digital-mycloud-ex2-ultra"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Western Digital Mycloud EX2 Ultra"/>
...
Monitor Western Digital Mycloud EX2 Ultra (storage) with Netdata over SNMP. Netdata recognizes the device automatically by its `sysObjectID` (recognized across 1 device identifiers) and collects the metrics this profile declares — on top of the generic SNMP baseline — with no manual OID configuration.

Netdata's SNMP collector matches the device to the **western-digital-mycloud-ex2-ultra.yaml** profile via `sysObjectID`/`sysDescr`, then polls the OIDs it declares.
...
Auto-detected as Western Digital Mycloud EX2 Ultra via sysObjectID/sysDescr.
...
On top of the **generic SNMP baseline** (the *Generic SNMP Device* integration — interfaces, system, IP/TCP/UDP, host resources), this Western Digital Mycloud EX2 Ultra profile adds the metrics below. Each is collected **only where the device exposes the matching OID** — inclusion means the profile requests it; availability depends on the device model and software.
