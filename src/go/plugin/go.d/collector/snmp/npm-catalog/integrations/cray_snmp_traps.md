<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cray_snmp_traps.md"
sidebar_label: "Cray SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cray, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cray devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cray-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cray-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cray SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Cray devices with Netdata. The bundled Cray trap profile decodes 74 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Cray enterprise OID space, and decodes the varbinds using the bundled Cray trap profile. No per-trap configuration.
...
Traps from Cray devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **74 trap definitions** from Cray across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 4 · `alert` 4 · `crit` 5 · `warning` 42 · `notice` 19

**By category:** `state_change` 4 · `config_change` 3 · `diagnostic` 67
...
- `CRI-SERVER-MIB::domainChange`
- `CRI-SERVER-MIB::eddControl`
