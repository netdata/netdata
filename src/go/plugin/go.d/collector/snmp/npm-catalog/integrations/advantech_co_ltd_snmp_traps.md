<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/advantech_co_ltd_snmp_traps.md"
sidebar_label: "Advantech Co Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [advantech-co-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Advantech Co Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/advantech-co-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/advantech-co-ltd-snmp-traps"
-->
...
# Advantech Co Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Advantech Co Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Advantech Co Ltd devices with Netdata. The bundled Advantech Co Ltd trap profile decodes 3 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Advantech Co Ltd enterprise OID space, and decodes the varbinds using the bundled Advantech Co Ltd trap profile. No per-trap configuration.
...
Traps from Advantech Co Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **3 trap definitions** from Advantech Co Ltd across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
