<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/c_c_power_inc_snmp_traps.md"
sidebar_label: "C C Power Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [c-c-power-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from C C Power Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/c-c-power-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/c-c-power-inc-snmp-traps"
-->
...
# C C Power Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="C C Power Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from C C Power Inc devices with Netdata. The bundled C C Power Inc trap profile decodes 44 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the C C Power Inc enterprise OID space, and decodes the varbinds using the bundled C C Power Inc trap profile. No per-trap configuration.
...
Traps from C C Power Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **44 trap definitions** from C C Power Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 7 · `crit` 4 · `warning` 11 · `notice` 22

**By category:** `state_change` 7 · `diagnostic` 37
...
- `CCPOWER-MIB::breakerTrap`
- `CCPOWER-MIB::fuseTrap`
