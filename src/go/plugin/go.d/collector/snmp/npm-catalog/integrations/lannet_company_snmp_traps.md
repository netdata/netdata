<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/lannet_company_snmp_traps.md"
sidebar_label: "Lannet Company SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [lannet-company, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Lannet Company devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/lannet-company-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/lannet-company-snmp-traps"
-->
...
# Lannet Company SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Lannet Company SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Lannet Company devices with Netdata. The bundled Lannet Company trap profile decodes 69 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Lannet Company enterprise OID space, and decodes the varbinds using the bundled Lannet Company trap profile. No per-trap configuration.
...
Traps from Lannet Company devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **69 trap definitions** from Lannet Company across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 6 · `warning` 29 · `notice` 32

**By category:** `state_change` 32 · `config_change` 2 · `security` 10 · `auth` 3 · `license` 2 · `diagnostic` 20

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `Lannet-Trapsv2-MIB` | 69 |
