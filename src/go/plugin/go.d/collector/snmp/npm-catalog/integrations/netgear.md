<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/netgear.md"
sidebar_label: "Netgear"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/Device Metrics/Integrations"
keywords: [netgear, snmp, network device, npm]
description: "Monitor Netgear (network device) with Netdata over SNMP."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/device-metrics/integrations/netgear"
slug: "/network-performance-monitoring/device-metrics/integrations/netgear"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Netgear"/>
...
Monitor Netgear (network device) with Netdata over SNMP. Netdata recognizes the device automatically by its `sysObjectID` (recognized across 1 device identifiers) and collects the metrics this profile declares — on top of the generic SNMP baseline — with no manual OID configuration.

Netdata's SNMP collector matches the device to the **netgear.yaml** profile via `sysObjectID`/`sysDescr`, then polls the OIDs it declares.
...
Auto-detected as Netgear via sysObjectID/sysDescr.
