<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/seagate_technology_snmp_traps.md"
sidebar_label: "Seagate Technology SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [seagate-technology, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Seagate Technology devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/seagate-technology-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/seagate-technology-snmp-traps"
-->
...
# Seagate Technology SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Seagate Technology SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Seagate Technology devices with Netdata. The bundled Seagate Technology trap profile decodes 5 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Seagate Technology enterprise OID space, and decodes the varbinds using the bundled Seagate Technology trap profile. No per-trap configuration.
...
Traps from Seagate Technology devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Seagate Technology across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `err` 1 · `warning` 1 · `info` 2
...
|:----|----:|
| `SEAGATESYSTEMTRAP-MIB` | 5 |

### Sample decoded traps

- `SEAGATESYSTEMTRAP-MIB::seagateEventInfoTrap`
- `SEAGATESYSTEMTRAP-MIB::seagateEventWarningTrap`
