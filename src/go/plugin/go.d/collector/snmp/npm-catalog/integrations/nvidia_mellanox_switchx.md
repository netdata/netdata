<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nvidia_mellanox_switchx.md"
sidebar_label: "Nvidia Mellanox Switchx"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/Device Metrics/Integrations"
keywords: [nvidia, mellanox, switchx, snmp, switch, npm]
description: "Monitor Nvidia Mellanox Switchx (switch) with Netdata over SNMP."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/device-metrics/integrations/nvidia-mellanox-switchx"
slug: "/network-performance-monitoring/device-metrics/integrations/nvidia-mellanox-switchx"
-->
...
# Nvidia Mellanox Switchx


<img src="https://netdata.cloud/img/nvidia.svg" width="150" alt="Nvidia Mellanox Switchx"/>
...
Monitor Nvidia Mellanox Switchx (switch) with Netdata over SNMP. Netdata recognizes the device automatically by its `sysObjectID` (recognized across 54 device identifiers) and collects the metrics this profile declares — on top of the generic SNMP baseline — with no manual OID configuration.

Netdata's SNMP collector matches the device to the **nvidia-mellanox-switchx.yaml** profile via `sysObjectID`/`sysDescr`, then polls the OIDs it declares.
...
Auto-detected as Nvidia Mellanox Switchx via sysObjectID/sysDescr.
...
On top of the **generic SNMP baseline** (the *Generic SNMP Device* integration — interfaces, system, IP/TCP/UDP, host resources), this Nvidia Mellanox Switchx profile adds the metrics below. Each is collected **only where the device exposes the matching OID** — inclusion means the profile requests it; availability depends on the device model and software.

**12 metrics** in 6 groups; each row is a chart context usable in alerts.
