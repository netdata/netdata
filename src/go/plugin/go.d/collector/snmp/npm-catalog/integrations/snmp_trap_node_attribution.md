...
description: "Attribute each trap to the right Netdata node. When enrichment resolves the trap source to an unambiguous vnode, the trap and any profile metrics attach to…"
