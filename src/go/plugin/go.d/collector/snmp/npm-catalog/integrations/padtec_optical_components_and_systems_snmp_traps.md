<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/padtec_optical_components_and_systems_snmp_traps.md"
sidebar_label: "Padtec Optical Components And Systems SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [padtec-optical-components-and-systems, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Padtec Optical Components And Systems devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/padtec-optical-components-and-systems-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/padtec-optical-components-and-systems-snmp-traps"
-->
...
# Padtec Optical Components And Systems SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Padtec Optical Components And Systems SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Padtec Optical Components And Systems devices with Netdata. The bundled Padtec Optical Components And Systems trap profile decodes 12 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Padtec Optical Components And Systems enterprise OID space, and decodes the varbinds using the bundled Padtec Optical Components And Systems trap profile. No per-trap configuration.
...
Traps from Padtec Optical Components And Systems devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **12 trap definitions** from Padtec Optical Components And Systems across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 3 · `notice` 7 · `info` 2

**By category:** `state_change` 3 · `diagnostic` 9
