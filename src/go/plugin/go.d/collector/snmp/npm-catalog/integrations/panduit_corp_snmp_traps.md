<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/panduit_corp_snmp_traps.md"
sidebar_label: "Panduit Corp SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [panduit-corp, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Panduit Corp devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/panduit-corp-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/panduit-corp-snmp-traps"
-->
...
# Panduit Corp SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Panduit Corp SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Panduit Corp devices with Netdata. The bundled Panduit Corp trap profile decodes 10 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Panduit Corp enterprise OID space, and decodes the varbinds using the bundled Panduit Corp trap profile. No per-trap configuration.
...
Traps from Panduit Corp devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Panduit Corp across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 2 · `warning` 2 · `notice` 3 · `info` 3
...
- `PANDUIT-OLD-MIB::trapCritical`
- `PANDUIT-OLD-MIB::trapWarning`
