<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/comet_system_s_r_o_snmp_traps.md"
sidebar_label: "Comet System S R O SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [comet-system-s-r-o, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Comet System S R O devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/comet-system-s-r-o-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/comet-system-s-r-o-snmp-traps"
-->
...
# Comet System S R O SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Comet System S R O SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Comet System S R O devices with Netdata. The bundled Comet System S R O trap profile decodes 39 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Comet System S R O enterprise OID space, and decodes the varbinds using the bundled Comet System S R O trap profile. No per-trap configuration.
...
Traps from Comet System S R O devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **39 trap definitions** from Comet System S R O across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `err` 3 · `warning` 24 · `notice` 12

**By category:** `state_change` 5 · `security` 1 · `diagnostic` 33
