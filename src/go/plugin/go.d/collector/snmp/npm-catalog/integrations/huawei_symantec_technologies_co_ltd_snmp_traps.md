<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/huawei_symantec_technologies_co_ltd_snmp_traps.md"
sidebar_label: "Huawei Symantec Technologies Co Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [huawei-symantec-technologies-co-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Huawei Symantec Technologies Co Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/huawei-symantec-technologies-co-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/huawei-symantec-technologies-co-ltd-snmp-traps"
-->
...
# Huawei Symantec Technologies Co Ltd SNMP Traps


<img src="https://netdata.cloud/img/huawei.svg" width="150" alt="Huawei Symantec Technologies Co Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Huawei Symantec Technologies Co Ltd devices with Netdata. The bundled Huawei Symantec Technologies Co Ltd trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Huawei Symantec Technologies Co Ltd enterprise OID space, and decodes the varbinds using the bundled Huawei Symantec Technologies Co Ltd trap profile. No per-trap configuration.
...
Traps from Huawei Symantec Technologies Co Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Huawei Symantec Technologies Co Ltd across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
