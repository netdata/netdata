<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/giganet_ltd_snmp_traps.md"
sidebar_label: "Giganet Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [giganet-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Giganet Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/giganet-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/giganet-ltd-snmp-traps"
-->
...
# Giganet Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Giganet Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Giganet Ltd devices with Netdata. The bundled Giganet Ltd trap profile decodes 251 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Giganet Ltd enterprise OID space, and decodes the varbinds using the bundled Giganet Ltd trap profile. No per-trap configuration.
...
Traps from Giganet Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **251 trap definitions** from Giganet Ltd across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 23 · `crit` 25 · `err` 7 · `warning` 77 · `notice` 109 · `info` 10

**By category:** `state_change` 65 · `config_change` 6 · `security` 1 · `license` 2 · `diagnostic` 177
...
- `CERAGON-MIB::gnODUTrap`
- `CERAGON-MIB::gnIDUTrap`
