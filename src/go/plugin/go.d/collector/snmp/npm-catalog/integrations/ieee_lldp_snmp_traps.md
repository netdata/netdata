<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/ieee_lldp_snmp_traps.md"
sidebar_label: "Ieee Lldp SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [ieee-lldp, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Ieee Lldp devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/ieee-lldp-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/ieee-lldp-snmp-traps"
-->
...
# Ieee Lldp SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Ieee Lldp SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Ieee Lldp devices with Netdata. The bundled Ieee Lldp trap profile decodes 13 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Ieee Lldp enterprise OID space, and decodes the varbinds using the bundled Ieee Lldp trap profile. No per-trap configuration.
...
Traps from Ieee Lldp devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **13 trap definitions** from Ieee Lldp across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 9 · `notice` 4

**By category:** `state_change` 10 · `diagnostic` 3

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `LLDP-EXT-DCBX-MIB` | 10 |
| `IEEE802171-CFM-MIB` | 1 |
| `LLDP-EXT-MED-MIB` | 1 |
| `LLDP-MIB` | 1 |
