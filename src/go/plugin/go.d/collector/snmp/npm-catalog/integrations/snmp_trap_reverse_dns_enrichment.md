...
description: "Annotate each trap with the reverse-DNS (PTR) name of its source IP, emitted as TRAPREVERSEDNS, so traps from raw IP addresses become readable by hostname."
