<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/net_track_gmbh_snmp_traps.md"
sidebar_label: "Net Track GmbH SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [net-track-gmbh, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Net Track GmbH devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/net-track-gmbh-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/net-track-gmbh-snmp-traps"
-->
...
# Net Track GmbH SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Net Track GmbH SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Net Track GmbH devices with Netdata. The bundled Net Track GmbH trap profile decodes 20 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Net Track GmbH enterprise OID space, and decodes the varbinds using the bundled Net Track GmbH trap profile. No per-trap configuration.
...
Traps from Net Track GmbH devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **20 trap definitions** from Net Track GmbH across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 8 · `warning` 8 · `notice` 4

**By category:** `diagnostic` 20

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `NETTRACK-E3METER-SNMP-MIB` | 19 |
| `NETTRACK-E3METER-CTR-SNMP-MIB` | 1 |

### Sample decoded traps

- `NETTRACK-E3METER-SNMP-MIB::e3IpmCurrentCritLow`
- `NETTRACK-E3METER-SNMP-MIB::e3IpmCurrentWarnLow`
