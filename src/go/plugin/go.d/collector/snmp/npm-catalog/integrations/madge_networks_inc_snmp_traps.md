<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/madge_networks_inc_snmp_traps.md"
sidebar_label: "Madge Networks Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [madge-networks-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Madge Networks Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/madge-networks-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/madge-networks-inc-snmp-traps"
-->
...
# Madge Networks Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Madge Networks Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Madge Networks Inc devices with Netdata. The bundled Madge Networks Inc trap profile decodes 14 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Madge Networks Inc enterprise OID space, and decodes the varbinds using the bundled Madge Networks Inc trap profile. No per-trap configuration.
...
Traps from Madge Networks Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **14 trap definitions** from Madge Networks Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 3 · `warning` 7 · `notice` 4

**By category:** `state_change` 9 · `diagnostic` 5
...
- `MADGECAU-MIB::backupPathStateChange`
- `MADGECAU-MIB::backupPathStateUse`
