<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/dec_snmp_traps.md"
sidebar_label: "Dec SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [dec, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Dec devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/dec-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/dec-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Dec SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Dec devices with Netdata. The bundled Dec trap profile decodes 83 trap definitions across 7 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Dec enterprise OID space, and decodes the varbinds using the bundled Dec trap profile. No per-trap configuration.
...
Traps from Dec devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **83 trap definitions** from Dec across **7 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 15 · `warning` 39 · `notice` 27 · `info` 1

**By category:** `state_change` 27 · `config_change` 2 · `auth` 1 · `diagnostic` 53
...
| `RAIDMANAGER-MIB` | 22 |
| `DECHUB90-MIB` | 8 |
| `GIGAswitchEthernet-MIB` | 6 |
| `TRUCLUSTER-SERVER-MIB` | 4 |
| `DECHUB900-HUBMGR-MIB-V3-0` | 2 |
| `SVRCLU-MIB` | 2 |

### Sample decoded traps

- `DECHUB90-MIB::consolePasswordFailure`
- `DECHUB90-MIB::nonVolatileRamError`
