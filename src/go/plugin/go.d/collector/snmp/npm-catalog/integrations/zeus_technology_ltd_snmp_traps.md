<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/zeus_technology_ltd_snmp_traps.md"
sidebar_label: "Zeus Technology Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [zeus-technology-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Zeus Technology Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/zeus-technology-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/zeus-technology-ltd-snmp-traps"
-->
...
# Zeus Technology Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Zeus Technology Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Zeus Technology Ltd devices with Netdata. The bundled Zeus Technology Ltd trap profile decodes 266 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Zeus Technology Ltd enterprise OID space, and decodes the varbinds using the bundled Zeus Technology Ltd trap profile. No per-trap configuration.
...
Traps from Zeus Technology Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **266 trap definitions** from Zeus Technology Ltd across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 26 · `crit` 26 · `err` 37 · `warning` 113 · `notice` 57 · `info` 7

**By category:** `state_change` 54 · `config_change` 17 · `security` 12 · `auth` 1 · `license` 36 · `mobility` 1 · `diagnostic` 145
