<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cambium_networks_limited_formerly_pipinghot_networks_limited_snmp_traps.md"
sidebar_label: "Cambium Networks Limited Formerly Pipinghot Networks Limited SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [cambium-networks-limited-formerly-pipinghot-networks-limited, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Cambium Networks Limited Formerly Pipinghot Networks Limited devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/cambium-networks-limited-formerly-pipinghot-networks-limited-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/cambium-networks-limited-formerly-pipinghot-networks-limited-snmp-traps"
-->
...
# Cambium Networks Limited Formerly Pipinghot Networks Limited SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Cambium Networks Limited Formerly Pipinghot Networks Limited SNMP Traps"/>
...
- `CANOPY-SYS-MIB::dfsChannelChangeTrap`
- `CANOPY-SYS-MIB::dfsImpulsiveInterferenceDetectedTrap`
