<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/streamcore_snmp_traps.md"
sidebar_label: "Streamcore SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [streamcore, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Streamcore devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/streamcore-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/streamcore-snmp-traps"
-->
...
# Streamcore SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Streamcore SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Streamcore devices with Netdata. The bundled Streamcore trap profile decodes 49 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Streamcore enterprise OID space, and decodes the varbinds using the bundled Streamcore trap profile. No per-trap configuration.
...
Traps from Streamcore devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **49 trap definitions** from Streamcore across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 41 · `notice` 6 · `info` 1

**By category:** `state_change` 14 · `security` 1 · `diagnostic` 34
...
- `STREAMCORE-MIB::scLoadTooHigh`
- `STREAMCORE-MIB::scTotalNumberRulesExceeded`
