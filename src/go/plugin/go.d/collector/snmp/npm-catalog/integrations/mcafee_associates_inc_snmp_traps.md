<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/mcafee_associates_inc_snmp_traps.md"
sidebar_label: "Mcafee Associates Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [mcafee-associates-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Mcafee Associates Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/mcafee-associates-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/mcafee-associates-inc-snmp-traps"
-->
...
# Mcafee Associates Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Mcafee Associates Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Mcafee Associates Inc devices with Netdata. The bundled Mcafee Associates Inc trap profile decodes 3 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Mcafee Associates Inc enterprise OID space, and decodes the varbinds using the bundled Mcafee Associates Inc trap profile. No per-trap configuration.
...
Traps from Mcafee Associates Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **3 trap definitions** from Mcafee Associates Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
