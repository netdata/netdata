<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/barix_ag_snmp_traps.md"
sidebar_label: "Barix AG SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [barix-ag, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Barix AG devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/barix-ag-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/barix-ag-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Barix AG SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Barix AG devices with Netdata. The bundled Barix AG trap profile decodes 10 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Barix AG enterprise OID space, and decodes the varbinds using the bundled Barix AG trap profile. No per-trap configuration.
...
Traps from Barix AG devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Barix AG across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 3 · `notice` 5 · `info` 1
...
|:----|----:|
| `BARIX-ABCL-TRAPS-MIB` | 9 |
| `BARIONET-MIB` | 1 |

### Sample decoded traps

- `BARIONET-MIB::digitalInputNotification`
- `BARIX-ABCL-TRAPS-MIB::keepalive`
