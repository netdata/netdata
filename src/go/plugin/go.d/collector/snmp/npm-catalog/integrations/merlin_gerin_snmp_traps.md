<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/merlin_gerin_snmp_traps.md"
sidebar_label: "Merlin Gerin SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [merlin-gerin, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Merlin Gerin devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/merlin-gerin-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/merlin-gerin-snmp-traps"
-->
...
# Merlin Gerin SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Merlin Gerin SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Merlin Gerin devices with Netdata. The bundled Merlin Gerin trap profile decodes 68 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Merlin Gerin enterprise OID space, and decodes the varbinds using the bundled Merlin Gerin trap profile. No per-trap configuration.
...
Traps from Merlin Gerin devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **68 trap definitions** from Merlin Gerin across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 4 · `crit` 1 · `warning` 24 · `notice` 37 · `info` 2

**By category:** `state_change` 36 · `diagnostic` 32
...
- `MG-SNMP-UPS-MIB::upsmgBatteryFault`
- `MG-SNMP-UPS-MIB::upsmgBatteryOK`
