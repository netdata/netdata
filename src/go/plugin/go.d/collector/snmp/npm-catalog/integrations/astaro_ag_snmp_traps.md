<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/astaro_ag_snmp_traps.md"
sidebar_label: "Astaro AG SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [astaro-ag, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Astaro AG devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/astaro-ag-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/astaro-ag-snmp-traps"
-->
...
# Astaro AG SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Astaro AG SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Astaro AG devices with Netdata. The bundled Astaro AG trap profile decodes 159 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Astaro AG enterprise OID space, and decodes the varbinds using the bundled Astaro AG trap profile. No per-trap configuration.
...
Traps from Astaro AG devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **159 trap definitions** from Astaro AG across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 1 · `alert` 10 · `crit` 11 · `err` 3 · `warning` 91 · `notice` 31 · `info` 12

**By category:** `state_change` 23 · `config_change` 3 · `security` 12 · `auth` 6 · `license` 8 · `diagnostic` 106 · `unknown` 1
