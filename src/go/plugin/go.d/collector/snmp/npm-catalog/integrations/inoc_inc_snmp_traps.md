<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/inoc_inc_snmp_traps.md"
sidebar_label: "Inoc Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [inoc-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Inoc Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/inoc-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/inoc-inc-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Inoc Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Inoc Inc devices with Netdata. The bundled Inoc Inc trap profile decodes 7 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Inoc Inc enterprise OID space, and decodes the varbinds using the bundled Inoc Inc trap profile. No per-trap configuration.
...
Traps from Inoc Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Inoc Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 5 · `notice` 2

**By category:** `state_change` 4 · `config_change` 1 · `diagnostic` 2

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SONICWALL-SSL-TRAN-MIB` | 4 |
| `SONICWALL-SSL-DEV-MIB` | 3 |

### Sample decoded traps

- `SONICWALL-SSL-DEV-MIB::cpuUtilChangeHi`
- `SONICWALL-SSL-DEV-MIB::cpuUtilChangeLo`
