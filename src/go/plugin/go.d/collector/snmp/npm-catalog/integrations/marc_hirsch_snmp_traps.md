<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/marc_hirsch_snmp_traps.md"
sidebar_label: "Marc Hirsch SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [marc-hirsch, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Marc Hirsch devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/marc-hirsch-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/marc-hirsch-snmp-traps"
-->
...
# Marc Hirsch SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Marc Hirsch SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Marc Hirsch devices with Netdata. The bundled Marc Hirsch trap profile decodes 498 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Marc Hirsch enterprise OID space, and decodes the varbinds using the bundled Marc Hirsch trap profile. No per-trap configuration.
...
Traps from Marc Hirsch devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **498 trap definitions** from Marc Hirsch across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 1 · `alert` 98 · `crit` 94 · `err` 1 · `warning` 279 · `notice` 25

**By category:** `state_change` 23 · `config_change` 6 · `security` 13 · `diagnostic` 456
...
- `CPS6000-MIB::cps6000TrapDc1Amj`
- `CPS6000-MIB::cps6000TrapDc1Epo`
