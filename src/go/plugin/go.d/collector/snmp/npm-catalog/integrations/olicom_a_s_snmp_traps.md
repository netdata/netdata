<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/olicom_a_s_snmp_traps.md"
sidebar_label: "Olicom A S SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [olicom-a-s, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Olicom A S devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/olicom-a-s-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/olicom-a-s-snmp-traps"
-->
...
# Olicom A S SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Olicom A S SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Olicom A S devices with Netdata. The bundled Olicom A S trap profile decodes 17 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Olicom A S enterprise OID space, and decodes the varbinds using the bundled Olicom A S trap profile. No per-trap configuration.
...
Traps from Olicom A S devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **17 trap definitions** from Olicom A S across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 2 · `warning` 11 · `notice` 3

**By category:** `state_change` 4 · `diagnostic` 13

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `Olicom-crossfireAtmSwitch-MIB` | 15 |
| `Olicom-MIB` | 2 |

### Sample decoded traps

- `Olicom-MIB::obmCallback`
- `Olicom-MIB::obmCallout`
