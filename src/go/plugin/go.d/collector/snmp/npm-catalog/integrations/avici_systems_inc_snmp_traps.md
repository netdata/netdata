<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/avici_systems_inc_snmp_traps.md"
sidebar_label: "Avici Systems Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [avici-systems-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Avici Systems Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/avici-systems-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/avici-systems-inc-snmp-traps"
-->
...
# Avici Systems Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Avici Systems Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Avici Systems Inc devices with Netdata. The bundled Avici Systems Inc trap profile decodes 31 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Avici Systems Inc enterprise OID space, and decodes the varbinds using the bundled Avici Systems Inc trap profile. No per-trap configuration.
...
Traps from Avici Systems Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **31 trap definitions** from Avici Systems Inc across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `crit` 7 · `warning` 12 · `notice` 9

**By category:** `state_change` 9 · `config_change` 2 · `diagnostic` 20
