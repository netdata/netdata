<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nice_systems_ltd_snmp_traps.md"
sidebar_label: "Nice Systems Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [nice-systems-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Nice Systems Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/nice-systems-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/nice-systems-ltd-snmp-traps"
-->
...
# Nice Systems Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Nice Systems Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Nice Systems Ltd devices with Netdata. The bundled Nice Systems Ltd trap profile decodes 350 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Nice Systems Ltd enterprise OID space, and decodes the varbinds using the bundled Nice Systems Ltd trap profile. No per-trap configuration.
...
Traps from Nice Systems Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **350 trap definitions** from Nice Systems Ltd across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 8 · `crit` 109 · `err` 33 · `warning` 126 · `notice` 46 · `info` 28

**By category:** `state_change` 30 · `config_change` 7 · `security` 1 · `diagnostic` 312
...
- `Nice-MIB-II::clsRcmIsDown`
- `Nice-MIB-II::clsRcmIsUp`
