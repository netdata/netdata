...
description: "Monitor APC PDU (pdu) with Netdata over SNMP. Netdata recognizes the device automatically by its sysObjectID (recognized across 4 device identifiers) and…"
