<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/acksys_snmp_traps.md"
sidebar_label: "Acksys SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [acksys, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Acksys devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/acksys-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/acksys-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Acksys SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Acksys devices with Netdata. The bundled Acksys trap profile decodes 10 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Acksys enterprise OID space, and decodes the varbinds using the bundled Acksys trap profile. No per-trap configuration.
...
Traps from Acksys devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **10 trap definitions** from Acksys across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 7 · `notice` 3

**By category:** `state_change` 3 · `security` 1 · `mobility` 1 · `diagnostic` 5
...
- `ACKSYS-MIB::linkAlarm`
- `ACKSYS-MIB::powerAlarm`
