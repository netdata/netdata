<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/net_insight_ab_snmp_traps.md"
sidebar_label: "Net Insight AB SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [net-insight-ab, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Net Insight AB devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/net-insight-ab-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/net-insight-ab-snmp-traps"
-->
...
# Net Insight AB SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Net Insight AB SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Net Insight AB devices with Netdata. The bundled Net Insight AB trap profile decodes 8 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Net Insight AB enterprise OID space, and decodes the varbinds using the bundled Net Insight AB trap profile. No per-trap configuration.
...
Traps from Net Insight AB devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Net Insight AB across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
- `NETI-EVT-MIB::nevtAlarmCritical`
- `NETI-EVT-MIB::nevtAlarmMajor`
