<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/aware_inc_snmp_traps.md"
sidebar_label: "Aware Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [aware-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Aware Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/aware-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/aware-inc-snmp-traps"
-->
...
# Aware Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Aware Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Aware Inc devices with Netdata. The bundled Aware Inc trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Aware Inc enterprise OID space, and decodes the varbinds using the bundled Aware Inc trap profile. No per-trap configuration.
...
Traps from Aware Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Aware Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
