<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/uk_mod_de_s_snmp_traps.md"
sidebar_label: "UK Mod De S SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [uk-mod-de-s, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from UK Mod De S devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/uk-mod-de-s-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/uk-mod-de-s-snmp-traps"
-->
...
# UK Mod De S SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="UK Mod De S SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from UK Mod De S devices with Netdata. The bundled UK Mod De S trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the UK Mod De S enterprise OID space, and decodes the varbinds using the bundled UK Mod De S trap profile. No per-trap configuration.
...
Traps from UK Mod De S devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from UK Mod De S across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `err` 1 · `warning` 1
