<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/schneider_electric_apc_netbotz_snmp_traps.md"
sidebar_label: "Schneider Electric Apc Netbotz SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [schneider-electric-apc-netbotz, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Schneider Electric Apc Netbotz devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/schneider-electric-apc-netbotz-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/schneider-electric-apc-netbotz-snmp-traps"
-->
...
# Schneider Electric Apc Netbotz SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Schneider Electric Apc Netbotz SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Schneider Electric Apc Netbotz devices with Netdata. The bundled Schneider Electric Apc Netbotz trap profile decodes 172 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Schneider Electric Apc Netbotz enterprise OID space, and decodes the varbinds using the bundled Schneider Electric Apc Netbotz trap profile. No per-trap configuration.
...
Traps from Schneider Electric Apc Netbotz devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **172 trap definitions** from Schneider Electric Apc Netbotz across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `err` 2 · `warning` 86 · `notice` 83

**By category:** `state_change` 20 · `security` 9 · `auth` 1 · `diagnostic` 142
