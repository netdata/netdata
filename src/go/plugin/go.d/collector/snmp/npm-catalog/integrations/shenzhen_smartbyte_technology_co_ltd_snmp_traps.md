<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/shenzhen_smartbyte_technology_co_ltd_snmp_traps.md"
sidebar_label: "Shenzhen Smartbyte Technology Co Ltd SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [shenzhen-smartbyte-technology-co-ltd, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Shenzhen Smartbyte Technology Co Ltd devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/shenzhen-smartbyte-technology-co-ltd-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/shenzhen-smartbyte-technology-co-ltd-snmp-traps"
-->
...
# Shenzhen Smartbyte Technology Co Ltd SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Shenzhen Smartbyte Technology Co Ltd SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Shenzhen Smartbyte Technology Co Ltd devices with Netdata. The bundled Shenzhen Smartbyte Technology Co Ltd trap profile decodes 6 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Shenzhen Smartbyte Technology Co Ltd enterprise OID space, and decodes the varbinds using the bundled Shenzhen Smartbyte Technology Co Ltd trap profile. No per-trap configuration.
...
Traps from Shenzhen Smartbyte Technology Co Ltd devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **6 trap definitions** from Shenzhen Smartbyte Technology Co Ltd across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 3 · `notice` 2

**By category:** `diagnostic` 6
