<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/deliberant_snmp_traps.md"
sidebar_label: "Deliberant SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [deliberant, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Deliberant devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/deliberant-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/deliberant-snmp-traps"
-->
...
# Deliberant SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Deliberant SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Deliberant devices with Netdata. The bundled Deliberant trap profile decodes 9 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Deliberant enterprise OID space, and decodes the varbinds using the bundled Deliberant trap profile. No per-trap configuration.
...
Traps from Deliberant devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **9 trap definitions** from Deliberant across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `warning` 4 · `notice` 4

**By category:** `state_change` 4 · `mobility` 2 · `diagnostic` 3

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `DLB-802DOT11-EXT-MIB` | 5 |
| `DLB-GENERIC-MIB` | 2 |
| `DLB-RADIO3-DRV-MIB` | 2 |

### Sample decoded traps

- `DLB-GENERIC-MIB::dlbPowerLoss`
- `DLB-GENERIC-MIB::dlbAdministrativeReboot`
