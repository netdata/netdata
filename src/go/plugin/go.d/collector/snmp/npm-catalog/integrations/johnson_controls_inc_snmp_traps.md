<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/johnson_controls_inc_snmp_traps.md"
sidebar_label: "Johnson Controls Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [johnson-controls-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Johnson Controls Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/johnson-controls-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/johnson-controls-inc-snmp-traps"
-->
...
# Johnson Controls Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Johnson Controls Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Johnson Controls Inc devices with Netdata. The bundled Johnson Controls Inc trap profile decodes 93 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Johnson Controls Inc enterprise OID space, and decodes the varbinds using the bundled Johnson Controls Inc trap profile. No per-trap configuration.
...
Traps from Johnson Controls Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **93 trap definitions** from Johnson Controls Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 49 · `notice` 44

**By category:** `state_change` 55 · `security` 7 · `diagnostic` 31
...
- `JCImSeries-MIB::n1HvacActiveConditionalEvent`
- `JCImSeries-MIB::n1HvacInactiveConditionalEvent`
