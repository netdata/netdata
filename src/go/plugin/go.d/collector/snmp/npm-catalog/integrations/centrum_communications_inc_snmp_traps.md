<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/centrum_communications_inc_snmp_traps.md"
sidebar_label: "Centrum Communications Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [centrum-communications-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Centrum Communications Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/centrum-communications-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/centrum-communications-inc-snmp-traps"
-->
...
# Centrum Communications Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Centrum Communications Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Centrum Communications Inc devices with Netdata. The bundled Centrum Communications Inc trap profile decodes 3 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Centrum Communications Inc enterprise OID space, and decodes the varbinds using the bundled Centrum Communications Inc trap profile. No per-trap configuration.
...
Traps from Centrum Communications Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **3 trap definitions** from Centrum Communications Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `notice` 3
