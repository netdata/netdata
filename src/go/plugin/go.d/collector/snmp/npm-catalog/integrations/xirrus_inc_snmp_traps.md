<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/xirrus_inc_snmp_traps.md"
sidebar_label: "Xirrus Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [xirrus-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Xirrus Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/xirrus-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/xirrus-inc-snmp-traps"
-->
...
# Xirrus Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Xirrus Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Xirrus Inc devices with Netdata. The bundled Xirrus Inc trap profile decodes 26 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Xirrus Inc enterprise OID space, and decodes the varbinds using the bundled Xirrus Inc trap profile. No per-trap configuration.
...
Traps from Xirrus Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **26 trap definitions** from Xirrus Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 2 · `err` 1 · `warning` 12 · `notice` 8 · `info` 1

**By category:** `state_change` 3 · `config_change` 2 · `security` 3 · `auth` 3 · `license` 1 · `diagnostic` 14
...
- `XIRRUS-MIB::adminLogin`
- `XIRRUS-MIB::adminLogout`
