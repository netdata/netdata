<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nokia_service_router_os.md"
sidebar_label: "Nokia Service Router OS"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/Device Metrics/Integrations"
keywords: [nokia, service, router, os, snmp, router, npm]
description: "Monitor Nokia Service Router OS (router) with Netdata over SNMP."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/device-metrics/integrations/nokia-service-router-os"
slug: "/network-performance-monitoring/device-metrics/integrations/nokia-service-router-os"
-->
...
# Nokia Service Router OS


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Nokia Service Router OS"/>
...
Monitor Nokia Service Router OS (router) with Netdata over SNMP. Netdata recognizes the device automatically by its `sysObjectID` (recognized across 1 device identifiers) and collects the metrics this profile declares — on top of the generic SNMP baseline — with no manual OID configuration.

Netdata's SNMP collector matches the device to the **nokia-service-router-os.yaml** profile via `sysObjectID`/`sysDescr`, then polls the OIDs it declares.
...
Auto-detected as Nokia Service Router OS via sysObjectID/sysDescr.
...
On top of the **generic SNMP baseline** (the *Generic SNMP Device* integration — interfaces, system, IP/TCP/UDP, host resources), this Nokia Service Router OS profile adds the metrics below. Each is collected **only where the device exposes the matching OID** — inclusion means the profile requests it; availability depends on the device model and software.
