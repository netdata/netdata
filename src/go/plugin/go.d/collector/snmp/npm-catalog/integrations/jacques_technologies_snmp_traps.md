<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/jacques_technologies_snmp_traps.md"
sidebar_label: "Jacques Technologies SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [jacques-technologies, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Jacques Technologies devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/jacques-technologies-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/jacques-technologies-snmp-traps"
-->
...
# Jacques Technologies SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Jacques Technologies SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Jacques Technologies devices with Netdata. The bundled Jacques Technologies trap profile decodes 4 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Jacques Technologies enterprise OID space, and decodes the varbinds using the bundled Jacques Technologies trap profile. No per-trap configuration.
...
Traps from Jacques Technologies devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from Jacques Technologies across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 1 · `notice` 3
...
- `JACQUES-650-MIB::jacquesJccpserverUpNotify`
