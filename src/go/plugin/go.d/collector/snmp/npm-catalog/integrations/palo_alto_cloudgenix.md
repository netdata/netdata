<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/palo_alto_cloudgenix.md"
sidebar_label: "Palo Alto Cloudgenix"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/Device Metrics/Integrations"
keywords: [palo, alto, cloudgenix, snmp, sd-wan, npm]
description: "Monitor Palo Alto Cloudgenix (sd-wan) with Netdata over SNMP."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/device-metrics/integrations/palo-alto-cloudgenix"
slug: "/network-performance-monitoring/device-metrics/integrations/palo-alto-cloudgenix"
-->
...
<img src="https://netdata.cloud/img/paloalto.png" width="150" alt="Palo Alto Cloudgenix"/>
...
Monitor Palo Alto Cloudgenix (sd-wan) with Netdata over SNMP. Netdata recognizes the device automatically by its `sysObjectID` (recognized across 6 device identifiers) and collects the metrics this profile declares — on top of the generic SNMP baseline — with no manual OID configuration.

Netdata's SNMP collector matches the device to the **palo-alto-cloudgenix.yaml** profile via `sysObjectID`/`sysDescr`, then polls the OIDs it declares.
...
Auto-detected as Palo Alto Cloudgenix via sysObjectID/sysDescr.
...
On top of the **generic SNMP baseline** (the *Generic SNMP Device* integration — interfaces, system, IP/TCP/UDP, host resources), this Palo Alto Cloudgenix profile adds the metrics below. Each is collected **only where the device exposes the matching OID** — inclusion means the profile requests it; availability depends on the device model and software.
