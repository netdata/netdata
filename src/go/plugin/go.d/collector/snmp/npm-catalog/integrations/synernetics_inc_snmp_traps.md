<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/synernetics_inc_snmp_traps.md"
sidebar_label: "Synernetics Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [synernetics-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Synernetics Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/synernetics-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/synernetics-inc-snmp-traps"
-->
...
# Synernetics Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Synernetics Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Synernetics Inc devices with Netdata. The bundled Synernetics Inc trap profile decodes 27 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Synernetics Inc enterprise OID space, and decodes the varbinds using the bundled Synernetics Inc trap profile. No per-trap configuration.
...
Traps from Synernetics Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **27 trap definitions** from Synernetics Inc across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 4 · `warning` 13 · `notice` 9

**By category:** `state_change` 11 · `security` 2 · `diagnostic` 14

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `LANPLEX-OPT-FDDI-MIB-1-1-2` | 11 |
| `LANPLEX-SYSTEMS-MIB-1-2-2` | 7 |
| `LANPLEX-MIB-1-2-9` | 6 |
| `SWITCHING-SYSTEMS-MIB` | 3 |

### Sample decoded traps

- `LANPLEX-MIB-1-2-9::lpSlotInsertEvent`
- `LANPLEX-MIB-1-2-9::lpSlotExtractEvent`
