<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/meru_networks_snmp_traps.md"
sidebar_label: "Meru Networks SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [meru-networks, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Meru Networks devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/meru-networks-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/meru-networks-snmp-traps"
-->
...
# Meru Networks SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Meru Networks SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Meru Networks devices with Netdata. The bundled Meru Networks trap profile decodes 102 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Meru Networks enterprise OID space, and decodes the varbinds using the bundled Meru Networks trap profile. No per-trap configuration.
...
Traps from Meru Networks devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **102 trap definitions** from Meru Networks across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 10 · `crit` 8 · `warning` 37 · `notice` 47

**By category:** `state_change` 24 · `config_change` 4 · `security` 8 · `auth` 2 · `license` 9 · `mobility` 6 · `diagnostic` 49
...
- `MERU-WLAN-MIB::mwlTopoStaAtsAdd`
- `MERU-WLAN-MIB::mwlTopoStaAtsRemove`
