<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/shasta_networks_snmp_traps.md"
sidebar_label: "Shasta Networks SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [shasta-networks, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Shasta Networks devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/shasta-networks-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/shasta-networks-snmp-traps"
-->
...
# Shasta Networks SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Shasta Networks SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Shasta Networks devices with Netdata. The bundled Shasta Networks trap profile decodes 11 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Shasta Networks enterprise OID space, and decodes the varbinds using the bundled Shasta Networks trap profile. No per-trap configuration.
...
Traps from Shasta Networks devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **11 trap definitions** from Shasta Networks across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 2 · `warning` 9

**By category:** `diagnostic` 11

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SSG-5000-CHASSIS-MIB` | 11 |

### Sample decoded traps

- `SSG-5000-CHASSIS-MIB::ssg5000ChassisFailureNotification`
- `SSG-5000-CHASSIS-MIB::ssg5000SysAlarmNotification`
