<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/infoblox_inc_snmp_traps.md"
sidebar_label: "Infoblox Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [infoblox-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Infoblox Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/infoblox-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/infoblox-inc-snmp-traps"
-->
...
# Infoblox Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Infoblox Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Infoblox Inc devices with Netdata. The bundled Infoblox Inc trap profile decodes 7 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Infoblox Inc enterprise OID space, and decodes the varbinds using the bundled Infoblox Inc trap profile. No per-trap configuration.
...
Traps from Infoblox Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Infoblox Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `err` 1 · `warning` 4 · `notice` 1

**By category:** `state_change` 2 · `license` 1 · `diagnostic` 4
