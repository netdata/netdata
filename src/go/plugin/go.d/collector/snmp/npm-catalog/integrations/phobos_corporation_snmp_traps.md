<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/phobos_corporation_snmp_traps.md"
sidebar_label: "Phobos Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [phobos-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Phobos Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/phobos-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/phobos-corporation-snmp-traps"
-->
...
# Phobos Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Phobos Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Phobos Corporation devices with Netdata. The bundled Phobos Corporation trap profile decodes 7 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Phobos Corporation enterprise OID space, and decodes the varbinds using the bundled Phobos Corporation trap profile. No per-trap configuration.
...
Traps from Phobos Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Phobos Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
- `SONICWALL-SSL-MIB::cpuUtilChangeHi`
- `SONICWALL-SSL-MIB::cpuUtilChangeLo`
