<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/microchip_technology_inc_snmp_traps.md"
sidebar_label: "Microchip Technology Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [microchip-technology-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Microchip Technology Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/microchip-technology-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/microchip-technology-inc-snmp-traps"
-->
...
# Microchip Technology Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Microchip Technology Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Microchip Technology Inc devices with Netdata. The bundled Microchip Technology Inc trap profile decodes 5 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Microchip Technology Inc enterprise OID space, and decodes the varbinds using the bundled Microchip Technology Inc trap profile. No per-trap configuration.
...
Traps from Microchip Technology Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Microchip Technology Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
|:----|----:|
| `CONTROLBOX-TH332-MIB` | 3 |
| `ServersCheck` | 2 |

### Sample decoded traps

- `ServersCheck::sensorAlert`
- `ServersCheck::iosensorAlert`
