<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/microwave_networks_incorporated_snmp_traps.md"
sidebar_label: "Microwave Networks Incorporated SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [microwave-networks-incorporated, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Microwave Networks Incorporated devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/microwave-networks-incorporated-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/microwave-networks-incorporated-snmp-traps"
-->
...
# Microwave Networks Incorporated SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Microwave Networks Incorporated SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Microwave Networks Incorporated devices with Netdata. The bundled Microwave Networks Incorporated trap profile decodes 8 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Microwave Networks Incorporated enterprise OID space, and decodes the varbinds using the bundled Microwave Networks Incorporated trap profile. No per-trap configuration.
...
Traps from Microwave Networks Incorporated devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Microwave Networks Incorporated across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 2 · `warning` 4 · `notice` 2
...
|:----|----:|
| `MNI-PROTEUS-AMT-MIB` | 8 |

### Sample decoded traps

- `MNI-PROTEUS-AMT-MIB::mnPrNotificationMajorAlarmSet`
- `MNI-PROTEUS-AMT-MIB::mnPrNotificationAlarmClear`
