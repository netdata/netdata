<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/network_alchemy_inc_snmp_traps.md"
sidebar_label: "Network Alchemy Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [network-alchemy-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Network Alchemy Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/network-alchemy-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/network-alchemy-inc-snmp-traps"
-->
...
# Network Alchemy Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Network Alchemy Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Network Alchemy Inc devices with Netdata. The bundled Network Alchemy Inc trap profile decodes 4 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Network Alchemy Inc enterprise OID space, and decodes the varbinds using the bundled Network Alchemy Inc trap profile. No per-trap configuration.
...
Traps from Network Alchemy Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from Network Alchemy Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `notice` 3

**By category:** `state_change` 3 · `unknown` 1

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `NETWORK-ALCHEMY-CLUSTER-MIB` | 4 |

### Sample decoded traps

- `NETWORK-ALCHEMY-CLUSTER-MIB::netalTrap0`
