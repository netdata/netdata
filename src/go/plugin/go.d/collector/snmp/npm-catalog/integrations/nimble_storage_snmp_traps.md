<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nimble_storage_snmp_traps.md"
sidebar_label: "Nimble Storage SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [nimble-storage, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Nimble Storage devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/nimble-storage-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/nimble-storage-snmp-traps"
-->
...
# Nimble Storage SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Nimble Storage SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Nimble Storage devices with Netdata. The bundled Nimble Storage trap profile decodes 448 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Nimble Storage enterprise OID space, and decodes the varbinds using the bundled Nimble Storage trap profile. No per-trap configuration.
...
Traps from Nimble Storage devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **448 trap definitions** from Nimble Storage across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 8 · `crit` 95 · `err` 70 · `warning` 185 · `notice` 61 · `info` 29

**By category:** `state_change` 67 · `config_change` 19 · `security` 3 · `auth` 1 · `diagnostic` 358
...
- `NIMBLE-TRAP-MIB::nimbleDsdRedEntry0101Deprecated`
- `NIMBLE-TRAP-MIB::nimbleDsdSpaceRedExit`
