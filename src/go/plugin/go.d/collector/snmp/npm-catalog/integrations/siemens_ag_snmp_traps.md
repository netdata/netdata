<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/siemens_ag_snmp_traps.md"
sidebar_label: "Siemens AG SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [siemens-ag, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Siemens AG devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/siemens-ag-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/siemens-ag-snmp-traps"
-->
...
# Siemens AG SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Siemens AG SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Siemens AG devices with Netdata. The bundled Siemens AG trap profile decodes 93 trap definitions across 6 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Siemens AG enterprise OID space, and decodes the varbinds using the bundled Siemens AG trap profile. No per-trap configuration.
...
Traps from Siemens AG devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **93 trap definitions** from Siemens AG across **6 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `emerg` 1 · `crit` 4 · `warning` 43 · `notice` 42 · `info` 3

**By category:** `state_change` 39 · `config_change` 6 · `security` 10 · `auth` 1 · `mobility` 12 · `diagnostic` 24 · `unknown` 1

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SN-MSPS-SCX200-MIB` | 68 |
| `SN-MSPS-SCX-MIB` | 13 |
| `SIEMENS-HP4KHIM-MIB` | 6 |
| `HIPATH-WIRELESS-HWC-MIB` | 3 |
| `AUTOMATION-SYSTEM-MIB` | 2 |
| `HIPATH-WIRELESS-HIGUARD-MIB` | 1 |
