<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/netgear_switch.md"
sidebar_label: "Netgear Switch"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/Device Metrics/Integrations"
keywords: [netgear, switch, snmp, switch, npm]
description: "Monitor Netgear Switch (switch) with Netdata over SNMP."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/device-metrics/integrations/netgear-switch"
slug: "/network-performance-monitoring/device-metrics/integrations/netgear-switch"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Netgear Switch"/>
...
Monitor Netgear Switch (switch) with Netdata over SNMP. Netdata recognizes the device automatically by its `sysObjectID` (recognized across 6 device identifiers) and collects the metrics this profile declares — on top of the generic SNMP baseline — with no manual OID configuration.

Netdata's SNMP collector matches the device to the **netgear-switch.yaml** profile via `sysObjectID`/`sysDescr`, then polls the OIDs it declares.
...
Auto-detected as Netgear Switch via sysObjectID/sysDescr.
