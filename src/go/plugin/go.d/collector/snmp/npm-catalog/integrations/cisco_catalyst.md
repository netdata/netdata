<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/cisco_catalyst.md"
sidebar_label: "Cisco Catalyst"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/Device Metrics/Integrations"
keywords: [cisco, catalyst, snmp, switch, npm]
description: "Monitor Cisco Catalyst (switch) with Netdata over SNMP."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/device-metrics/integrations/cisco-catalyst"
slug: "/network-performance-monitoring/device-metrics/integrations/cisco-catalyst"
-->
...
<img src="https://netdata.cloud/img/cisco.svg" width="150" alt="Cisco Catalyst"/>
...
Monitor Cisco Catalyst (switch) with Netdata over SNMP. Netdata recognizes the device automatically by its `sysObjectID` (recognized across 448 device identifiers) and collects the metrics this profile declares — on top of the generic SNMP baseline — with no manual OID configuration.
...
**156 metrics** in 22 groups; each row is a chart context usable in alerts.
