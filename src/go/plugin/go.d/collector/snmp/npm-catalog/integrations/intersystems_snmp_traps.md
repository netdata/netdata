<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/intersystems_snmp_traps.md"
sidebar_label: "Intersystems SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [intersystems, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Intersystems devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/intersystems-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/intersystems-snmp-traps"
-->
...
# Intersystems SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Intersystems SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Intersystems devices with Netdata. The bundled Intersystems trap profile decodes 19 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Intersystems enterprise OID space, and decodes the varbinds using the bundled Intersystems trap profile. No per-trap configuration.
...
Traps from Intersystems devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **19 trap definitions** from Intersystems across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 6 · `crit` 4 · `err` 2 · `warning` 4 · `notice` 2 · `info` 1

**By category:** `state_change` 2 · `license` 1 · `diagnostic` 16
