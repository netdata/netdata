<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/clavister_ab_snmp_traps.md"
sidebar_label: "Clavister AB SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [clavister-ab, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Clavister AB devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/clavister-ab-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/clavister-ab-snmp-traps"
-->
...
# Clavister AB SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Clavister AB SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Clavister AB devices with Netdata. The bundled Clavister AB trap profile decodes 8 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Clavister AB enterprise OID space, and decodes the varbinds using the bundled Clavister AB trap profile. No per-trap configuration.
...
Traps from Clavister AB devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Clavister AB across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 3 · `warning` 2 · `notice` 3
...
|:----|----:|
| `CLAVISTER-STREAM-TRAPS-MIB` | 7 |
| `CLAVISTER-TRAPS-MIB` | 1 |

### Sample decoded traps

- `CLAVISTER-TRAPS-MIB::clavisterOSGenericTrap`
- `CLAVISTER-STREAM-TRAPS-MIB::ssmSnmpGenericTrap`
