<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/u_c_davis_ece_dept_tom_snmp_traps.md"
sidebar_label: "U C Davis Ece Dept Tom SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [u-c-davis-ece-dept-tom, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from U C Davis Ece Dept Tom devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/u-c-davis-ece-dept-tom-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/u-c-davis-ece-dept-tom-snmp-traps"
-->
...
# U C Davis Ece Dept Tom SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="U C Davis Ece Dept Tom SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from U C Davis Ece Dept Tom devices with Netdata. The bundled U C Davis Ece Dept Tom trap profile decodes 4 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the U C Davis Ece Dept Tom enterprise OID space, and decodes the varbinds using the bundled U C Davis Ece Dept Tom trap profile. No per-trap configuration.
...
Traps from U C Davis Ece Dept Tom devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from U C Davis Ece Dept Tom across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `notice` 2 · `info` 1

**By category:** `diagnostic` 2 · `unknown` 2
