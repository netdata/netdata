<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/adva_ag_optical_networking_snmp_traps.md"
sidebar_label: "Adva AG Optical Networking SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [adva-ag-optical-networking, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Adva AG Optical Networking devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/adva-ag-optical-networking-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/adva-ag-optical-networking-snmp-traps"
-->
...
# Adva AG Optical Networking SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Adva AG Optical Networking SNMP Traps"/>
...
| `ADVA-FSPR7-MIB` | 564 |
| `FspR7-MIB` | 551 |
| `ADVA-FSP3000ALM-MIB` | 111 |
| `METRO1500-MIB` | 80 |
| `FSP150-MIB` | 44 |
| `FspR7-LAYER2-MIB` | 40 |
| `CM-PERFORMANCE-MIB` | 24 |
| `FspR7-SPEQ-MIB` | 21 |
| `F3-PTP-MIB` | 14 |
| `ADVA-FSPR7-CFM-EXTENSION-MIB` | 11 |
| `F3-L3-MIB` | 11 |
| `CM-SYSTEM-MIB` | 7 |
| `F3-FPM-MIB` | 7 |
| `F3-SYNCJACK-MIB` | 6 |
| `CM-ALARM-MIB` | 4 |
| `F3-CONNECTGUARD-MIB` | 4 |
| `CM-SA-MIB` | 3 |
| `CM-SECURITY-MIB` | 2 |
| `AOS-CORE-ALARM-MIB` | 1 |
| `F3-EOMPLS-MIB` | 1 |
| `F3-NTP-MIB` | 1 |
| `F3-PWE3-MIB` | 1 |
| `F3-TWAMP-MIB` | 1 |
