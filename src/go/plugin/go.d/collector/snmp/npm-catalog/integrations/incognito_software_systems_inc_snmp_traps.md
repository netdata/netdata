<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/incognito_software_systems_inc_snmp_traps.md"
sidebar_label: "Incognito Software Systems Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [incognito-software-systems-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Incognito Software Systems Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/incognito-software-systems-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/incognito-software-systems-inc-snmp-traps"
-->
...
# Incognito Software Systems Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Incognito Software Systems Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Incognito Software Systems Inc devices with Netdata. The bundled Incognito Software Systems Inc trap profile decodes 39 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Incognito Software Systems Inc enterprise OID space, and decodes the varbinds using the bundled Incognito Software Systems Inc trap profile. No per-trap configuration.
...
Traps from Incognito Software Systems Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **39 trap definitions** from Incognito Software Systems Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `crit` 3 · `err` 1 · `warning` 17 · `notice` 15 · `info` 1

**By category:** `state_change` 16 · `config_change` 1 · `security` 4 · `license` 1 · `diagnostic` 17

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `INCOGNITO-EXPR-IPCOMMANDER-MIB` | 39 |
