...
description: "Monitor Isilon (storage) with Netdata over SNMP. Netdata recognizes the device automatically by its sysObjectID (recognized across 2 device identifiers) and…"
