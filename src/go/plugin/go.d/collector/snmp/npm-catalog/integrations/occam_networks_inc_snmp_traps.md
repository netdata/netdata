<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/occam_networks_inc_snmp_traps.md"
sidebar_label: "Occam Networks Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [occam-networks-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Occam Networks Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/occam-networks-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/occam-networks-inc-snmp-traps"
-->
...
# Occam Networks Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Occam Networks Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Occam Networks Inc devices with Netdata. The bundled Occam Networks Inc trap profile decodes 11 trap definitions across 3 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Occam Networks Inc enterprise OID space, and decodes the varbinds using the bundled Occam Networks Inc trap profile. No per-trap configuration.
...
Traps from Occam Networks Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **11 trap definitions** from Occam Networks Inc across **3 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 2 · `warning` 5 · `notice` 3 · `info` 1

**By category:** `state_change` 7 · `config_change` 1 · `diagnostic` 3
...
- `OCCAM-MLT-MIB::mltTestCompletedNotification`
