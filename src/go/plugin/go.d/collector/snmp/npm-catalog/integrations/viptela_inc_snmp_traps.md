<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/viptela_inc_snmp_traps.md"
sidebar_label: "Viptela Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [viptela-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Viptela Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/viptela-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/viptela-inc-snmp-traps"
-->
...
# Viptela Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Viptela Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Viptela Inc devices with Netdata. The bundled Viptela Inc trap profile decodes 110 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Viptela Inc enterprise OID space, and decodes the varbinds using the bundled Viptela Inc trap profile. No per-trap configuration.
...
Traps from Viptela Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **110 trap definitions** from Viptela Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 8 · `crit` 6 · `warning` 35 · `notice` 60 · `info` 1

**By category:** `state_change` 50 · `config_change` 9 · `security` 21 · `auth` 4 · `mobility` 1 · `diagnostic` 25
...
- `VIPTELA-TRAPS::viptelaActionsSystemSoftwareInstallStatus`
- `VIPTELA-TRAPS::viptelaActionsSystemRebootIssued`
