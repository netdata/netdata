<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/better_networks_snmp_traps.md"
sidebar_label: "Better Networks SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [better-networks, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Better Networks devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/better-networks-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/better-networks-snmp-traps"
-->
...
# Better Networks SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Better Networks SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Better Networks devices with Netdata. The bundled Better Networks trap profile decodes 7 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Better Networks enterprise OID space, and decodes the varbinds using the bundled Better Networks trap profile. No per-trap configuration.
...
Traps from Better Networks devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **7 trap definitions** from Better Networks across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 4 · `notice` 3

**By category:** `state_change` 3 · `config_change` 1 · `diagnostic` 3

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `BETTER-NETWORKS-ETHERNETBOX-MIB` | 7 |

### Sample decoded traps

- `BETTER-NETWORKS-ETHERNETBOX-MIB::sensorstatusChangeToLow`
- `BETTER-NETWORKS-ETHERNETBOX-MIB::sensorstatusChangeToNormal`
