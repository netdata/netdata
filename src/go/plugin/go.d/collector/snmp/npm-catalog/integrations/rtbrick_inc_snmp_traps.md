<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/rtbrick_inc_snmp_traps.md"
sidebar_label: "Rtbrick Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [rtbrick-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Rtbrick Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/rtbrick-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/rtbrick-inc-snmp-traps"
-->
...
# Rtbrick Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Rtbrick Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Rtbrick Inc devices with Netdata. The bundled Rtbrick Inc trap profile decodes 1 trap definition across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Rtbrick Inc enterprise OID space, and decodes the varbinds using the bundled Rtbrick Inc trap profile. No per-trap configuration.
...
Traps from Rtbrick Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **1 trap definition** from Rtbrick Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
|:----|----:|
| `RTBRICK-SYSLOG-MIB` | 1 |

### Sample decoded traps

- `RTBRICK-SYSLOG-MIB::rtbrickSyslogTrap`
