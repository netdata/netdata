<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/nsi_software_snmp_traps.md"
sidebar_label: "Nsi Software SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [nsi-software, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Nsi Software devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/nsi-software-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/nsi-software-snmp-traps"
-->
...
# Nsi Software SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Nsi Software SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Nsi Software devices with Netdata. The bundled Nsi Software trap profile decodes 40 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Nsi Software enterprise OID space, and decodes the varbinds using the bundled Nsi Software trap profile. No per-trap configuration.
...
Traps from Nsi Software devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **40 trap definitions** from Nsi Software across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 8 · `crit` 1 · `err` 1 · `warning` 9 · `notice` 17 · `info` 4

**By category:** `state_change` 25 · `config_change` 1 · `security` 2 · `license` 1 · `diagnostic` 11
...
- `DTMIB::dttrapKernelStarted`
- `DTMIB::dttrapKernelStopped`
