<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/an_d_cz_snmp_traps.md"
sidebar_label: "An D Cz SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [an-d-cz, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from An D Cz devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/an-d-cz-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/an-d-cz-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="An D Cz SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from An D Cz devices with Netdata. The bundled An D Cz trap profile decodes 15 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the An D Cz enterprise OID space, and decodes the varbinds using the bundled An D Cz trap profile. No per-trap configuration.
...
Traps from An D Cz devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **15 trap definitions** from An D Cz across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 10 · `notice` 4 · `info` 1
...
- `IMCO-LS110-MIB::opto1-trap`
- `IMCO-LS110-MIB::opto2-trap`
