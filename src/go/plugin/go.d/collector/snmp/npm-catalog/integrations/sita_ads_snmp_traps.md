<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/sita_ads_snmp_traps.md"
sidebar_label: "Sita Ads SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [sita-ads, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Sita Ads devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/sita-ads-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/sita-ads-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Sita Ads SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Sita Ads devices with Netdata. The bundled Sita Ads trap profile decodes 12 trap definitions across 5 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Sita Ads enterprise OID space, and decodes the varbinds using the bundled Sita Ads trap profile. No per-trap configuration.
...
Traps from Sita Ads devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **12 trap definitions** from Sita Ads across **5 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 6 · `notice` 6

**By category:** `state_change` 6 · `config_change` 1 · `diagnostic` 5
