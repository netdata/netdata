<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/teltonika_snmp_traps.md"
sidebar_label: "Teltonika SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [teltonika, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Teltonika devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/teltonika-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/teltonika-snmp-traps"
-->
...
# Teltonika SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Teltonika SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Teltonika devices with Netdata. The bundled Teltonika trap profile decodes 19 trap definitions across 4 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Teltonika enterprise OID space, and decodes the varbinds using the bundled Teltonika trap profile. No per-trap configuration.
...
Traps from Teltonika devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **19 trap definitions** from Teltonika across **4 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 1 · `notice` 16 · `info` 2

**By category:** `state_change` 12 · `mobility` 2 · `diagnostic` 5
...
| `TELTONIKA-MIB` | 6 |
| `TELTONIKA-OLD-MIB` | 6 |
| `TELTONIKA-RUTX-MIB` | 4 |
| `TELTONIKA-OTD-MIB` | 3 |

### Sample decoded traps

- `TELTONIKA-MIB::trapSignalStrength`
- `TELTONIKA-RUTX-MIB::signalChangeNotification`
