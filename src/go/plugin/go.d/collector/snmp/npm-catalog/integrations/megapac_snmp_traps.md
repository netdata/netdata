<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/megapac_snmp_traps.md"
sidebar_label: "Megapac SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [megapac, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Megapac devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/megapac-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/megapac-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Megapac SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Megapac devices with Netdata. The bundled Megapac trap profile decodes 28 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Megapac enterprise OID space, and decodes the varbinds using the bundled Megapac trap profile. No per-trap configuration.
...
Traps from Megapac devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **28 trap definitions** from Megapac across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 4 · `err` 3 · `warning` 13 · `notice` 7

**By category:** `state_change` 6 · `config_change` 1 · `diagnostic` 21
...
- `SATELCOM-MIB::errorLogReport`
- `SATELCOM-MIB::sysRestart`
