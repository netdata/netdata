<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/lantronix_snmp_traps.md"
sidebar_label: "Lantronix SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [lantronix, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Lantronix devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/lantronix-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/lantronix-snmp-traps"
-->
...
# Lantronix SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Lantronix SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Lantronix devices with Netdata. The bundled Lantronix trap profile decodes 32 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Lantronix enterprise OID space, and decodes the varbinds using the bundled Lantronix trap profile. No per-trap configuration.
...
Traps from Lantronix devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **32 trap definitions** from Lantronix across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 1 · `warning` 21 · `notice` 7 · `info` 2

**By category:** `state_change` 4 · `config_change` 2 · `diagnostic` 26

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `LANTRONIX-SLC-MIB` | 19 |
| `SLP1-MIB` | 13 |

### Sample decoded traps

- `LANTRONIX-SLC-MIB::slcEventPowerSupply`
- `LANTRONIX-SLC-MIB::slcEventSysadminPassword`
