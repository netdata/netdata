<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/ap_nederland_b.v._snmp_traps.md"
sidebar_label: "Ap Nederland B.V. SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [ap-nederland-bv, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Ap Nederland B.V."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/ap-nederland-b.v.-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/ap-nederland-b.v.-snmp-traps"
-->
...
# Ap Nederland B.V. SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Ap Nederland B.V. SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Ap Nederland B.V. devices with Netdata. The bundled Ap Nederland B.V. trap profile decodes 5 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Ap Nederland B.V. enterprise OID space, and decodes the varbinds using the bundled Ap Nederland B.V. trap profile. No per-trap configuration.
...
Traps from Ap Nederland B.V. devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **5 trap definitions** from Ap Nederland B.V. across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
|:----|----:|
| `APNL-MODULAR-PDU-MIB` | 5 |

### Sample decoded traps

- `APNL-MODULAR-PDU-MIB::pduVoltageAlarm`
- `APNL-MODULAR-PDU-MIB::pduCurrentAlarm`
