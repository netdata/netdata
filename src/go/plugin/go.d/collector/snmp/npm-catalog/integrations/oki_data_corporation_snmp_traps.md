<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/oki_data_corporation_snmp_traps.md"
sidebar_label: "Oki Data Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [oki-data-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Oki Data Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/oki-data-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/oki-data-corporation-snmp-traps"
-->
...
# Oki Data Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Oki Data Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Oki Data Corporation devices with Netdata. The bundled Oki Data Corporation trap profile decodes 8 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Oki Data Corporation enterprise OID space, and decodes the varbinds using the bundled Oki Data Corporation trap profile. No per-trap configuration.
...
Traps from Oki Data Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Oki Data Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 7 · `notice` 1
...
- `OKIDATA-MIB::trapPrinterOnline`
- `OKIDATA-MIB::trapPrinterOffline`
