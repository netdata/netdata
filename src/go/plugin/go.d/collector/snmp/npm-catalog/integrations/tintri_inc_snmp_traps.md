<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/tintri_inc_snmp_traps.md"
sidebar_label: "Tintri Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [tintri-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Tintri Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/tintri-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/tintri-inc-snmp-traps"
-->
...
# Tintri Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Tintri Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Tintri Inc devices with Netdata. The bundled Tintri Inc trap profile decodes 156 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Tintri Inc enterprise OID space, and decodes the varbinds using the bundled Tintri Inc trap profile. No per-trap configuration.
...
Traps from Tintri Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **156 trap definitions** from Tintri Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 13 · `crit` 62 · `err` 15 · `warning` 48 · `notice` 18

**By category:** `state_change` 26 · `config_change` 3 · `security` 11 · `auth` 4 · `license` 6 · `diagnostic` 106
...
- `VMSTORE-MIB::diskRAIDFailed`
- `VMSTORE-MIB::outOfSpace`
