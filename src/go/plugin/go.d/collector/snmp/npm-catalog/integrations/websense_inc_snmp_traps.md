<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/websense_inc_snmp_traps.md"
sidebar_label: "Websense Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [websense-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Websense Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/websense-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/websense-inc-snmp-traps"
-->
...
# Websense Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Websense Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Websense Inc devices with Netdata. The bundled Websense Inc trap profile decodes 46 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Websense Inc enterprise OID space, and decodes the varbinds using the bundled Websense Inc trap profile. No per-trap configuration.
...
Traps from Websense Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **46 trap definitions** from Websense Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `crit` 3 · `warning` 18 · `notice` 23 · `info` 1

**By category:** `state_change` 4 · `config_change` 2 · `security` 2 · `diagnostic` 38

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `WBSN-APPLIANCE-MIB` | 46 |

### Sample decoded traps

- `WBSN-APPLIANCE-MIB::testEvent`
- `WBSN-APPLIANCE-MIB::cpuMaxUsageExceed`
