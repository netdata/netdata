<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/teldat_s_a_snmp_traps.md"
sidebar_label: "Teldat S A SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [teldat-s-a, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Teldat S A devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/teldat-s-a-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/teldat-s-a-snmp-traps"
-->
...
# Teldat S A SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Teldat S A SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Teldat S A devices with Netdata. The bundled Teldat S A trap profile decodes 4 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Teldat S A enterprise OID space, and decodes the varbinds using the bundled Teldat S A trap profile. No per-trap configuration.
...
Traps from Teldat S A devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **4 trap definitions** from Teldat S A across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
