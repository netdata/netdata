<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/sinetica_snmp_traps.md"
sidebar_label: "Sinetica SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [sinetica, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Sinetica devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/sinetica-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/sinetica-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Sinetica SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Sinetica devices with Netdata. The bundled Sinetica trap profile decodes 72 trap definitions across 7 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Sinetica enterprise OID space, and decodes the varbinds using the bundled Sinetica trap profile. No per-trap configuration.
...
Traps from Sinetica devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **72 trap definitions** from Sinetica across **7 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 41 · `notice` 30

**By category:** `state_change` 25 · `diagnostic` 47
...
|:----|----:|
| `NETCOM-MIB` | 20 |
| `RMS-COMPACT-SNMPv1-CONTACT-MIB` | 16 |
| `RMS-COMPACT-SNMPv1-HUMID1-MIB` | 8 |
| `RMS-COMPACT-SNMPv1-HUMID2-MIB` | 8 |
| `RMS-COMPACT-SNMPv1-MAIN-MIB` | 8 |
| `RMS-COMPACT-SNMPv1-OUTPUT-MIB` | 8 |
| `HAWK-I2-MIB` | 4 |

### Sample decoded traps

- `NETCOM-MIB::netcomLowHumidity`
- `NETCOM-MIB::netcomHighHumidity`
