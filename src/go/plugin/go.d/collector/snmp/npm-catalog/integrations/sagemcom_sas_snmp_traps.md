<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/sagemcom_sas_snmp_traps.md"
sidebar_label: "Sagemcom Sas SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [sagemcom-sas, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Sagemcom Sas devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/sagemcom-sas-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/sagemcom-sas-snmp-traps"
-->
...
# Sagemcom Sas SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Sagemcom Sas SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Sagemcom Sas devices with Netdata. The bundled Sagemcom Sas trap profile decodes 3 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Sagemcom Sas enterprise OID space, and decodes the varbinds using the bundled Sagemcom Sas trap profile. No per-trap configuration.
...
Traps from Sagemcom Sas devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **3 trap definitions** from Sagemcom Sas across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
