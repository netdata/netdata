<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/skyhigh_security_llc_snmp_traps.md"
sidebar_label: "Skyhigh Security LLC SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [skyhigh-security-llc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Skyhigh Security LLC devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/skyhigh-security-llc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/skyhigh-security-llc-snmp-traps"
-->
...
# Skyhigh Security LLC SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Skyhigh Security LLC SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Skyhigh Security LLC devices with Netdata. The bundled Skyhigh Security LLC trap profile decodes 3 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Skyhigh Security LLC enterprise OID space, and decodes the varbinds using the bundled Skyhigh Security LLC trap profile. No per-trap configuration.
...
Traps from Skyhigh Security LLC devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **3 trap definitions** from Skyhigh Security LLC across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 2 · `notice` 1

**By category:** `security` 1 · `diagnostic` 2

### Coverage by MIB

| MIB | Trap definitions |
|:----|----:|
| `SKYHIGHSECURITY-SWG-MIB` | 3 |
