<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/atto_technology_inc_snmp_traps.md"
sidebar_label: "Atto Technology Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [atto-technology-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Atto Technology Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/atto-technology-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/atto-technology-inc-snmp-traps"
-->
...
# Atto Technology Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Atto Technology Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Atto Technology Inc devices with Netdata. The bundled Atto Technology Inc trap profile decodes 8 trap definitions across 2 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Atto Technology Inc enterprise OID space, and decodes the varbinds using the bundled Atto Technology Inc trap profile. No per-trap configuration.
...
Traps from Atto Technology Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **8 trap definitions** from Atto Technology Inc across **2 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 5 · `notice` 3

**By category:** `state_change` 3 · `diagnostic` 5
...
- `ATTOBRIDGE-MIB::bridgeTempStatusChanged`
- `ATTOBRIDGE-MIB::bridgeVoltageStatusChanged`
