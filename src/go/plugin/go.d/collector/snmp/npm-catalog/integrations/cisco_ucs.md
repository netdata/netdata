...
description: "Monitor Cisco UCS (ucs) with Netdata over SNMP. Netdata recognizes the device automatically by its sysObjectID (recognized across 4 device identifiers) and…"
