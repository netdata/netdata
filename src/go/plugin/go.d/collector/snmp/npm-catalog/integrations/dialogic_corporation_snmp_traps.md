<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/dialogic_corporation_snmp_traps.md"
sidebar_label: "Dialogic Corporation SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [dialogic-corporation, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Dialogic Corporation devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/dialogic-corporation-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/dialogic-corporation-snmp-traps"
-->
...
# Dialogic Corporation SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Dialogic Corporation SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Dialogic Corporation devices with Netdata. The bundled Dialogic Corporation trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Dialogic Corporation enterprise OID space, and decodes the varbinds using the bundled Dialogic Corporation trap profile. No per-trap configuration.
...
Traps from Dialogic Corporation devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Dialogic Corporation across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `notice` 1
