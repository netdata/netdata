<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/sgte_ies_snmp_traps.md"
sidebar_label: "Sgte Ies SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [sgte-ies, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Sgte Ies devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/sgte-ies-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/sgte-ies-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Sgte Ies SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Sgte Ies devices with Netdata. The bundled Sgte Ies trap profile decodes 31 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Sgte Ies enterprise OID space, and decodes the varbinds using the bundled Sgte Ies trap profile. No per-trap configuration.
...
Traps from Sgte Ies devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **31 trap definitions** from Sgte Ies across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 4 · `crit` 3 · `err` 1 · `warning` 17 · `notice` 6

**By category:** `state_change` 2 · `config_change` 2 · `diagnostic` 26 · `unknown` 1
...
- `SGTE-MIB::aModifHeure`
- `SGTE-MIB::aModifParam`
