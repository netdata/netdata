<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/rogue_engineering_inc_snmp_traps.md"
sidebar_label: "Rogue Engineering Inc SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [rogue-engineering-inc, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Rogue Engineering Inc devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/rogue-engineering-inc-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/rogue-engineering-inc-snmp-traps"
-->
...
# Rogue Engineering Inc SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Rogue Engineering Inc SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Rogue Engineering Inc devices with Netdata. The bundled Rogue Engineering Inc trap profile decodes 2 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Rogue Engineering Inc enterprise OID space, and decodes the varbinds using the bundled Rogue Engineering Inc trap profile. No per-trap configuration.
...
Traps from Rogue Engineering Inc devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **2 trap definitions** from Rogue Engineering Inc across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.
...
|:----|----:|
| `Rogue-Engineering-Inc-Sentinel-Remote-IO-with-SNMP` | 2 |
