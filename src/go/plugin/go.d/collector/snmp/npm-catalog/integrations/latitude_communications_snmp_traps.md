<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/latitude_communications_snmp_traps.md"
sidebar_label: "Latitude Communications SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [latitude-communications, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Latitude Communications devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/latitude-communications-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/latitude-communications-snmp-traps"
-->
...
# Latitude Communications SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Latitude Communications SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Latitude Communications devices with Netdata. The bundled Latitude Communications trap profile decodes 6 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Latitude Communications enterprise OID space, and decodes the varbinds using the bundled Latitude Communications trap profile. No per-trap configuration.
...
Traps from Latitude Communications devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **6 trap definitions** from Latitude Communications across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 3 · `warning` 3
