...
description: "Monitor APC UPS (ups) with Netdata over SNMP. Netdata recognizes the device automatically by its sysObjectID (recognized across 15 device identifiers) and…"
