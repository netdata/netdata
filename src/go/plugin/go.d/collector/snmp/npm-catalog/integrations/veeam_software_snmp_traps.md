<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/veeam_software_snmp_traps.md"
sidebar_label: "Veeam Software SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [veeam-software, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Veeam Software devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/veeam-software-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/veeam-software-snmp-traps"
-->
...
# Veeam Software SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Veeam Software SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Veeam Software devices with Netdata. The bundled Veeam Software trap profile decodes 16 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Veeam Software enterprise OID space, and decodes the varbinds using the bundled Veeam Software trap profile. No per-trap configuration.
...
Traps from Veeam Software devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **16 trap definitions** from Veeam Software across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `warning` 1 · `notice` 7 · `info` 8

**By category:** `state_change` 9 · `config_change` 1 · `diagnostic` 6
...
- `VEEAM-MIB::onBackupJobCompleted`
- `VEEAM-MIB::onVmBackupCompleted`
