<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/netquest_corp_snmp_traps.md"
sidebar_label: "Netquest Corp SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [netquest-corp, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Netquest Corp devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/netquest-corp-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/netquest-corp-snmp-traps"
-->
...
# Netquest Corp SNMP Traps


<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Netquest Corp SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Netquest Corp devices with Netdata. The bundled Netquest Corp trap profile decodes 33 trap definitions across 1 MIB into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Netquest Corp enterprise OID space, and decodes the varbinds using the bundled Netquest Corp trap profile. No per-trap configuration.
...
Traps from Netquest Corp devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **33 trap definitions** from Netquest Corp across **1 MIB** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `alert` 1 · `err` 1 · `warning` 21 · `notice` 10

**By category:** `state_change` 19 · `diagnostic` 14
...
- `LINK-PROBE-MIB::pvcNotAvailDCE`
- `LINK-PROBE-MIB::pvcNotAvailDTE`
