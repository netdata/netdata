<!--
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/go/plugin/go.d/collector/snmp/npm-catalog/integrations/motorola_snmp_traps.md"
sidebar_label: "Motorola SNMP Traps"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps/Integrations"
keywords: [motorola, snmp, trap, traps, inform, notification, npm]
description: "Receive, decode, and store SNMP traps and INFORMs from Motorola devices with Netdata."
...
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/integrations/motorola-snmp-traps"
slug: "/network-performance-monitoring/snmp-traps/integrations/motorola-snmp-traps"
-->
...
<img src="https://netdata.cloud/img/SNMP.png" width="150" alt="Motorola SNMP Traps"/>
...
Receive, decode, and store SNMP traps and INFORMs from Motorola devices with Netdata. The bundled Motorola trap profile decodes 34 trap definitions across 6 MIBs into structured journal events with named, typed varbinds — searchable and filterable in the Logs tab.

Netdata's SNMP trap listener receives traps on UDP/162, matches them to the Motorola enterprise OID space, and decodes the varbinds using the bundled Motorola trap profile. No per-trap configuration.
...
Traps from Motorola devices are decoded automatically once the device is pointed at the Agent's trap listener.
...
Netdata decodes **34 trap definitions** from Motorola across **6 MIBs** into structured journal events. A trap is decoded **only if the device actually sends it**; inclusion here means the profile can decode it.

**By severity:** `crit` 1 · `warning` 12 · `notice` 19 · `info` 2

**By category:** `state_change` 20 · `security` 1 · `license` 1 · `diagnostic` 12
...
|:----|----:|
| `WHISP-APS-MIB` | 13 |
| `WHISP-PLV-GATEWAY-MIB` | 6 |
| `WHISP-SM-MIB` | 6 |
| `WHISP-PLV-MODEM-MIB` | 4 |
| `WHISP-BOX-MIBV2-MIB` | 3 |
| `CMM4-MIB` | 2 |
