...
The **vernemq** collector can be configured directly through the Netdata web interface:

1. Go to **Nodes**.
2. Select the node **where you want the vernemq data-collection job to run** and click the :gear: (**Configure this node**). This node will be responsible for collecting metrics.
