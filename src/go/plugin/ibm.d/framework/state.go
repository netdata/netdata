...
func (s *CollectorState) GetInstance(ctx any, labels any) *Instance {
...
func (s *CollectorState) SetMetricsForGeneratedCode(ctx any, labels any, values map[string]int64) {
...
func (s *CollectorState) SetUpdateEveryOverrideForGeneratedCode(ctx any, labels any, updateEvery int) {
...
// Use the type-safe Set() methods on generated context types instead.
func (s *CollectorState) set(ctx any, labels any, values map[string]int64) {
	instance := s.GetInstance(ctx, labels)
...
func extractContextName(ctx any) string {
...
func structToMap(labels any) map[string]string {
...
func getContextMetadata(ctx any) *ContextMetadata {
...
func extractContextMetadata(ctx any) *ContextMetadata {
	v := reflect.ValueOf(ctx)
	if v.Kind() == reflect.Pointer {
		v = v.Elem()
	}
...
func (s *CollectorState) Debugf(format string, args ...any) {
	if s.collector != nil {
...
func (s *CollectorState) Warningf(format string, args ...any) {
	if s.collector != nil {
...
func (s *CollectorState) Errorf(format string, args ...any) {
	if s.collector != nil {
...
func (s *CollectorState) Infof(format string, args ...any) {
	if s.collector != nil {
