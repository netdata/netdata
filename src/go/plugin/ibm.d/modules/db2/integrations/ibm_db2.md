...
description: "Monitors IBM DB2 databases using system catalog views and MONGET table functions to expose connections, locking, buffer pool efficiency, tablespace capacity…"
keywords: ['db2']
