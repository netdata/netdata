...
const (
	...
	queryMonGetTransactionLog = `
		SELECT 
			LOG_USED_TOP_KB * 1024 as TOTAL_LOG_USED,
			TOTAL_LOG_AVAILABLE_KB * 1024 as TOTAL_LOG_AVAILABLE,
			CASE 
				WHEN TOTAL_LOG_AVAILABLE_KB > 0 
				THEN (LOG_USED_TOP_KB * 100) / TOTAL_LOG_AVAILABLE_KB
				ELSE 0 
			END as LOG_UTILIZATION,
