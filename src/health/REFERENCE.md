...
- [Systemd mount unit failed state guide](/src/health/guides/systemdunits/systemd_mount_unit_failed_state.md) - Track mount unit states with the systemd units collector
- [Filecheck collector](/src/go/plugin/go.d/collector/filecheck/README.md) - Monitor for the presence/absence of expected mount directories
