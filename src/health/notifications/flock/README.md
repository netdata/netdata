...
description: "Send notifications to Flock using Netdata's Agent alert notification feature, which supports dozens of endpoints, user roles, and more."
keywords: ['Flock']
...
<img src="https://netdata.cloud/img/flock.png" width="150" alt="Flock"/>
...
- The incoming webhook URL as given by flock.com. You can use the same on all your Netdata servers (or you can have multiple if you like). Read more about flock webhooks and how to get one [here](https://support.flock.com/hc/en-us/articles/360006943354-Incoming-webhooks).
