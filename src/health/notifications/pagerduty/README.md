...
description: "PagerDuty is an enterprise incident resolution service that integrates with ITOps and DevOps monitoring stacks to improve operational reliability and agility."
keywords: ['PagerDuty']
...
<img src="https://netdata.cloud/img/pagerduty.png" width="150" alt="PagerDuty"/>
...
- [Add a new service](https://support.pagerduty.com/main/docs/services-and-integrations#create-a-service) to PagerDuty. Click Use our API directly and select either `Events API v2` or `Events API v1`. Once you finish creating the service, click on the Integrations tab to find your Integration Key.
