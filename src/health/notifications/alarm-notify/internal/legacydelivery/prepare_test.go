...
func TestPrepareSelection(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"unsupported alongside valid":   {config: []string{`DISCORD_WEBHOOK_URL=https://example.org; DEFAULT_RECIPIENT_DISCORD=channel; SEND_OPSGENIE=YES; OPSGENIE_API_KEY=synthetic-private-value`}, err: "legacy opsgenie"},
