...
The first nineteen implementation PRs cover the foundation, routing/fan-out, Slack app webhooks, Discord, Telegram, Pushover,
Pushbullet, Twilio, MessageBird, Gotify, ntfy, Rocket.Chat, Flock, Fleep, ilert, SIGNL4, Alerta, Dynatrace, Prowl, Kavenegar,
SMSEagle, PagerDuty, Opsgenie, Teams, Matrix, custom commands and SMS Server Tools 3. Windows command delivery remains
