...
| [`default memory mode`](#default-memory-mode) | `ram`   | The [database](/src/database/README.md) to use for all nodes using this `API_KEY`. Valid settings are `dbengine`, `ram`, or `none`. [Read more &rarr;](#default-memory-mode)                             |
...
| `default health log history`      | `5d`    | History of health log events (in seconds) kept in the database.                                                                                                                                          |
