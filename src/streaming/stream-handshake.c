...
static struct {
    ...
    {STREAM_HANDSHAKE_RCV_DISCONNECT_LOCAL_VNODE_CLAIMED, "DISCONNECTED LOCAL VNODE CLAIMED", 409}, // Conflict
    ...
    {STREAM_HANDSHAKE_DISCONNECT_BUFFER_OVERFLOW, "DISCONNECTED NOT SUFFICIENT SEND BUFFER", 413}, // Content Too Large
    ...
    {STREAM_HANDSHAKE_PARENT_VNODE_IS_LOCAL, "LOCAL VNODE", 101},
