...
typedef enum {
    ...
    STREAM_HANDSHAKE_DISCONNECT_NOT_SUFFICIENT_SENDER_READ_BUFFER = -23,
    STREAM_HANDSHAKE_DISCONNECT_NOT_SUFFICIENT_SENDER_SEND_BUFFER = -24,
    STREAM_HANDSHAKE_DISCONNECT_SOCKET_EOF = -25,
    STREAM_HANDSHAKE_DISCONNECT_SOCKET_READ_FAILED = -26,
    STREAM_HANDSHAKE_DISCONNECT_SOCKET_READ_TIMEOUT = -27,
    STREAM_HANDSHAKE_DISCONNECT_SOCKET_ERROR = -28,
    STREAM_HANDSHAKE_DISCONNECT_SOCKET_WRITE_FAILED = -29,
    STREAM_HANDSHAKE_DISCONNECT_SOCKET_CLOSED_BY_PARENT = -30,
    STREAM_HANDSHAKE_ERROR_HTTP_UPGRADE = -31,
    STREAM_HANDSHAKE_NO_HOST_IN_DESTINATION = -32,
    STREAM_HANDSHAKE_CONNECT_TIMEOUT = -33,
    STREAM_HANDSHAKE_CONNECTION_REFUSED = -34,
    STREAM_HANDSHAKE_CANT_RESOLVE_HOSTNAME = -35,
    STREAM_HANDSHAKE_PREPARING = -36,
    STREAM_HANDSHAKE_CONNECTING = -37,
    STREAM_HANDSHAKE_CONNECTED = -38,
    STREAM_HANDSHAKE_EXITING = -39,
    STREAM_HANDSHAKE_NO_STREAM_INFO = -40,
