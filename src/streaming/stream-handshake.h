...
typedef enum {
    ...
    STREAM_HANDSHAKE_NO_HOST_IN_DESTINATION = -28,
    STREAM_HANDSHAKE_CONNECT_TIMEOUT = -29,
    STREAM_HANDSHAKE_CONNECTION_REFUSED = -30,
    STREAM_HANDSHAKE_CANT_RESOLVE_HOSTNAME = -31,
    STREAM_HANDSHAKE_PREPARING = -32,
    STREAM_HANDSHAKE_CONNECTING = -33,
    STREAM_HANDSHAKE_CONNECTED = -34,
    STREAM_HANDSHAKE_EXITING = -35,
    STREAM_HANDSHAKE_NO_STREAM_INFO = -36,
