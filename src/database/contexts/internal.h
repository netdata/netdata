...
#define WORKER_JOB_HOSTS_CTX_METRICS     2
#define WORKER_JOB_HOSTS_RRD_METRICS     3
#define WORKER_JOB_CHECK                 4
#define WORKER_JOB_SEND                  5
#define WORKER_JOB_DEQUEUE               6
#define WORKER_JOB_RETENTION             7
#define WORKER_JOB_QUEUED                8
#define WORKER_JOB_CLEANUP               9
#define WORKER_JOB_CLEANUP_DELETE       10
#define WORKER_JOB_PP_METRIC            11 // post-processing metrics
#define WORKER_JOB_PP_INSTANCE          12 // post-processing instances
#define WORKER_JOB_PP_CONTEXT           13 // post-processing contexts
#define WORKER_JOB_HUB_QUEUE_SIZE       14
#define WORKER_JOB_PP_QUEUE_SIZE        15
