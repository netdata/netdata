        ...
        if (dbengine_contexts) {
...

            {
                ...
                if (unlikely(!st_ram_usage)) {
                    ...
                    rd_cached = rrddim_add(st_ram_usage, "cache", NULL, 1, 1024*1024, RRD_ALGORITHM_ABSOLUTE);
                    rd_pinned = rrddim_add(st_ram_usage, "collectors", NULL, 1, 1024*1024, RRD_ALGORITHM_ABSOLUTE);
                ...
                API_producers = (collected_number)stats_array[38];
                pages_on_disk = (collected_number)stats_array[2];
                populated_pages = (collected_number)stats_array[37];
