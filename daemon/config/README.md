...
|                 storage tiers                  |     `0`     | The number of storage tiers you want to have in your dbengine. Check the tiering mechanism in the [dbengine's reference](/database/engine/README.md#tiering). You can have up to 5 tiers of data. This numbers ranges between 1 and 4.                                                                                                                                                                                                                                                                                                                                                                                              |
...
| dbengine tier **_Xi+** update every iterations |    `60`     | The down sampling value of each tier from the previous one. For each Tier, the greater by one Tier has N (equal to 60 by default) less metric points of any metric it collects. (_i belongs to [1..4]_)                                                                                                                                                                                                                                                                                                                                                                                                                             |
