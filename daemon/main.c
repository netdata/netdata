...
static void log_init(void) {
    ...
    char *selected_level = config_get(CONFIG_SECTION_LOGS, "severity-level", NETDATA_LOG_LEVEL_ERROR_STR);
    use_severity_level = log_severity_string_to_severity_level(selected_level);
