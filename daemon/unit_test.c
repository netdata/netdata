                                    ...
                                    int current_region, time_t time_start, time_t time_end)
{
    ...
    fprintf(stderr, "%s() running on region %d, start time %"PRId64", end time %"PRId64", update every %d...\n", __FUNCTION__, current_region, time_start, time_end, update_every);
    uint8_t same;
                          ...
                          unsigned RAMP_UP_SECONDS, unsigned PAGE_CACHE_MB, unsigned DISK_SPACE_MB)
{
    ...
    if (!test_duration)
        test_duration = 1;
    fprintf(stderr, "\nDB-engine stress test finished in %"PRId64" seconds.\n", test_duration);
    ...
    fprintf(stderr, "Performance is %"PRIu64" written data points/sec and %"PRIu64" read data points/sec.\n",
