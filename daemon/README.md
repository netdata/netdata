...
The tags `FATAL` and `INFO` will always appear inside logs, while error can be hidden with option [severity level](https://github.com/netdata/netdata/tree/master/daemon/config#logs-section-options).
