...
It provides **unparalleled insights, in real-time (per second resolution)**, of everything
happening on the system it runs (including applications such as web and database servers),
