...
<p align="center">
  ...
  &nbsp;<br/>
  ...and due to your love :heart:, it is the 3rd most :star:'d project in the <a href="https://landscape.cncf.io/card-mode?grouping=no&sort=stars" target="_blank">CNCF landscape</a>!
</p>
...
### 2. **Configure Collectors** :boom:
   ...
   Netdata auto-detects and auto-discovers most operating system data sources and applications. However, many data sources require some [manual configuration](https://learn.netdata.cloud/docs/data-collection/collectors-configuration), usually to allow Netdata get access to the metrics.
...
### 4. **Connect your Parents to [Netdata Cloud](http://app.netdata.cloud/)** :cloud:
   ...
   Optionally, sign-up to Netdata Cloud and claim your Netdata Parents (check out the Netdata Cloud [live demo space](https://app.netdata.cloud/spaces/netdata-demo) - no login/sign-up required).
