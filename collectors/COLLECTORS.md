...
-   [systemd unit states](https://learn.netdata.cloud/docs/agent/collectors/go.d.plugin/modules/systemdunits): Get
    metrics on the states of services, sockets, devices, paths, and much more.
