# Netdata collectors support list
...
Check also [Third Party Plugins](../docs/third-party-plugins.md) for a list of plugins distributed by third parties.

## Available collectors for gathering metrics
