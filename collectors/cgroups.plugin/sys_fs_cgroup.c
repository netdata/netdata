...
void *cgroups_main(void *ptr) {
    ...
    rrd_function_add(localhost, NULL, "containers-vms", 10, RRDFUNCTIONS_CGTOP_HELP, "top", true, cgroup_function_cgroup_top, NULL);
    rrd_function_add(localhost, NULL, "systemd-services", 10, RRDFUNCTIONS_CGTOP_HELP, "top", true, cgroup_function_systemd_top, NULL);
