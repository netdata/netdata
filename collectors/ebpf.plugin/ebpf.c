...
ebpf_module_t ebpf_modules[] = {
    ...
    { .thread_name = "disk", .config_name = "disk", .thread_description = NETDATA_EBPF_DISK_MODULE_DESC,
      ...
      .kernels =  NETDATA_V3_10 | NETDATA_V4_14 | NETDATA_V4_16 | NETDATA_V4_18 | NETDATA_V5_4 | NETDATA_V5_14,
      .load = EBPF_LOAD_LEGACY, .targets = disk_targets, .probe_links = NULL, .objects = NULL,
      .thread = NULL, .maps_per_core = CONFIG_BOOLEAN_YES, .lifetime = EBPF_DEFAULT_LIFETIME, .running_time = 0},
    ...
    { .thread_name = "hardirq", .config_name = "hardirq", .thread_description = NETDATA_EBPF_HARDIRQ_MODULE_DESC,
      ...
      .kernels =  NETDATA_V3_10 | NETDATA_V4_14 | NETDATA_V4_16 | NETDATA_V4_18 | NETDATA_V5_4 | NETDATA_V5_14,
      .load = EBPF_LOAD_LEGACY, .targets = hardirq_targets, .probe_links = NULL, .objects = NULL,
      .thread = NULL, .maps_per_core = CONFIG_BOOLEAN_YES, .lifetime = EBPF_DEFAULT_LIFETIME, .running_time = 0},
...
ebpf_filesystem_partitions_t localfs[] =
    {
     {.filesystem = "ext4",
      ...
      .fs_maps = NULL,
      .fs_obj = NULL,
      .functions = { { .name = "ext4_file_read_iter", .mode = EBPF_LOAD_PROBE},
                     { .name = "ext4_file_write_iter", .mode = EBPF_LOAD_PROBE},
                     { .name = "ext4_file_open", .mode = EBPF_LOAD_PROBE},
                     { .name = "ext4_sync_file", .mode = EBPF_LOAD_PROBE},
     ...
     {.filesystem = "xfs",
      ...
      .fs_obj = NULL,
      .functions =
          {{.name = "xfs_file_read_iter", .mode = EBPF_LOAD_PROBE},
           {.name = "xfs_file_write_iter", .mode = EBPF_LOAD_PROBE},
           {.name = "xfs_file_open", .mode = EBPF_LOAD_PROBE},
           {.name = "xfs_file_fsync", .mode = EBPF_LOAD_PROBE},
           {.name = NULL, .mode = EBPF_LOAD_PROBE}}
     },
      {
          .filesystem = "nfs",
          ...
          .fs_obj = NULL,
          .functions =
              {{.name = "nfs_file_read", .mode = EBPF_LOAD_PROBE},
               {.name = "nfs_file_write", .mode = EBPF_LOAD_PROBE},
               {.name = "nfs_open", .mode = EBPF_LOAD_PROBE},
               {.name = "nfs_getattr", .mode = EBPF_LOAD_PROBE},
               {.name = NULL, .mode = EBPF_LOAD_PROBE}} // "nfs4_file_open" - not present on all kernels
      },
      {.filesystem = "zfs",
       .optional_filesystem = NULL,
       .family = "zfs",
       ...
       .fs_obj = NULL,
       .functions =
           {{.name = "zpl_iter_read", .mode = EBPF_LOAD_PROBE},
            {.name = "zpl_iter_write", .mode = EBPF_LOAD_PROBE},
            {.name = "zpl_open", .mode = EBPF_LOAD_PROBE},
            {.name = "zpl_fsync", .mode = EBPF_LOAD_PROBE},
            {.name = NULL, .mode = EBPF_LOAD_PROBE}}},
      {.filesystem = "btrfs",
       .optional_filesystem = NULL,
       .family = "btrfs",
       ...
       .fs_obj = NULL,
       .functions =
           {{.name = "btrfs_file_read_iter", .mode = EBPF_LOAD_PROBE},
            {.name = "btrfs_file_write_iter", .mode = EBPF_LOAD_PROBE},
            {.name = "btrfs_file_open", .mode = EBPF_LOAD_PROBE},
            {.name = "btrfs_sync_file", .mode = EBPF_LOAD_PROBE},
            {.name = NULL, .mode = EBPF_LOAD_PROBE}}},
      {.filesystem = NULL,
       .optional_filesystem = NULL,
       .family = NULL,
