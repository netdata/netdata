...
ebpf_module_t ebpf_modules[] = {
    { .info = {.thread_name = "process",
      ...
      .functions = {.start_routine = ebpf_process_thread,
                    ...
                    .fnct_routine = ebpf_function_process_manipulation,
                    .fcnt_name = EBPF_FUNCTION_PROCESS,
                    .fcnt_desc = EBPF_PLUGIN_PROCESS_FUNCTION_DESCRIPTION,
    ...
    { .info = {.thread_name = "socket",
      ...
      .functions = {.start_routine = ebpf_socket_thread,
                   ...
                   .fnct_routine = ebpf_function_socket_manipulation,
    ...
    { .info = {.thread_name = "cachestat", .config_name = "cachestat", .thread_description = NETDATA_EBPF_CACHESTAT_MODULE_DESC},
      .functions = {.start_routine = ebpf_cachestat_thread,
                    ...
                    .fnct_routine = ebpf_function_cachestat_manipulation,
                    .fcnt_name = EBPF_FUNCTION_CACHESTAT,
                    .fcnt_desc = EBPF_PLUGIN_CACHESTAT_FUNCTION_DESCRIPTION,
                    .fcnt_thread_chart_name = NULL,
                    .fcnt_thread_lifetime_name = NULL},
      .enabled = NETDATA_THREAD_EBPF_NOT_RUNNING,
      .update_every = EBPF_DEFAULT_UPDATE_EVERY, .global_charts = 1, .apps_charts = NETDATA_EBPF_APPS_FLAG_NO,
    ...
    { .info = {.thread_name = "dc",
      ...
      .functions = {.start_routine = ebpf_dcstat_thread,
                    ...
                    .fnct_routine = ebpf_function_dc_manipulation,
                    .fcnt_name = EBPF_FUNCTION_DC,
                    .fcnt_desc = EBPF_PLUGIN_DC_FUNCTION_DESCRIPTION,
                    .fcnt_thread_chart_name = NULL,
                    .fcnt_thread_lifetime_name = NULL},
                    .enabled = NETDATA_THREAD_EBPF_NOT_RUNNING,
      .update_every = EBPF_DEFAULT_UPDATE_EVERY, .global_charts = 1, .apps_charts = NETDATA_EBPF_APPS_FLAG_NO,
    ...
    { .info = {.thread_name = "swap", .config_name = "swap", .thread_description = NETDATA_EBPF_SWAP_MODULE_DESC},
      .functions = {.start_routine = ebpf_swap_thread,
                    ...
                    .fnct_routine = ebpf_function_swap_manipulation,
                    .fcnt_name = EBPF_FUNCTION_SWAP,
                    .fcnt_desc = EBPF_PLUGIN_SWAP_FUNCTION_DESCRIPTION,
                    .fcnt_thread_chart_name = NULL,
                    .fcnt_thread_lifetime_name = NULL},
      .enabled = NETDATA_THREAD_EBPF_NOT_RUNNING,
      .update_every = EBPF_DEFAULT_UPDATE_EVERY, .global_charts = 1, .apps_charts = NETDATA_EBPF_APPS_FLAG_NO,
    ...
    { .info = {.thread_name = "vfs",
      ...
      .functions = {.start_routine = ebpf_vfs_thread,
                   ...
                   .fnct_routine = ebpf_function_vfs_manipulation,
                   .fcnt_name = EBPF_FUNCTION_VFS,
                   .fcnt_desc = EBPF_PLUGIN_VFS_FUNCTION_DESCRIPTION,
                   .fcnt_thread_chart_name = NULL,
                   .fcnt_thread_lifetime_name = NULL},
                   .enabled = NETDATA_THREAD_EBPF_NOT_RUNNING,
      .update_every = EBPF_DEFAULT_UPDATE_EVERY, .global_charts = 1, .apps_charts = NETDATA_EBPF_APPS_FLAG_NO,
    ...
    {  .info = { .thread_name = "fd",
       ...
       .functions = {.start_routine = ebpf_fd_thread,
                     ...
                     .fnct_routine = ebpf_function_fd_manipulation,
                     .fcnt_name = EBPF_FUNCTION_FD,
                     .fcnt_desc = EBPF_PLUGIN_FD_FUNCTION_DESCRIPTION,
                     .fcnt_thread_chart_name = NULL,
                     .fcnt_thread_lifetime_name = NULL
                    },
      .enabled = NETDATA_THREAD_EBPF_NOT_RUNNING,
    ...
    { .info = {.thread_name = "shm",
      ...
      .functions = {.start_routine = ebpf_shm_thread,
                   ...
                   .fnct_routine = ebpf_function_shm_manipulation,
                   .fcnt_name = EBPF_FUNCTION_SHM,
                   .fcnt_desc = EBPF_PLUGIN_SHM_FUNCTION_DESCRIPTION,
                   .fcnt_thread_chart_name = NULL,
                   .fcnt_thread_lifetime_name = NULL
      },
      .enabled = NETDATA_THREAD_EBPF_NOT_RUNNING,
