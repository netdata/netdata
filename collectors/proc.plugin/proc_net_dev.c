...
#define NETDEV_OPERSTATE_UNKNOWN 0
#define NETDEV_OPERSTATE_NOTPRESENT 1
#define NETDEV_OPERSTATE_DOWN 2
#define NETDEV_OPERSTATE_LOWERLAYERDOWN 3
#define NETDEV_OPERSTATE_TESTING 4
#define NETDEV_OPERSTATE_DORMANT 5
#define NETDEV_OPERSTATE_UP 6
