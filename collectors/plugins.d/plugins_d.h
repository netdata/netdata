...
#define PLUGINSD_KEYWORD_REP_ON "REP_ON"
#define PLUGINSD_KEYWORD_REP_OFF "REP_OFF"
#define PLUGINSD_KEYWORD_REP_ACK "REP_ACK"
#define PLUGINSD_KEYWORD_REP_PAUSE "REP_PAUSE"
