...
_Multiple Endpoints (urls) Examples: [`rabbitmq`](collectors/python.d.plugin/rabbitmq/README.md) (simpler) , [`elasticsearch`](/collectors/python.d.plugin/elasticsearch/README.md) (threaded)_
