...
// mypopen_raw is the interface to use instead of custom_popene()
...
#define mypopen_raw(pidptr, env, flags, fpp, command, args...) custom_popene(pidptr, env, flags, fpp, command, ##args, NULL)
