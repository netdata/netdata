...
// mypopen_raw is the interface to use instead of custom_popene_internal_dont_use_directly()
...
#define mypopen_raw_default_flags_and_environment(pidptr, fpp, command, args...) custom_popene_internal_dont_use_directly(pidptr, environ, POPEN_FLAGS_DEFAULT, fpp, command, command, ##args, NULL)
#define mypopen_raw_default_flags(pidptr, env, fpp, command, args...) custom_popene_internal_dont_use_directly(pidptr, env, POPEN_FLAGS_DEFAULT, fpp, command, command, ##args, NULL)
#define mypopen_raw(pidptr, env, flags, fpp, command, args...) custom_popene_internal_dont_use_directly(pidptr, env, flags, fpp, command, command, ##args, NULL)

extern int custom_popene_internal_dont_use_directly(volatile pid_t *pidptr, char **env, uint8_t flags, FILE **fpp, const char *command, ...);
