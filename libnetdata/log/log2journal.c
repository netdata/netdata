...
void display_help(const char *name) {
    ...
    printf("Options:\n");
    printf("\n");
    printf("  --filename-key=KEY       Add a field with KEY as the key and the current filename as value.\n");
    ...
    printf("\n");
    printf("  --unmatched-key=KEY      Include unmatched log entries in the output with KEY as the field name.\n");
    ...
    printf("\n");
    printf("  --duplicate=OLD,NEW      Duplicate a field with OLD key as NEW key, retaining the same value.\n");
    printf("                           Useful for further processing. Up to %d duplications allowed.\n", MAX_KEY_DUPS);
    printf("\n");
    printf("  --inject=LINE            Inject constant fields into successfully parsed log entries.\n");
    printf("                           Up to %d fields can be injected.\n", MAX_INJECTIONS);
    printf("\n");
    printf("  --inject-unmatched=LINE  Inject lines into the output for each unmatched log entry.\n");
